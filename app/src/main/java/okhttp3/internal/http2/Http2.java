...
public final class Http2 {
    ...
    private static final String[] FRAME_NAMES = {QrRefreshNotification.DATA, "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};
    ...
    static {
        ...
        while (true) {
            ...
            strArr[i2] = Util.format("%8s", Integer.toBinaryString(i2)).replace(InputCardNumberView.DIVIDER, '0');
            i2++;
        }
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 <= 0; i7++) {
                ...
                sb3.append(strArr5[i8]);
                sb3.append('|');
                sb3.append(strArr5[i6]);
                sb3.append("|PADDED");
                strArr5[i9 | 8] = sb3.toString();
            }
        }
        while (true) {
