...
public final class Http2Codec implements HttpCodec {
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header("Content-Type"), okhttp3.internal.http.HttpHeaders.contentLength(response), Okio.KClassImpl$Data$declaredNonStaticMembers$2(new StreamFinishingSource(this.stream.getSource())));
    }
