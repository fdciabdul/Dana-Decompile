...
public class BlockquoteHandler extends TagHandler {
    ...
    public final void MyBillsEntityDataFactory(SpannableConfiguration spannableConfiguration, SpannableBuilder spannableBuilder, HtmlTag htmlTag) {
        ...
        SpannableBuilder.PlaceComponentResult(spannableBuilder, spannableConfiguration.MyBillsEntityDataFactory.PlaceComponentResult(spannableConfiguration.scheduleImpl), htmlTag.moveToNextValue(), htmlTag.MyBillsEntityDataFactory());
    }
}
