...
public final class PagingDataTransforms$transform$$inlined$map$1<R> implements Flow<PageEvent<R>> {
    final /* synthetic */ Function2 KClassImpl$Data$declaredNonStaticMembers$2;
    final /* synthetic */ Flow PlaceComponentResult;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    /* renamed from: androidx.paging.PagingDataTransforms$transform$$inlined$map$1$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    public final Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.PlaceComponentResult.collect(new AnonymousClass2(flowCollector, this.KClassImpl$Data$declaredNonStaticMembers$2), continuation);
