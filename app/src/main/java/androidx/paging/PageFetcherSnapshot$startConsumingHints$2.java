...
@DebugMetadata(c = "androidx.paging.PageFetcherSnapshot$startConsumingHints$2", f = "PageFetcherSnapshot.kt", i = {0, 0}, l = {SecExceptionCode.SEC_ERROR_SIGNATURE_NO_DATA_FILE, 229}, m = "invokeSuspend", n = {"this_$iv", "$this$withLock_u24default$iv$iv"}, s = {"L$0", "L$1"})
...
public final class PageFetcherSnapshot$startConsumingHints$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            Flow onStart = FlowKt.onStart(FlowKt.consumeAsFlow(pageFetcherSnapshotState.initRecordTimeStamp), new PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1(pageFetcherSnapshotState, null));
            mutex2.unlock(null);
            this.L$0 = null;
            this.L$1 = null;
            this.L$2 = null;
            this.label = 2;
            if (PageFetcherSnapshot.KClassImpl$Data$declaredNonStaticMembers$2(pageFetcherSnapshot, onStart, LoadType.PREPEND, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        } catch (Throwable th) {
