...
public class MenuBuilder implements SupportMenu {
    ...
    public MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        ...
        if (contextMenuInfo != null) {
            createNewMenuItem.getAuthRequestContext = contextMenuInfo;
        }
    ...
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        ...
        menuItemImpl.moveToNextValue = subMenuBuilder;
    ...
    public void setExclusiveItemChecked(MenuItem menuItem) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (menuItemImpl.getGroupId() == groupId && menuItemImpl.lookAheadTest() && menuItemImpl.isCheckable()) {
                menuItemImpl.BuiltInFictitiousFunctionClassFactory(menuItemImpl == menuItem);
            }
        }
        startDispatchingItemsChanged();
    }
    ...
    public void setGroupCheckable(int i, boolean z, boolean z2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (menuItemImpl.getGroupId() == i) {
                menuItemImpl.MyBillsEntityDataFactory = (menuItemImpl.MyBillsEntityDataFactory & (-5)) | (z2 ? 4 : 0);
    ...
    public void setGroupVisible(int i, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i2);
            if (menuItemImpl.getGroupId() == i && menuItemImpl.MyBillsEntityDataFactory(z)) {
                z2 = true;
            }
        }
        if (z2) {
    ...
    private void setShortcutsVisibleInner(boolean z) {
        this.mShortcutsVisible = z && this.mResources.getConfiguration().keyboard != 1 && ViewConfigurationCompat.PlaceComponentResult(ViewConfiguration.get(this.mContext), this.mContext);
    }
    ...
    private static int findInsertIndex(ArrayList<MenuItemImpl> arrayList, int i) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            if (arrayList.get(size).scheduleImpl <= i) {
                return size + 1;
            }
        }
        return 0;
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (((modifiers & 69647) == ((isQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & 69647)) && alphabeticShortcut != 0 && ((alphabeticShortcut == keyData.meta[0] || alphabeticShortcut == keyData.meta[2] || (isQwertyMode && alphabeticShortcut == '\b' && i == 67)) && menuItemImpl.isEnabled())) {
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i) {
        ...
        boolean BuiltInFictitiousFunctionClassFactory = menuItemImpl.BuiltInFictitiousFunctionClassFactory();
        ActionProvider actionProvider = menuItemImpl.BuiltInFictitiousFunctionClassFactory;
        boolean z = actionProvider != null && actionProvider.MyBillsEntityDataFactory();
        if (menuItemImpl.MyBillsEntityDataFactory()) {
            BuiltInFictitiousFunctionClassFactory |= menuItemImpl.expandActionView();
            ...
            if (z) {
                actionProvider.MyBillsEntityDataFactory(subMenuBuilder2);
            }
            BuiltInFictitiousFunctionClassFactory |= dispatchSubMenuSelected(subMenuBuilder2, menuPresenter);
            if (!BuiltInFictitiousFunctionClassFactory) {
                close(true);
            }
        } else if ((i & 1) == 0) {
        ...
        if (this.mIsActionItemsStale) {
            ...
            if (z) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (menuItemImpl.PlaceComponentResult()) {
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                this.mHeaderIcon = ContextCompat.PlaceComponentResult(getContext(), i2);
