...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    public static boolean getAuthRequestContext() {
        return PlaceComponentResult() && Build.VERSION.SDK_INT <= 20;
    }
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        ...
        if (context != null) {
            return ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().KClassImpl$Data$declaredNonStaticMembers$2(context, this, i);
        }
