...
final class FoldingFeatureObserver$registerLayoutStateChangeCallback$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            windowInfoTracker = this.this$0.PlaceComponentResult;
            final Flow<WindowLayoutInfo> BuiltInFictitiousFunctionClassFactory = windowInfoTracker.BuiltInFictitiousFunctionClassFactory(this.$activity);
            ...
            Flow distinctUntilChanged = FlowKt.distinctUntilChanged(new Flow<FoldingFeature>() { // from class: androidx.slidingpanelayout.widget.FoldingFeatureObserver$registerLayoutStateChangeCallback$1$invokeSuspend$$inlined$mapNotNull$1
                ...
                @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001b\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¸\u0006\u0006"}, d2 = {"Lkotlinx/coroutines/flow/FlowKt__CollectKt$collect$3;", "Lkotlinx/coroutines/flow/FlowCollector;", "p0", "", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx/coroutines/flow/FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2"}, k = 1, mv = {1, 6, 0}, xi = 48)
                ...
                public static final class AnonymousClass2 implements FlowCollector<WindowLayoutInfo> {
                    ...
                    final /* synthetic */ FoldingFeatureObserver MyBillsEntityDataFactory;
                    ...
                    public AnonymousClass2(FlowCollector flowCollector, FoldingFeatureObserver foldingFeatureObserver) {
                        ...
                        this.MyBillsEntityDataFactory = foldingFeatureObserver;
                    }
                    ...
                    */
                    public final java.lang.Object emit(androidx.window.layout.WindowLayoutInfo r5, kotlin.coroutines.Continuation r6) {
                        /*
                            r4 = this;
                        ...
                        L32:
                            ...
                            androidx.window.layout.FoldingFeature r5 = androidx.slidingpanelayout.widget.FoldingFeatureObserver.KClassImpl$Data$declaredNonStaticMembers$2(r5)
                            if (r5 == 0) goto L4b
                            r0.label = r3
                ...
                public final Object collect(FlowCollector<? super FoldingFeature> flowCollector, Continuation continuation) {
            ...
            if (distinctUntilChanged.collect(new FlowCollector<FoldingFeature>() { // from class: androidx.slidingpanelayout.widget.FoldingFeatureObserver$registerLayoutStateChangeCallback$1$invokeSuspend$$inlined$collect$1
                ...
                public final Object emit(FoldingFeature foldingFeature, Continuation<? super Unit> continuation) {
                    ...
                    onFoldingFeatureChangeListener = FoldingFeatureObserver.this.getAuthRequestContext;
                    if (onFoldingFeatureChangeListener == null) {
                        unit = null;
                    } else {
                        onFoldingFeatureChangeListener.PlaceComponentResult(foldingFeature2);
                        unit = Unit.INSTANCE;
                    }
