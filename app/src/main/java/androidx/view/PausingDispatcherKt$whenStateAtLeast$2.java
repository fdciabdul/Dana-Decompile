...
public final class PausingDispatcherKt$whenStateAtLeast$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Job job = (Job) ((CoroutineScope) this.L$0).getPlaceComponentResult().get(Job.INSTANCE);
            if (job == null) {
                throw new IllegalStateException("when[State] methods should have a parent job".toString());
            }
            PausingDispatcher pausingDispatcher = new PausingDispatcher();
            LifecycleController lifecycleController2 = new LifecycleController(this.$this_whenStateAtLeast, this.$minState, pausingDispatcher.getAuthRequestContext, job);
            try {
                ...
                dispatchQueue.PlaceComponentResult = true;
        ...
        lifecycleController.getAuthRequestContext.KClassImpl$Data$declaredNonStaticMembers$2(lifecycleController.BuiltInFictitiousFunctionClassFactory);
        DispatchQueue dispatchQueue3 = lifecycleController.PlaceComponentResult;
        dispatchQueue3.PlaceComponentResult = true;
        dispatchQueue3.PlaceComponentResult();
        return obj;
    }
}
