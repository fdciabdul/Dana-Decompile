...
public class MonitorUtil {
    ...
    public static void monitorJSONError(String str, JSONException jSONException) {
        ...
        sb.append(str);
        ACLog.d("IAPConnectPlugin", sb.toString());
        ACLogEvent addParams = ACLogEvent.newLogger("iapconnect_center", "ac_js_api_plugin_fail").addParams("jsapi", str);
        StringBuilder sb2 = new StringBuilder();
        sb2.append("convert result to JSON error in ");
        sb2.append(str);
        sb2.append(": ");
        sb2.append(jSONException);
        addParams.addParams("resultMessage", sb2.toString()).setEventType(LogEventType.CRUCIAL_LOG).event();
    }
