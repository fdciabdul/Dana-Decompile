...
public class RpcLogEvent {
    ...
    public static final String PARAM_KEY_REAL_URL = "realUrl";
    public static final String PARAM_KEY_RESULT = "result";
    public static final String PARAM_KEY_RPC_HTTP_PROTOCOLS = "rpc_http_protocols";
    public static final String PARAM_KEY_RPC_ID = "rpc_id";
    public static final String PARAM_KEY_RPC_RESULT = "rpc_result";
    public static final String PARAM_KEY_RPC_RESULT_CODE = "rpc_result_code";
    public static final String PARAM_KEY_RPC_TIME = "rpc_time";
    public static final String PARAM_KEY_RPC_TRACE_ID = "rpc_trace_id";
    public static final String PARAM_KEY_URL = "url";
    public static final String RPC_NATIVE_RPC_PERFORMANCE = "native_rpc_performance";
