...
public class RectUtils {
    public static float[] BuiltInFictitiousFunctionClassFactory(RectF rectF) {
        return new float[]{rectF.left, rectF.top, rectF.right, rectF.top, rectF.right, rectF.bottom, rectF.left, rectF.bottom};
    }

    public static float[] PlaceComponentResult(float[] fArr) {
    ...
    public static float[] KClassImpl$Data$declaredNonStaticMembers$2(RectF rectF) {
        return new float[]{rectF.centerX(), rectF.centerY()};
    }

    public static RectF BuiltInFictitiousFunctionClassFactory(float[] fArr) {
