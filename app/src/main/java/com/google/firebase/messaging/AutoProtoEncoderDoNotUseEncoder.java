...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor INSTANCEID_DESCRIPTOR = FieldDescriptor.builder(FoundationProxy.COMPONENT_INSTANCE_ID).withProperty(AtProtobuf.builder().tag(3).build()).build();
        ...
        private static final FieldDescriptor TOPIC_DESCRIPTOR = FieldDescriptor.builder(SemanticAttributes.MessagingDestinationKindValues.TOPIC).withProperty(AtProtobuf.builder().tag(10).build()).build();
