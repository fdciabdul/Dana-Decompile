...
public class GmsRpc {
    ...
    public Task<?> subscribeToTopic(String str, String str2) {
        ...
        sb.append(str2);
        bundle.putString(EXTRA_TOPIC, sb.toString());
        StringBuilder sb2 = new StringBuilder();
        sb2.append(TOPIC_PREFIX);
        sb2.append(str2);
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            InstrumentInjector.log_e("FirebaseMessaging", "Failed to get FIS auth token", e);
        }
        bundle.putString("appid", (String) Tasks.await(this.firebaseInstallations.getId()));
        StringBuilder sb = new StringBuilder();
        sb.append("fcm-");
        sb.append("23.0.8");
        bundle.putString(PARAM_CLIENT_VER, sb.toString());
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        ...
        sb.append(bundle);
        InstrumentInjector.log_w("FirebaseMessaging", sb.toString(), new Throwable());
        throw new IOException(ERROR_SERVICE_NOT_AVAILABLE);
    }
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new CredentialManager$$ExternalSyntheticLambda0(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return GmsRpc.this.m179xb80eb67f(task2);
            }
        });
    }
    ...
    public /* synthetic */ String m179xb80eb67f(Task task) throws Exception {
