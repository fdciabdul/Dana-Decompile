...
public class SphericalUtil {
    ...
    public static LatLng computeOffsetOrigin(LatLng latLng, double d, double d2) {
        ...
        double sin4 = Math.sin(Math.toRadians(latLng.latitude));
        double d4 = cos * cos;
        double d5 = sin * sin;
        double d6 = ((d5 * d4) + (d4 * d4)) - ((d4 * sin4) * sin4);
        ...
        return new LatLng(Math.toDegrees(atan2), Math.toDegrees(Math.toRadians(latLng.longitude) - Math.atan2(sin2 * sin3, (cos * Math.cos(atan2)) - (sin * Math.sin(atan2)))));
    }
