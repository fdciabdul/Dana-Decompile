...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public enum Aggregate {
        SIZE { // from class: com.google.common.collect.TreeMultiset.Aggregate.1
            ...
            @Override // com.google.common.collect.TreeMultiset.Aggregate
            final long treeAggregate(@CheckForNull AvlNode<?> avlNode) {
                if (avlNode == null) {
                    return 0L;
                }
    ...
    final java.util.Iterator<Multiset.Entry<E>> descendingEntryIterator() {
    ...
    public static final class Reference<T> {
        ...
        public final void checkAndSet(@CheckForNull T t, @CheckForNull T t2) {
            if (this.value != t) {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        Serialization.getFieldSetter(TreeMultiset.class, InvoiceConstant.HEADER).set((Serialization.FieldSetter) this, (Object) avlNode);
        successor(avlNode, avlNode);
