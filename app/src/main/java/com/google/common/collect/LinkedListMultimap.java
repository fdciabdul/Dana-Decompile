...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    /* loaded from: classes7.dex */
    class NodeIterator implements ListIterator<Map.Entry<K, V>>, Iterator {
        @CheckForNull
        Node<K, V> current;
    ...
    /* loaded from: classes7.dex */
    class DistinctKeyIterator implements java.util.Iterator<K>, Iterator {
        @CheckForNull
        Node<K, V> current;
        int expectedModCount;
        @CheckForNull
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes7.dex */
    public class ValueForKeyIterator implements ListIterator<V>, Iterator {
        @CheckForNull
        Node<K, V> current;
        @ParametricNullness
        final K key;
