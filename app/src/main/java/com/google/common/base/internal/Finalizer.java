...
public class Finalizer implements Runnable {
    ...
    public static final byte[] KClassImpl$Data$declaredNonStaticMembers$2 = {59, -54, -26, -72, -11, 19, -23, -53, 60, -13, 11, -9, -59, 36, 18, 8, -15, -6, 1};
    ...
    */
    private static void a(int r6, short r7, byte r8, java.lang.Object[] r9) {
        /*
            int r8 = r8 * 4
            int r8 = 16 - r8
            byte[] r0 = com.google.common.base.internal.Finalizer.KClassImpl$Data$declaredNonStaticMembers$2
            int r6 = r6 * 4
            int r6 = 3 - r6
            int r7 = r7 * 2
            int r7 = r7 + 106
        ...
        L36:
            ...
            goto L1c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.internal.Finalizer.a(int, short, byte, java.lang.Object[]):void");
    }
    ...
    */
    public static void startFinalizer(java.lang.Class<?> r6, java.lang.ref.ReferenceQueue<java.lang.Object> r7, java.lang.ref.PhantomReference<java.lang.Object> r8) {
        /*
            ...
            r3 = 3
            r4 = 0
            java.lang.Long r4 = java.lang.Long.valueOf(r4)     // Catch: java.lang.Throwable -> L3d
            r2[r3] = r4     // Catch: java.lang.Throwable -> L3d
            r3 = 4
            java.lang.Boolean r4 = java.lang.Boolean.FALSE     // Catch: java.lang.Throwable -> L3d
            r2[r3] = r4     // Catch: java.lang.Throwable -> L3d
            java.lang.Object r7 = r7.newInstance(r2)     // Catch: java.lang.Throwable -> L3d
    ...
    private static Field getInheritableThreadLocalsField() {
        try {
            byte b = (byte) (KClassImpl$Data$declaredNonStaticMembers$2[18] - 1);
            byte b2 = b;
            Object[] objArr = new Object[1];
            a(b, b2, b2, objArr);
            Field declaredField = Class.forName((String) objArr[0]).getDeclaredField("inheritableThreadLocals");
    ...
    private static Constructor<Thread> getBigThreadConstructor() {
        try {
            Class<?>[] clsArr = {ThreadGroup.class, Runnable.class, String.class, Long.TYPE, Boolean.TYPE};
            byte b = (byte) (KClassImpl$Data$declaredNonStaticMembers$2[18] - 1);
            byte b2 = b;
            Object[] objArr = new Object[1];
            a(b, b2, b2, objArr);
            return Class.forName((String) objArr[0]).getConstructor(clsArr);
        } catch (Throwable unused) {
            return null;
        }
    }
