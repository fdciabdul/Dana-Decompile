...
public class TrustedListenableFutureTask<V> extends FluentFuture.TrustedFuture<V> implements RunnableFuture<V> {
    ...
    final class TrustedFutureInterruptibleTask extends InterruptibleTask<V> {
        ...
        @Override // com.google.common.util.concurrent.InterruptibleTask
        final void afterRanInterruptiblySuccess(@ParametricNullness V v) {
    ...
    final class TrustedFutureInterruptibleAsyncTask extends InterruptibleTask<ListenableFuture<V>> {
        ...
        @Override // com.google.common.util.concurrent.InterruptibleTask
        final /* bridge */ /* synthetic */ void afterRanInterruptiblySuccess(Object obj) {
        ...
        final void afterRanInterruptiblySuccess(ListenableFuture<V> listenableFuture) {
