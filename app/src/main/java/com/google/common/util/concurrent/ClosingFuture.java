...
public final class ClosingFuture<V> {
    ...
    public static final class DeferredCloser {
        ...
        @ParametricNullness
        public final <C extends Closeable> C eventuallyClose(@ParametricNullness C c, Executor executor) {
    ...
    private boolean compareAndUpdateState(State state, State state2) {
        return LifecycleKt$$ExternalSyntheticBackportWithForwarding0.KClassImpl$Data$declaredNonStaticMembers$2(this.state, state, state2);
    }
    ...
    public static final class CloseableList extends IdentityHashMap<Closeable, Executor> implements Closeable {
        ...
        final void add(@CheckForNull Closeable closeable, Executor executor) {
            Preconditions.checkNotNull(executor);
            if (closeable == null) {
                return;
            }
