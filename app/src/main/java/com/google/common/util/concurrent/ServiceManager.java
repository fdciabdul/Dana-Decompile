...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public static final class ServiceManagerState {
        ...
        final void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    ...
                    sb.append(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.in(ImmutableSet.of(Service.State.NEW, Service.State.STARTING))));
        ...
        final void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                sb.append(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                throw new TimeoutException(sb.toString());
            } finally {
                this.monitor.leave();
            }
        ...
        final void checkHealthy() {
            ...
            sb.append(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.equalTo(Service.State.RUNNING))));
    ...
    static final class ServiceListener extends Service.Listener {
        ...
        public final void failed(Service.State state, Throwable th) {
            ServiceManagerState serviceManagerState = this.state.get();
            if (serviceManagerState != null) {
                if ((!(this.service instanceof NoOpService)) != false) {
