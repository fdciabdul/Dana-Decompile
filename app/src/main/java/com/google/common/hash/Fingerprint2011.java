...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    private static void weakHashLength32WithSeeds(byte[] bArr, int i, long j, long j2, long[] jArr) {
        ...
        long rotateRight2 = Long.rotateRight(j4, 23);
        jArr[0] = j4 + load644;
    ...
    private static long fullFingerprint(byte[] bArr, int i, int i2) {
        ...
        long load643 = LittleEndianByteArray.load64(bArr, i3 - 56);
        long[] jArr = new long[2];
        long[] jArr2 = new long[2];
        long j = i2;
        weakHashLength32WithSeeds(bArr, i3 - 64, j, load642, jArr);
        weakHashLength32WithSeeds(bArr, i3 - 32, j * K1, K0, jArr2);
        long shiftMix = (load643 ^ K0) + (shiftMix(jArr[1]) * K1);
        long rotateRight = Long.rotateRight(load64 + shiftMix, 39) * K1;
        long rotateRight2 = Long.rotateRight(load642, 33) * K1;
        int i4 = i;
        int i5 = (i2 - 1) & (-64);
        while (true) {
            long rotateRight3 = Long.rotateRight(rotateRight + rotateRight2 + jArr[0] + LittleEndianByteArray.load64(bArr, i4 + 16), 37);
            long rotateRight4 = Long.rotateRight(rotateRight2 + jArr[1] + LittleEndianByteArray.load64(bArr, i4 + 48), 42);
            long j2 = jArr2[1] ^ (rotateRight3 * K1);
            long j3 = (rotateRight4 * K1) ^ jArr[0];
            long rotateRight5 = Long.rotateRight(jArr2[0] ^ shiftMix, 33);
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        long rotateRight3 = Long.rotateRight(load643, 7);
        int i5 = i + 16;
        long load644 = load643 + LittleEndianByteArray.load64(bArr, i5);
        long rotateRight4 = rotateRight + Long.rotateRight(load644, 31) + rotateRight2 + rotateRight3;
        ...
        long rotateRight7 = Long.rotateRight(load647, 7);
        long load648 = load647 + LittleEndianByteArray.load64(bArr, i4);
        return shiftMix((shiftMix(((load64 + load644 + rotateRight5 + Long.rotateRight(load648, 31) + rotateRight6 + rotateRight7) * K2) + ((load646 + load648 + rotateRight4) * K0)) * K0) + rotateRight4) * K2;
    }
