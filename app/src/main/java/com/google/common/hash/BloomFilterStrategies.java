...
public enum BloomFilterStrategies implements BloomFilter.Strategy {
    MURMUR128_MITZ_32 { // from class: com.google.common.hash.BloomFilterStrategies.1
        ...
        public final <T> boolean put(@ParametricNullness T t, Funnel<? super T> funnel, int i, LockFreeBitArray lockFreeBitArray) {
        ...
        @Override // com.google.common.hash.BloomFilter.Strategy
        public final <T> boolean mightContain(@ParametricNullness T t, Funnel<? super T> funnel, int i, LockFreeBitArray lockFreeBitArray) {
            long bitSize = lockFreeBitArray.bitSize();
            long asLong = Hashing.murmur3_128().hashObject(t, funnel).asLong();
            int i2 = (int) asLong;
            int i3 = (int) (asLong >>> 32);
    ...
    public static final class LockFreeBitArray {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public final void putData(int i, long j) {
            long j2;
            long j3;
            boolean z;
            while (true) {
