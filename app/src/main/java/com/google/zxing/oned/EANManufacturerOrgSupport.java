    ...
    private void initIfNeeded() {
        synchronized (this) {
            if (this.ranges.isEmpty()) {
                ...
                add(new int[]{475}, "LV");
                add(new int[]{476}, "AZ");
                add(new int[]{477}, Condition.MATCH_TYPE_LESS_THAN);
                add(new int[]{478}, "UZ");
                add(new int[]{479}, "LK");
                add(new int[]{480}, "PH");
                add(new int[]{481}, "BY");
                ...
                add(new int[]{627}, "KW");
                add(new int[]{628}, "SA");
                add(new int[]{629}, IAPAECodeEncoding.IAP_ERROR_IDENTITY);
                add(new int[]{640, 649}, "FI");
                add(new int[]{690, 695}, "CN");
                add(new int[]{700, 709}, "NO");
                add(new int[]{729}, "IL");
                add(new int[]{730, 739}, "SE");
                add(new int[]{740}, Condition.MATCH_TYPE_GREATER_THAN);
                add(new int[]{741}, "SV");
                add(new int[]{742}, "HN");
                add(new int[]{743}, "NI");
                add(new int[]{744}, "CR");
