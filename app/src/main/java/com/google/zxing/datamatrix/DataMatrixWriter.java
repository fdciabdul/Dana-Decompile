...
public final class DataMatrixWriter implements Writer {
    ...
    public final BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        ...
        if (barcodeFormat == BarcodeFormat.DATA_MATRIX) {
            ...
            String encodeHighLevel = HighLevelEncoder.encodeHighLevel(str, symbolShapeHint, r0, dimension);
            SymbolInfo lookup = SymbolInfo.lookup(encodeHighLevel.length(), symbolShapeHint, r0, dimension, true);
