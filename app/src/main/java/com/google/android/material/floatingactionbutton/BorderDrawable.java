...
public class BorderDrawable extends Drawable implements FSDraw {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, r0.top, 0.0f, r0.bottom, new int[]{ColorUtils.BuiltInFictitiousFunctionClassFactory(this.topOuterStrokeColor, this.currentBorderTintColor), ColorUtils.BuiltInFictitiousFunctionClassFactory(this.topInnerStrokeColor, this.currentBorderTintColor), ColorUtils.BuiltInFictitiousFunctionClassFactory(ColorUtils.MyBillsEntityDataFactory(this.topInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.BuiltInFictitiousFunctionClassFactory(ColorUtils.MyBillsEntityDataFactory(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.BuiltInFictitiousFunctionClassFactory(this.bottomInnerStrokeColor, this.currentBorderTintColor), ColorUtils.BuiltInFictitiousFunctionClassFactory(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
