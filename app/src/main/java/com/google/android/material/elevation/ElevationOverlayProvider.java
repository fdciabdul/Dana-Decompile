...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(int i, float f) {
        ...
        return ColorUtils.MyBillsEntityDataFactory(MaterialColors.layer(ColorUtils.MyBillsEntityDataFactory(i, 255), this.elevationOverlayColor, calculateOverlayAlphaFraction), Color.alpha(i));
    }
    ...
    private boolean isThemeSurfaceColor(int i) {
        return ColorUtils.MyBillsEntityDataFactory(i, 255) == this.colorSurface;
    }
}
