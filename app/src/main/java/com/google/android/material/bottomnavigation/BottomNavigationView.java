...
public class BottomNavigationView extends NavigationBarView {
    ...
    public BottomNavigationView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setItemHorizontalTranslationEnabled(obtainTintedStyledAttributes.getAuthRequestContext(R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        view.setBackgroundColor(ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_bottom_navigation_shadow_color));
