...
public class ShadowDrawableWrapper extends DrawableWrapper implements FSDraw {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_shadow_end_color);
