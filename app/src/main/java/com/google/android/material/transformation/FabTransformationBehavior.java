...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createElevationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        float errorConfigVersion = ViewCompat.getErrorConfigVersion(view2) - ViewCompat.getErrorConfigVersion(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-errorConfigVersion);
            }
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, 0.0f);
        } else {
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, -errorConfigVersion);
        }
    ...
    private void createColorAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                ofInt = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, backgroundTint & FlexItem.MAX_SIZE);
            } else {
    ...
    private int getBackgroundTint(View view) {
        ColorStateList moveToNextValue = ViewCompat.moveToNextValue(view);
        if (moveToNextValue != null) {
            return moveToNextValue.getColorForState(view.getDrawableState(), moveToNextValue.getDefaultColor());
        }
        return 0;
    }
