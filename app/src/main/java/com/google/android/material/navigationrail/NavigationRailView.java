...
public class NavigationRailView extends NavigationBarView {
    ...
    public NavigationRailView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        int resourceId = obtainTintedStyledAttributes.BuiltInFictitiousFunctionClassFactory.getResourceId(R.styleable.NavigationRailView_headerLayout, 0);
        if (resourceId != 0) {
            addHeaderView(resourceId);
        }
        setMenuGravity(obtainTintedStyledAttributes.BuiltInFictitiousFunctionClassFactory.getInt(R.styleable.NavigationRailView_menuGravity, 49));
