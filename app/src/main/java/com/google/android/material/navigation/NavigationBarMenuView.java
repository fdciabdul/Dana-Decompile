...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(1, this.menu.getVisibleItems().size(), false, 1));
    }
    ...
    public ColorStateList createDefaultColorStateList(int i) {
        ...
        if (getContext().getTheme().resolveAttribute(i, typedValue, true)) {
            ...
            if (getContext().getTheme().resolveAttribute(R.attr.readMicros, typedValue, true)) {
        ...
        if (navigationBarItemViewArr != null) {
            for (NavigationBarItemView navigationBarItemView : navigationBarItemViewArr) {
                if (navigationBarItemView != null) {
                    this.itemPool.MyBillsEntityDataFactory(navigationBarItemView);
    ...
    public void updateMenuView() {
        ...
        if (i != this.selectedItemId) {
            TransitionManager.getAuthRequestContext(this, this.set);
        }
        boolean isShifting = isShifting(this.labelVisibilityMode, this.menu.getVisibleItems().size());
    ...
    private NavigationBarItemView getNewItem() {
        NavigationBarItemView BuiltInFictitiousFunctionClassFactory = this.itemPool.BuiltInFictitiousFunctionClassFactory();
        return BuiltInFictitiousFunctionClassFactory == null ? createNavigationBarItemView(getContext()) : BuiltInFictitiousFunctionClassFactory;
    }
