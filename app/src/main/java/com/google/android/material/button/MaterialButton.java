...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    */
    ...
    public void setBackgroundResource(int i) {
        setBackgroundDrawable(i != 0 ? ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(getContext(), i) : null);
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (isUsingOriginalBackground()) {
            if (drawable != getBackground()) {
                InstrumentInjector.log_w(LOG_TAG, "MaterialButton manages its own background to control elevation, shape, color and states. Consider using backgroundTint, shapeAppearance and other attributes where available. A custom background will ignore these attributes and you should consider handling interaction states such as pressed, focused and disabled");
    ...
    private void updateIconPosition(int i, int i2) {
        ...
        if (isIconStart() || isIconEnd()) {
            ...
            int textWidth = (((((i - getTextWidth()) - ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(this)) - i4) - this.iconPadding) - ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(this)) / 2;
    ...
    public void setIconResource(int i) {
        setIcon(i != 0 ? ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(getContext(), i) : null);
    }
    ...
    public void setIconTintResource(int i) {
        setIconTint(AppCompatResources.getAuthRequestContext(getContext(), i));
    }
    ...
    private void updateIcon(boolean z) {
        ...
        if (drawable != null) {
            ...
            this.icon = mutate;
            DrawableCompat.PlaceComponentResult(mutate, this.iconTint);
            PorterDuff.Mode mode = this.iconTintMode;
            if (mode != null) {
                DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(this.icon, mode);
            }
            int i = this.iconSize;
            if (i == 0) {
        ...
        Drawable[] PlaceComponentResult = TextViewCompat.PlaceComponentResult(this);
        boolean z2 = false;
        Drawable drawable3 = PlaceComponentResult[0];
        Drawable drawable4 = PlaceComponentResult[1];
        Drawable drawable5 = PlaceComponentResult[2];
    ...
    private void resetIconDrawable() {
        if (isIconStart()) {
            TextViewCompat.getAuthRequestContext(this, this.icon, null, null, null);
        } else if (isIconEnd()) {
            TextViewCompat.getAuthRequestContext(this, null, null, this.icon, null);
        } else if (isIconTop()) {
            TextViewCompat.getAuthRequestContext(this, null, this.icon, null, null);
        }
    }
    ...
    public void setRippleColorResource(int i) {
        if (isUsingOriginalBackground()) {
            setRippleColor(AppCompatResources.getAuthRequestContext(getContext(), i));
        }
    }
    ...
    public void setStrokeColorResource(int i) {
        if (isUsingOriginalBackground()) {
            setStrokeColor(AppCompatResources.getAuthRequestContext(getContext(), i));
        }
    }
