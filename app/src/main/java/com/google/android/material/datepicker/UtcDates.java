...
class UtcDates {
    ...
    private static TimeZone getTimeZone() {
        return DesugarTimeZone.BuiltInFictitiousFunctionClassFactory(UTC);
    }
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll(d.f7256a, resources.getString(R.string.mtrl_picker_text_input_day_abbr)).replaceAll(DiskFormatter.MB, resources.getString(R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(R.string.mtrl_picker_text_input_year_abbr));
    }
