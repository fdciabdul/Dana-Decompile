...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            public int clampViewPositionVertical(View view, int i, int i2) {
                return MathUtils.BuiltInFictitiousFunctionClassFactory(i, BottomSheetBehavior.this.getExpandedOffset(), BottomSheetBehavior.this.hideable ? BottomSheetBehavior.this.parentHeight : BottomSheetBehavior.this.collapsedOffset);
            }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, final V v, int i) {
        ...
        if (this.viewRef == null) {
            ...
            if (this.shapeThemingEnabled && (materialShapeDrawable = this.materialShapeDrawable) != null) {
                ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(v, materialShapeDrawable);
            }
            MaterialShapeDrawable materialShapeDrawable2 = this.materialShapeDrawable;
            if (materialShapeDrawable2 != null) {
                float f = this.elevation;
                if (f == -1.0f) {
                    f = ViewCompat.getErrorConfigVersion(v);
                }
            ...
            if (ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda1(v) == 0) {
                ViewCompat.moveToNextValue((View) v, 1);
            }
        ...
        if (this.viewDragHelper == null) {
            this.viewDragHelper = ViewDragHelper.MyBillsEntityDataFactory(coordinatorLayout, this.dragCallback);
        }
        int top = v.getTop();
        ...
        int i5 = this.state;
        if (i5 == 3) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, getExpandedOffset());
        } else if (i5 == 6) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, this.halfExpandedOffset);
        } else if (this.hideable && i5 == 5) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, this.parentHeight);
        } else if (i5 == 4) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, this.collapsedOffset);
        } else if (i5 == 1 || i5 == 2) {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (this.ignoreEvents || (viewDragHelper = this.viewDragHelper) == null || !viewDragHelper.MyBillsEntityDataFactory(motionEvent)) {
            WeakReference<View> weakReference2 = this.nestedScrollingChildRef;
            View view2 = weakReference2 != null ? weakReference2.get() : null;
            return (actionMasked != 2 || view2 == null || this.ignoreEvents || this.state == 1 || coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || Math.abs(((float) this.initialY) - motionEvent.getY()) <= ((float) this.viewDragHelper.lookAheadTest)) ? false : true;
        }
        return true;
    }
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        if (v.isShown()) {
            ...
            this.velocityTracker.addMovement(motionEvent);
            if (this.viewDragHelper != null && actionMasked == 2 && !this.ignoreEvents && Math.abs(this.initialY - motionEvent.getY()) > this.viewDragHelper.lookAheadTest) {
                this.viewDragHelper.getAuthRequestContext(v, motionEvent.getPointerId(motionEvent.getActionIndex()));
            }
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, V v, View view, int i, int i2, int[] iArr, int i3) {
        ...
        if (i2 > 0) {
            if (i4 < getExpandedOffset()) {
                ...
                ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, -expandedOffset);
                setStateInternal(3);
            ...
            if (i4 <= i5 || this.hideable) {
                ...
                int i6 = top - i5;
                iArr[1] = i6;
                ViewCompat.BuiltInFictitiousFunctionClassFactory((View) v, -i6);
                setStateInternal(4);
            }
        }
        ...
        if (this.paddingBottomSystemWindowInsets || this.paddingLeftSystemWindowInsets || this.paddingRightSystemWindowInsets || z) {
            ViewUtils.doOnApplyWindowInsets(view, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
                ...
                public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                    BottomSheetBehavior.this.insetTop = windowInsetsCompat.initRecordTimeStamp();
                    boolean isLayoutRtl = ViewUtils.isLayoutRtl(view2);
                    int paddingBottom = view2.getPaddingBottom();
                    int paddingLeft = view2.getPaddingLeft();
                    int paddingRight = view2.getPaddingRight();
                    if (BottomSheetBehavior.this.paddingBottomSystemWindowInsets) {
                        BottomSheetBehavior.this.insetBottom = windowInsetsCompat.moveToNextValue();
                        paddingBottom = relativePadding.bottom + BottomSheetBehavior.this.insetBottom;
                    }
                    if (BottomSheetBehavior.this.paddingLeftSystemWindowInsets) {
                        paddingLeft = (isLayoutRtl ? relativePadding.end : relativePadding.start) + windowInsetsCompat.lookAheadTest();
                    }
                    if (BottomSheetBehavior.this.paddingRightSystemWindowInsets) {
                        paddingRight = (isLayoutRtl ? relativePadding.start : relativePadding.end) + windowInsetsCompat.getErrorConfigVersion();
                    }
                    view2.setPadding(paddingLeft, view2.getPaddingTop(), paddingRight, paddingBottom);
                    if (z) {
                        BottomSheetBehavior.this.gestureInsetBottom = windowInsetsCompat.getAuthRequestContext().getAuthRequestContext;
                    }
    ...
    void startSettlingAnimation(View view, int i, int i2, boolean z) {
        ViewDragHelper viewDragHelper = this.viewDragHelper;
        if (viewDragHelper != null && (!z ? !viewDragHelper.KClassImpl$Data$declaredNonStaticMembers$2(view, view.getLeft(), i2) : !viewDragHelper.getAuthRequestContext(view.getLeft(), i2))) {
            setStateInternal(2);
            updateDrawableForTargetState(i);
            ...
            if (!((SettleRunnable) this.settleRunnable).isPosted) {
                ...
                ViewCompat.PlaceComponentResult(view, this.settleRunnable);
    ...
    public class SettleRunnable implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (BottomSheetBehavior.this.viewDragHelper != null && BottomSheetBehavior.this.viewDragHelper.KClassImpl$Data$declaredNonStaticMembers$2()) {
                ViewCompat.PlaceComponentResult(this.view, this);
            } else {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt != this.viewRef.get()) {
                    if (z) {
                        ...
                        ViewCompat.moveToNextValue(childAt, this.importantForAccessibilityMap.get(childAt).intValue());
                    }
                }
            }
            if (!z) {
    ...
    private void updateAccessibilityActions() {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) v, 524288);
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) v, 262144);
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) v, (int) CrashCombineUtils.DEFAULT_MAX_INFO_LEN);
        int i = this.expandHalfwayActionId;
        if (i != -1) {
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) v, i);
        }
        if (!this.fitToContents && this.state != 6) {
            this.expandHalfwayActionId = addAccessibilityActionForState(v, R.string.bottomsheet_action_expand_halfway, 6);
        }
        if (this.hideable && this.state != 5) {
            replaceAccessibilityActionForState(v, AccessibilityNodeInfoCompat.AccessibilityActionCompat.getErrorConfigVersion, 5);
        }
        int i2 = this.state;
        if (i2 == 3) {
            replaceAccessibilityActionForState(v, AccessibilityNodeInfoCompat.AccessibilityActionCompat.NetworkUserEntityData$$ExternalSyntheticLambda0, this.fitToContents ? 4 : 6);
        } else if (i2 == 4) {
            replaceAccessibilityActionForState(v, AccessibilityNodeInfoCompat.AccessibilityActionCompat.DatabaseTableConfigUtil, this.fitToContents ? 3 : 6);
        } else if (i2 == 6) {
            replaceAccessibilityActionForState(v, AccessibilityNodeInfoCompat.AccessibilityActionCompat.NetworkUserEntityData$$ExternalSyntheticLambda0, 4);
            replaceAccessibilityActionForState(v, AccessibilityNodeInfoCompat.AccessibilityActionCompat.DatabaseTableConfigUtil, 3);
        }
    }
    ...
    private void replaceAccessibilityActionForState(V v, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, int i) {
        ViewCompat.PlaceComponentResult(v, accessibilityActionCompat, null, createAccessibilityViewCommandForState(i));
    }

    private int addAccessibilityActionForState(V v, int i, int i2) {
        return ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(v, v.getResources().getString(i), createAccessibilityViewCommandForState(i2));
    }
