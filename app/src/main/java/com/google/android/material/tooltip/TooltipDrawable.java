...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate, FSDraw {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) {
        ...
        setFillColor(ColorStateList.valueOf(obtainStyledAttributes.getColor(R.styleable.Tooltip_backgroundTint, MaterialColors.layer(ColorUtils.MyBillsEntityDataFactory(MaterialColors.getColor(this.context, 16842801, TooltipDrawable.class.getCanonicalName()), 229), ColorUtils.MyBillsEntityDataFactory(MaterialColors.getColor(this.context, R.attr.colorOnBackground, TooltipDrawable.class.getCanonicalName()), 153)))));
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(calculatePointerOffset, (float) (-((d * sqrt) - d2)));
        super.draw(canvas);
        drawText(canvas);
        canvas.restore();
    }
