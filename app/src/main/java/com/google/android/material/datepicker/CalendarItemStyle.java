...
final class CalendarItemStyle {
    ...
    private CalendarItemStyle(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int i, ShapeAppearanceModel shapeAppearanceModel, Rect rect) {
        Preconditions.PlaceComponentResult(rect.left);
        Preconditions.PlaceComponentResult(rect.top);
        Preconditions.PlaceComponentResult(rect.right);
        Preconditions.PlaceComponentResult(rect.bottom);
        this.insets = rect;
    ...
    public static CalendarItemStyle create(Context context, int i) {
        Preconditions.MyBillsEntityDataFactory(i != 0, "Cannot create a CalendarItemStyle with a styleResId of 0");
    ...
    public final void styleItem(TextView textView) {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(textView, new InsetDrawable(Build.VERSION.SDK_INT >= 21 ? new RippleDrawable(this.textColor.withAlpha(30), materialShapeDrawable, materialShapeDrawable2) : materialShapeDrawable, this.insets.left, this.insets.top, this.insets.right, this.insets.bottom));
    }
