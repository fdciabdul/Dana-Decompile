...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    */
    ...
    private void onApplySupportImageTint() {
        ...
        if (colorStateList == null) {
            DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(drawable);
            return;
        }
        ...
        drawable.mutate().setColorFilter(AppCompatDrawableManager.BuiltInFictitiousFunctionClassFactory(colorForState, mode));
    }

    @Override // android.view.View
    public void setBackgroundDrawable(Drawable drawable) {
        InstrumentInjector.log_i(LOG_TAG, "Setting a custom background is not supported.");
    }
    ...
    public void setImageResource(int i) {
        __fsTypeCheck_7c50712740147fe1efee2dfe782b1a7b(this.imageHelper, i);
        onApplySupportImageTint();
    }
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return (ShapeAppearanceModel) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(getImpl().getShapeAppearance());
    }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState((Bundle) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(extendableSavedState.extendableStates.get(EXPANDABLE_WIDGET_HELPER_KEY)));
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private boolean shouldUpdateVisibility(View view, FloatingActionButton floatingActionButton) {
            return this.autoHideEnabled && ((CoordinatorLayout.LayoutParams) floatingActionButton.getLayoutParams()).NetworkUserEntityData$$ExternalSyntheticLambda0 == view.getId() && floatingActionButton.getUserSetVisibility() == 0;
        }
        ...
        private void offsetIfNeeded(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            ...
            if (i2 != 0) {
                ViewCompat.BuiltInFictitiousFunctionClassFactory((View) floatingActionButton, i2);
            }
            if (i != 0) {
                ViewCompat.PlaceComponentResult((View) floatingActionButton, i);
            }
        }
    }
