...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        ViewCompat.moveToNextValue((View) textView, 2);
        ViewCompat.moveToNextValue((View) textView2, 2);
        setFocusable(true);
    ...
    public void initialize(MenuItemImpl menuItemImpl, int i) {
        ...
        if (Build.VERSION.SDK_INT < 21 || Build.VERSION.SDK_INT > 23) {
            TooltipCompat.PlaceComponentResult(this, title);
        }
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (Build.VERSION.SDK_INT < 21 || Build.VERSION.SDK_INT > 23) {
            TooltipCompat.PlaceComponentResult(this, charSequence);
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        MyBillsEntityDataFactory.MyBillsEntityDataFactory(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.PlaceComponentResult(0, 1, getItemVisiblePosition(), 1, false, isSelected()));
        if (isSelected()) {
    ...
    public void setEnabled(boolean z) {
        ...
        if (z) {
            ...
            ViewCompat.PlaceComponentResult(this, (PointerIconCompat) null);
        }
    }
    ...
    public void setTextAppearanceInactive(int i) {
        TextViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this.smallLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }

    public void setTextAppearanceActive(int i) {
        TextViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this.largeLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }
    ...
    public void setItemBackground(int i) {
        setItemBackground(i == 0 ? null : ContextCompat.PlaceComponentResult(getContext(), i));
    }
