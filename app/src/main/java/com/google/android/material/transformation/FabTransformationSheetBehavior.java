    ...
    private void updateImportantForAccessibility(View view, boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) && (((CoordinatorLayout.LayoutParams) childAt.getLayoutParams()).lookAheadTest instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z2) {
                    if (!z) {
