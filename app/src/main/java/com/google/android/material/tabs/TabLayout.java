...
public class TabLayout extends HorizontalScrollView {
    ...
    */
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f7435id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f7435id);
        }
        return createTabFromPool;
    }

    protected Tab createTabFromPool() {
        Tab BuiltInFictitiousFunctionClassFactory = tabPool.BuiltInFictitiousFunctionClassFactory();
        return BuiltInFictitiousFunctionClassFactory == null ? new Tab() : BuiltInFictitiousFunctionClassFactory;
    }

    protected boolean releaseFromTabPool(Tab tab) {
        return tabPool.MyBillsEntityDataFactory(tab);
    }
    ...
    public void setSelectedTabIndicatorGravity(int i) {
        if (this.tabIndicatorGravity != i) {
            ...
            ViewCompat.VerifyPinStateManager$executeRiskChallenge$2$2(this.slidingTabIndicator);
        }
    }
    ...
    public void setTabIconTintResource(int i) {
        setTabIconTint(AppCompatResources.getAuthRequestContext(getContext(), i));
    }
    ...
    public void setTabRippleColorResource(int i) {
        setTabRippleColor(AppCompatResources.getAuthRequestContext(getContext(), i));
    }
    ...
    public void setSelectedTabIndicator(int i) {
        ...
        if (i != 0) {
            ...
            setSelectedTabIndicator(BuiltInFictitiousFunctionClassFactory);
            return;
        }
    ...
    private TabView createTabView(Tab tab) {
        ...
        TabView BuiltInFictitiousFunctionClassFactory = pool != null ? pool.BuiltInFictitiousFunctionClassFactory() : null;
        if (BuiltInFictitiousFunctionClassFactory == null) {
            BuiltInFictitiousFunctionClassFactory = new TabView(getContext());
        }
        BuiltInFictitiousFunctionClassFactory.setTab(tab);
        BuiltInFictitiousFunctionClassFactory.setFocusable(true);
        BuiltInFictitiousFunctionClassFactory.setMinimumWidth(getTabMinWidth());
        if (TextUtils.isEmpty(tab.contentDesc)) {
            BuiltInFictitiousFunctionClassFactory.setContentDescription(tab.text);
        } else {
            BuiltInFictitiousFunctionClassFactory.setContentDescription(tab.contentDesc);
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(1, getTabCount(), false, 1));
    }
    ...
    */
    protected void onMeasure(int r7, int r8) {
        ...
        L41:
            ...
            r5 = 56
            float r1 = com.google.android.material.internal.ViewUtils.dpToPx(r1, r5)
            float r0 = r0 - r1
            int r1 = (int) r0
        L5c:
            r6.tabMaxWidth = r1
        ...
        L8b:
            ...
            int r3 = r3.height
            int r0 = r0 + r1
            int r8 = getChildMeasureSpec(r8, r0, r3)
    ...
    private void removeTabViewAt(int i) {
        ...
        if (tabView != null) {
            tabView.reset();
            this.tabViewPool.MyBillsEntityDataFactory(tabView);
        }
        requestLayout();
    }
    ...
    private void animateToTab(int i) {
        ...
        if (getWindowToken() == null || !ViewCompat.getValueOfTouchPositionAbsolute(this) || this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private int calculateScrollXForTab(int i, float f) {
        ...
        if (i2 == 0 || i2 == 2) {
            ...
            return ViewCompat.initRecordTimeStamp(this) == 0 ? left + i4 : left - i4;
        }
        return 0;
    }
    ...
    private void applyModeAndGravity() {
        int i = this.mode;
        ViewCompat.BuiltInFictitiousFunctionClassFactory(this.slidingTabIndicator, (i == 0 || i == 2) ? Math.max(0, this.contentInsetStart - this.tabPaddingStart) : 0, 0, 0, 0);
        int i2 = this.mode;
        if (i2 == 0) {
            applyGravityForModeScrollable(this.tabGravity);
        } else if (i2 == 1 || i2 == 2) {
            if (this.tabGravity == 2) {
                InstrumentInjector.log_w(LOG_TAG, "GRAVITY_START is not supported with the current tab mode, GRAVITY_CENTER will be used instead");
            }
    ...
    private void applyGravityForModeScrollable(int i) {
        if (i == 0) {
            InstrumentInjector.log_w(LOG_TAG, "MODE_SCROLLABLE + GRAVITY_FILL is not supported, GRAVITY_START will be used instead");
        } else if (i == 1) {
            this.slidingTabIndicator.setGravity(1);
            return;
        } else if (i != 2) {
    ...
    public static class Tab {
        ...
        public Tab setIcon(int i) {
            ...
            if (tabLayout != null) {
                BuiltInFictitiousFunctionClassFactory = ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(tabLayout.getContext(), i);
                return setIcon(BuiltInFictitiousFunctionClassFactory);
            }
    ...
    public final class TabView extends LinearLayout implements FSOuterThis {
        ...
        public final Object _fsGetOuterThis() {
        ...
        public TabView(Context context) {
            ...
            ViewCompat.BuiltInFictitiousFunctionClassFactory(this, TabLayout.this.tabPaddingStart, TabLayout.this.tabPaddingTop, TabLayout.this.tabPaddingEnd, TabLayout.this.tabPaddingBottom);
            setGravity(17);
            setOrientation(!TabLayout.this.inlineLabel ? 1 : 0);
            setClickable(true);
            ViewCompat.PlaceComponentResult(this, PointerIconCompat.PlaceComponentResult(getContext(), 1002));
        }
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabBackgroundResId != 0) {
                BuiltInFictitiousFunctionClassFactory = ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(context, TabLayout.this.tabBackgroundResId);
                this.baseBackgroundDrawable = BuiltInFictitiousFunctionClassFactory;
                if (BuiltInFictitiousFunctionClassFactory != null && BuiltInFictitiousFunctionClassFactory.isStateful()) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    drawable = new RippleDrawable(convertToRippleDrawableColor, gradientDrawable3, TabLayout.this.unboundedRipple ? null : gradientDrawable2);
                } else {
                    Drawable scheduleImpl = DrawableCompat.scheduleImpl(gradientDrawable2);
                    DrawableCompat.PlaceComponentResult(scheduleImpl, convertToRippleDrawableColor);
                    drawable = new LayerDrawable(new Drawable[]{gradientDrawable, scheduleImpl});
                }
            }
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, drawable);
        ...
        public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (badgeDrawable != null && badgeDrawable.isVisible()) {
                ...
                sb.append(", ");
                sb.append((Object) this.badgeDrawable.getContentDescription());
            ...
            MyBillsEntityDataFactory.MyBillsEntityDataFactory(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.PlaceComponentResult(0, 1, this.tab.getPosition(), 1, false, isSelected()));
            if (isSelected()) {
                MyBillsEntityDataFactory.PlaceComponentResult(false);
                MyBillsEntityDataFactory.getAuthRequestContext(AccessibilityNodeInfoCompat.AccessibilityActionCompat.BuiltInFictitiousFunctionClassFactory);
            }
            MyBillsEntityDataFactory.lookAheadTest(getResources().getString(R.string.item_view_role_description));
        }
        ...
        public final void onMeasure(int i, int i2) {
            ...
            if (this.textView != null) {
                ...
                int authRequestContext = TextViewCompat.getAuthRequestContext(this.textView);
                if (f != textSize || (authRequestContext >= 0 && i3 != authRequestContext)) {
        ...
        final void update() {
            ...
            if (customView != null) {
                ...
                if (textView2 != null) {
                    this.defaultMaxLines = TextViewCompat.getAuthRequestContext(textView2);
                }
            ...
            if (this.customView == null) {
                ...
                if (tab != null && tab.getIcon() != null) {
                    drawable = DrawableCompat.scheduleImpl(tab.getIcon()).mutate();
                }
                if (drawable != null) {
                    DrawableCompat.PlaceComponentResult(drawable, TabLayout.this.tabIconTint);
                    if (TabLayout.this.tabIconTintMode != null) {
                        DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(drawable, TabLayout.this.tabIconTintMode);
                    }
                }
                if (this.textView == null) {
                    inflateAndAddDefaultTextView();
                    this.defaultMaxLines = TextViewCompat.getAuthRequestContext(this.textView);
                }
                TextViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this.textView, TabLayout.this.tabTextAppearance);
        ...
        private void updateTextAndIcon(TextView textView, ImageView imageView) {
            Tab tab = this.tab;
            Drawable mutate = (tab == null || tab.getIcon() == null) ? null : DrawableCompat.scheduleImpl(this.tab.getIcon()).mutate();
            Tab tab2 = this.tab;
            ...
            if (imageView != null) {
                ...
                if (TabLayout.this.inlineLabel) {
                    if (dpToPx != MarginLayoutParamsCompat.BuiltInFictitiousFunctionClassFactory(marginLayoutParams)) {
                        MarginLayoutParamsCompat.getAuthRequestContext(marginLayoutParams, dpToPx);
                    ...
                    MarginLayoutParamsCompat.getAuthRequestContext(marginLayoutParams, 0);
                    imageView.setLayoutParams(marginLayoutParams);
                    imageView.requestLayout();
                }
            }
            ...
            if (Build.VERSION.SDK_INT < 21 || Build.VERSION.SDK_INT > 23) {
                ...
                TooltipCompat.PlaceComponentResult(this, text);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (TabLayout.this.tabSelectedIndicator.getBounds().width() > 0) {
                ...
                if (TabLayout.this.tabSelectedIndicatorColor != 0) {
                    drawable = DrawableCompat.scheduleImpl(drawable);
                    if (Build.VERSION.SDK_INT == 21) {
                        drawable.setColorFilter(TabLayout.this.tabSelectedIndicatorColor, PorterDuff.Mode.SRC_IN);
                    } else {
                        DrawableCompat.MyBillsEntityDataFactory(drawable, TabLayout.this.tabSelectedIndicatorColor);
                    }
                }
