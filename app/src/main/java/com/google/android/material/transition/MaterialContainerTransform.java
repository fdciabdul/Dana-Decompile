...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            transitionValues.MyBillsEntityDataFactory = TransitionUtils.findDescendantOrAncestorById(transitionValues.MyBillsEntityDataFactory, i);
        } else if (view != null) {
            transitionValues.MyBillsEntityDataFactory = view;
        } else if (transitionValues.MyBillsEntityDataFactory.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) transitionValues.MyBillsEntityDataFactory.getTag(R.id.mtrl_motion_snapshot_view);
            transitionValues.MyBillsEntityDataFactory.setTag(R.id.mtrl_motion_snapshot_view, null);
            transitionValues.MyBillsEntityDataFactory = view2;
        }
        View view3 = transitionValues.MyBillsEntityDataFactory;
        if (!ViewCompat.getValueOfTouchPositionAbsolute(view3) && view3.getWidth() == 0 && view3.getHeight() == 0) {
            return;
        }
        ...
        transitionValues.getAuthRequestContext.put(PROP_BOUNDS, relativeBounds);
        transitionValues.getAuthRequestContext.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view3, relativeBounds, shapeAppearanceModel));
    }
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            RectF rectF = (RectF) transitionValues.getAuthRequestContext.get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) transitionValues.getAuthRequestContext.get(PROP_SHAPE_APPEARANCE);
            if (rectF == null || shapeAppearanceModel == null) {
                InstrumentInjector.log_w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                RectF rectF2 = (RectF) transitionValues2.getAuthRequestContext.get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) transitionValues2.getAuthRequestContext.get(PROP_SHAPE_APPEARANCE);
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    InstrumentInjector.log_w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View view2 = transitionValues.MyBillsEntityDataFactory;
                final View view3 = transitionValues2.MyBillsEntityDataFactory;
    ...
    private static float getElevationOrDefault(float f, View view) {
        return f == -1.0f ? ViewCompat.getErrorConfigVersion(view) : f;
    }
    ...
    /* loaded from: classes7.dex */
    static final class TransitionDrawable extends Drawable implements FSDraw {
        ...
        private void updateProgress(float f) {
            ...
            float f6 = f3;
            float f7 = f4;
            FitModeResult evaluate = this.fitModeEvaluator.evaluate(f, ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.scale.start))).floatValue(), ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.scale.end))).floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            float floatValue = ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.scaleMask.start))).floatValue();
            float floatValue2 = ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.scaleMask.end))).floatValue();
            ...
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f, ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(Float.valueOf(this.progressThresholds.fade.end))).floatValue(), 0.35f);
