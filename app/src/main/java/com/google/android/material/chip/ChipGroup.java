    ...
    */
    public ChipGroup(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        L69:
            ...
            r8 = 1
            androidx.core.view.ViewCompat.moveToNextValue(r7, r8)
            return
        */
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(getRowCount(), isSingleLine() ? getChipCount() : -1, false, isSingleSelection() ? 1 : 2));
    }
    ...
    class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View view, View view2) {
            if (view == ChipGroup.this && (view2 instanceof Chip)) {
                if (view2.getId() == -1) {
                    view2.setId(ViewCompat.MyBillsEntityDataFactory());
                }
