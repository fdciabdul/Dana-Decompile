...
public final class CollapsingTextHelper implements FSDraw {
    ...
    public final void setExpansionFraction(float f) {
        float authRequestContext = MathUtils.getAuthRequestContext(f, 0.0f, 1.0f);
        if (authRequestContext != this.expandedFraction) {
            this.expandedFraction = authRequestContext;
    ...
    private void calculateOffsets(float f) {
        ...
        ViewCompat.VerifyPinStateManager$executeRiskChallenge$2$2(this.view);
    }
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        int BuiltInFictitiousFunctionClassFactory = GravityCompat.BuiltInFictitiousFunctionClassFactory(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        int i = BuiltInFictitiousFunctionClassFactory & 112;
        if (i == 48) {
        ...
        int i2 = BuiltInFictitiousFunctionClassFactory & 8388615;
        if (i2 == 1) {
        ...
        int BuiltInFictitiousFunctionClassFactory2 = GravityCompat.BuiltInFictitiousFunctionClassFactory(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = BuiltInFictitiousFunctionClassFactory2 & 112;
        if (i3 == 48) {
        ...
        int i4 = BuiltInFictitiousFunctionClassFactory2 & 8388615;
        if (i4 == 1) {
    ...
    private boolean isDefaultIsRtl() {
        return ViewCompat.initRecordTimeStamp(this.view) == 1;
    }

    private boolean isTextDirectionHeuristicsIsRtl(CharSequence charSequence, boolean z) {
        return (z ? TextDirectionHeuristicsCompat.KClassImpl$Data$declaredNonStaticMembers$2 : TextDirectionHeuristicsCompat.PlaceComponentResult).getAuthRequestContext(charSequence, 0, charSequence.length());
    }
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z) {
        ...
        try {
            ...
            InstrumentInjector.log_e(TAG, e.getCause().getMessage(), e);
            staticLayout = null;
        }
        return (StaticLayout) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(staticLayout);
    }
