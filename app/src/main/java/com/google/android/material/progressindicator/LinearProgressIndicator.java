...
public final class LinearProgressIndicator extends BaseProgressIndicator<LinearProgressIndicatorSpec> {
    ...
    protected final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 1 && ((ViewCompat.initRecordTimeStamp(this) != 1 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 2) && (ViewCompat.initRecordTimeStamp(this) != 0 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 3))) {
            z2 = false;
        }
    ...
    public final void setIndicatorDirection(int i) {
        ...
        LinearProgressIndicatorSpec linearProgressIndicatorSpec = (LinearProgressIndicatorSpec) this.spec;
        boolean z = true;
        if (i != 1 && ((ViewCompat.initRecordTimeStamp(this) != 1 || ((LinearProgressIndicatorSpec) this.spec).indicatorDirection != 2) && (ViewCompat.initRecordTimeStamp(this) != 0 || i != 3))) {
            z = false;
        }
