...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    */
    ...
    public void setRippleColorResource(int i) {
        this.cardViewHelper.setRippleColor(AppCompatResources.getAuthRequestContext(getContext(), i));
    }
    ...
    public void setCheckedIconResource(int i) {
        this.cardViewHelper.setCheckedIcon(AppCompatResources.KClassImpl$Data$declaredNonStaticMembers$2(getContext(), i));
    }
