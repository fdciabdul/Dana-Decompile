...
public class MaterialCardViewHelper {
    ...
    public void setCheckedIcon(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            this.checkedIcon = scheduleImpl;
            DrawableCompat.PlaceComponentResult(scheduleImpl, this.checkedIconTint);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if (ViewCompat.initRecordTimeStamp(this.materialCardView) == 1) {
                i4 = i7;
                i3 = i10;
            } else {
                i3 = i7;
