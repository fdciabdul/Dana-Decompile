    ...
    */
    public MaterialButtonToggleGroup(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            r8.recycle()
            androidx.core.view.ViewCompat.moveToNextValue(r6, r7)
            return
        */
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            InstrumentInjector.log_e(LOG_TAG, "Child views must be of type MaterialButton.");
            return;
        }
        ...
        ViewCompat.MyBillsEntityDataFactory(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.button.MaterialButtonToggleGroup.2
            {
                MaterialButtonToggleGroup.this = this;
            }

            @Override // androidx.core.view.AccessibilityDelegateCompat
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                super.onInitializeAccessibilityNodeInfo(view2, accessibilityNodeInfoCompat);
                accessibilityNodeInfoCompat.MyBillsEntityDataFactory(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.PlaceComponentResult(0, 1, MaterialButtonToggleGroup.this.getIndexWithinVisibleButtons(view2), 1, false, ((MaterialButton) view2).isChecked()));
            }
        });
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(1, getVisibleButtonCount(), false, isSingleSelection() ? 1 : 2));
    }
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
            ...
            if (getOrientation() == 0) {
                MarginLayoutParamsCompat.getAuthRequestContext(buildLayoutParams, 0);
                MarginLayoutParamsCompat.KClassImpl$Data$declaredNonStaticMembers$2(buildLayoutParams, -min);
                buildLayoutParams.topMargin = 0;
            } else {
                buildLayoutParams.bottomMargin = 0;
                buildLayoutParams.topMargin = -min;
                MarginLayoutParamsCompat.KClassImpl$Data$declaredNonStaticMembers$2(buildLayoutParams, 0);
            }
    ...
    private void resetChildMargins(int i) {
        ...
        MarginLayoutParamsCompat.getAuthRequestContext(layoutParams, 0);
        MarginLayoutParamsCompat.KClassImpl$Data$declaredNonStaticMembers$2(layoutParams, 0);
    ...
    private void setGeneratedIdIfNeeded(MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(ViewCompat.MyBillsEntityDataFactory());
        }
    }
    ...
    protected int getChildDrawingOrder(int i, int i2) {
        ...
        if (numArr == null || i2 >= numArr.length) {
            InstrumentInjector.log_w(LOG_TAG, "Child order wasn't updated");
            return i2;
        }
