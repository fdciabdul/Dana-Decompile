...
public final class zaad {
    private final Map<BasePendingResult<?>, Boolean> zaa = DesugarCollections.MyBillsEntityDataFactory(new WeakHashMap());
    private final Map<TaskCompletionSource<?>, Boolean> zab = DesugarCollections.MyBillsEntityDataFactory(new WeakHashMap());
