...
public final class zaaa extends Button {
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        Drawable scheduleImpl = DrawableCompat.scheduleImpl(InstrumentInjector.Resources_getDrawable(resources, zab));
        DrawableCompat.PlaceComponentResult(scheduleImpl, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(scheduleImpl, PorterDuff.Mode.SRC_ATOP);
        setBackgroundDrawable(scheduleImpl);
