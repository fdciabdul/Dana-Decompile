...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    private String zac;
    public static final byte[] getAuthRequestContext = {93, 18, 67, -65, Ascii.NAK, -2, 22, 5, 2, 3, -46, 61, Ascii.DC4, 7, 14, -7, 17, 14, -62, Ascii.GS, TarHeader.LF_BLK, 7, 14, -7, Ascii.ESC, 4, 6, Ascii.ETB, -43, TarHeader.LF_CONTIG, 8, 4, 5, 2, 6, Ascii.ESC, -3, 14, 7, -29, 45, 0, 17};
    public static final int PlaceComponentResult = 41;
    ...
    */
    private static void a(byte r6, int r7, short r8, java.lang.Object[] r9) {
        /*
            byte[] r0 = com.google.android.gms.common.GoogleApiAvailability.getAuthRequestContext
            int r6 = r6 * 6
            int r6 = r6 + 97
            int r8 = r8 * 5
            int r8 = 23 - r8
        ...
        L37:
            ...
            goto L1c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.GoogleApiAvailability.a(byte, int, short, java.lang.Object[]):void");
    }
    ...
    public final Dialog zaa(Context context, int i, zag zagVar, DialogInterface.OnCancelListener onCancelListener) {
        ...
        InstrumentInjector.log_w("GoogleApiAvailability", String.format("Creating dialog for Google Play services availability issue. ConnectionResult=%s", Integer.valueOf(i)), new IllegalArgumentException());
    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        int i2;
        String str2;
        InstrumentInjector.log_w("GoogleApiAvailability", String.format("GMS core API Availability. ConnectionResult=%s, tag=%s", Integer.valueOf(i), null), new IllegalArgumentException());
        if (i == 18) {
            zaf(context);
            ...
            NotificationCompat.Builder authRequestContext = new NotificationCompat.Builder(context).PlaceComponentResult(true).BuiltInFictitiousFunctionClassFactory(true).getAuthRequestContext(zaf).getAuthRequestContext(new NotificationCompat.BigTextStyle().getAuthRequestContext(zae));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                try {
                    byte b = getAuthRequestContext[41];
                    Object[] objArr = new Object[1];
                    a(b, (byte) (b + 1), getAuthRequestContext[41], objArr);
                    Class<?> cls = Class.forName((String) objArr[0]);
                    byte b2 = (byte) (PlaceComponentResult & 7);
                    byte b3 = getAuthRequestContext[41];
                    Object[] objArr2 = new Object[1];
                    a(b2, b3, (byte) (b3 + 1), objArr2);
                    authRequestContext.getAuthRequestContext(((ApplicationInfo) cls.getMethod((String) objArr2[0], null).invoke(context, null)).icon).KClassImpl$Data$declaredNonStaticMembers$2(2);
                    if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                        authRequestContext.MyBillsEntityDataFactory(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
                    } else {
                        authRequestContext.KClassImpl$Data$declaredNonStaticMembers$2(pendingIntent);
                    }
                } catch (Throwable th) {
                ...
                authRequestContext.getAuthRequestContext(17301642).KClassImpl$Data$declaredNonStaticMembers$2(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).KClassImpl$Data$declaredNonStaticMembers$2(System.currentTimeMillis()).KClassImpl$Data$declaredNonStaticMembers$2(pendingIntent).MyBillsEntityDataFactory(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
                ...
                authRequestContext.BuiltInFictitiousFunctionClassFactory(str2);
            }
            Notification BuiltInFictitiousFunctionClassFactory = authRequestContext.BuiltInFictitiousFunctionClassFactory();
            if (i == 1 || i == 2 || i == 3) {
            ...
            notificationManager.notify(i2, BuiltInFictitiousFunctionClassFactory);
        }
    }
    ...
    public final boolean zag(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa(activity, i, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i, d.f7256a), 2), onCancelListener);
        if (zaa2 == null) {
            return false;
        }
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, d.f7256a), i2), onCancelListener);
    }
    ...
    public Dialog getErrorDialog(Fragment fragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, d.f7256a), i2), onCancelListener);
    }
}
