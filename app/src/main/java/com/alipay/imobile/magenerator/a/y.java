...
public final class y {
    ...
    public final int c() {
        return (this.f7024a * 4) + 17;
    }

    public final String toString() {
        return String.valueOf(this.f7024a);
    }
}
