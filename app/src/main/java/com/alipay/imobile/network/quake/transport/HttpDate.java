...
public final class HttpDate {
    ...
    private static final ThreadLocal<DateFormat> f7060a = new a();
    ...
    class a extends ThreadLocal<DateFormat> {
        ...
        public DateFormat initialValue() {
            ...
            simpleDateFormat.setTimeZone(e.f7080a);
    ...
    public static Date parse(String str) {
        ...
        Date parse = f7060a.get().parse(str, parsePosition);
        ...
        synchronized (strArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (dateFormat == null) {
                    ...
                    dateFormat.setTimeZone(e.f7080a);
