...
public final class BuildConfig {
    ...
    public static final String CAMERA_RS435 = "RS435";
    public static final boolean DEBUG = false;
    public static final String FLAVOR = "";
    public static final String ISP = "";
    public static final String ISP_ASTRA_PRO = "AstraPro";
    public static final String ISP_ASTRA_PRO2 = "AstraPro2";
    public static final Boolean OFFLINE = Boolean.FALSE;
