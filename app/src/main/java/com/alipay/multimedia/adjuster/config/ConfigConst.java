...
public class ConfigConst {
    ...
    public static final int[] CDN_IMAGE_SIZE = {16, 20, 24, 30, 32, 36, 40, 48, 50, 60, 64, 70, 72, 80, 88, 90, 100, 110, 120, 125, 128, 130, 145, BlobStatic.MONITOR_IMAGE_WIDTH, 170, 180, 190, 200, 210, WheelView.DIVIDER_ALPHA, 230, 234, 240, 250, 270, 290, 300, SecExceptionCode.SEC_ERROR_STA_INVALID_ENCRYPTED_DATA, 315, 320, 336, 350, AUScreenAdaptTool.WIDTH_BASE, 400, 430, 460, 468, 480, 490, 540, 560, 570, 580, 600, 640, 670, 720, 728, 760, 960, 970};
