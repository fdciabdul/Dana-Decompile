...
public class AlertUtil {
    ...
    private Dialog realAlertRetryTimeout() {
        return realAlert("retryOverMax", R2.string.zface_retry_max_title(), R2.string.zface_retry_max_msg(), R2.string.zface_retry_max_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.1
    ...
    public void alertRetryOutTime() {
        alert("retryOverMax", R2.string.zface_retry_max_title(), R2.string.zface_retry_max_msg(), R2.string.zface_retry_max_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.5
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.sendResponse(209, CodeConstants.OUT_TIME);
            }
    ...
    public void alertLivelessFail() {
        alert("livelessFail", R2.string.zface_retry_max_title(), R2.string.zface_retry_max_msg(), R2.string.zface_retry_max_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.6
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertFirstLogin() {
        alert("authorization", R2.string.zface_detect_dialog_first_login(), "", R2.string.zface_detect_dialog_first_login_confirm(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.7
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retry(AlertUtil.this.mRetryTimes);
            }
        }, R2.string.zface_detect_dialog_first_login_cancel(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.8
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertFailRetry() {
        alert("livnessFail", R2.string.zface_scan_fail_title(), R2.string.zface_scan_fail_msg(), R2.string.zface_scan_fail_retry(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.9
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retry(AlertUtil.this.mRetryTimes);
            }
        }, R2.string.zface_scan_fail_quit(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.10
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertInterruptResume() {
        alert("systemInterrupt", R2.string.zface_interrupt_title(), R2.string.zface_interrupt_msg(), R2.string.zface_interrupt_retry(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.11
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retry(AlertUtil.this.mRetryTimes);
            }
        }, R2.string.zface_interrupt_close(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.12
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertTimeOut() {
        alert(TwilioIdentityVerificationActivity.CHALLENGE_INFO_TIMEOUT, R2.string.zface_time_out_title(), R2.string.zface_time_out_msg(), R2.string.zface_time_out_retry(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.13
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retry(AlertUtil.this.mRetryTimes);
            }
        }, R2.string.zface_time_out_quit(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.14
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertSystemNotSupport(final String str) {
        alert("errorDeviceModel", R2.string.zface_device_unsupport_msg(), "", R2.string.zface_device_unsupport_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.15
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertCameraOpenFailed() {
        alert("cameraInitError", R2.string.zface_camera_init_error_msg(), "", R2.string.zface_camera_init_error_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.16
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertCameraPermissionFailed(DialogInterface.OnClickListener onClickListener) {
        alert("cameraPermission", R2.string.zface_camera_without_permission_title(), R2.string.zface_camera_without_permission_msg(), R2.string.zface_camera_without_permission_go_settings(), onClickListener, R2.string.zface_camera_without_permission_quit(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.17
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertSystemError() {
        alert("loadAlgorithmErr", R2.string.system_error_title(), R2.string.system_error_msg(), R2.string.system_error_got_it(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.18
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertNetworkError() {
        this.mRetryTimes--;
        alert("networkFail", R2.string.network_error_title(), R2.string.network_error_msg(), R2.string.network_error_retry(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.19
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retryUpload();
            }
        }, R2.string.network_error_exit(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.20
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void alertBack() {
        alert("clickXback", R2.string.zface_user_cancel_title(), R2.string.zface_user_cancel_msg(), R2.string.zface_user_cancel_stay(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.21
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertUtil.this.mAlertClickEvents.retry(AlertUtil.this.mRetryTimes);
            }
        }, R2.string.zface_user_cancel_quit(), new DialogInterface.OnClickListener() { // from class: com.alipay.zoloz.zface.ui.util.AlertUtil.22
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
