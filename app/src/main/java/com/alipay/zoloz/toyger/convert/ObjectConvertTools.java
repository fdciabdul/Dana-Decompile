...
public class ObjectConvertTools {
    private static Map<Class, IOriginalConverter<?>> mAllConverter = new HashMap<Class, IOriginalConverter<?>>() { // from class: com.alipay.zoloz.toyger.convert.ObjectConvertTools.1
        {
