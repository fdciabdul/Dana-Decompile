...
public class LoggerFactory {
    ...
    public static void init(Application application) {
        ...
        HybridEncryption.createInstance(application);
    ...
    private static void initToolsProcessIfNeeded(Application application, InitParams initParams) {
    ...
    public static void initLater(Application application, InitParams initParams) {
    ...
    public static TraceLogger getInnerTraceLogger() {
        TraceLogger traceLogger2;
        synchronized (LoggerFactory.class) {
