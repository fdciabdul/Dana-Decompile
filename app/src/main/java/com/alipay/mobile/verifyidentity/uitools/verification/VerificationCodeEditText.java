...
public class VerificationCodeEditText extends EditText implements VerificationAction, TextWatcher {
    ...
    private void initAttrs(AttributeSet attributeSet) {
        ...
        this.mVerCodeMargin = (int) obtainStyledAttributes.getDimension(R.styleable.VerCodeEditText_verCodeMargin, dp2px(10));
        ...
        this.mBottomLineHeight = obtainStyledAttributes.getDimension(R.styleable.VerCodeEditText_bottomLineHeight, dp2px(1));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < obj.length(); i4++) {
            canvas.save();
            float f2 = (paddingLeft * i4) + (this.mVerCodeMargin * i4) + (paddingLeft / 2);
            ...
            if (this.inputStyle != 1021) {
                ...
                f = ((((measuredHeight - fontMetrics.bottom) + fontMetrics.top) * 100.0f) / 99.0f) - fontMetrics.top;
            }
        ...
        if (this.inputStyle != 1021 && this.showCursor) {
            ...
            canvas.drawLine(((length + 0.5f) * f3) + (obj.length() * this.mVerCodeMargin), i5, (obj.length() * this.mVerCodeMargin) + (f3 * (obj.length() + 0.5f)), i5 * 5, this.mBottomLineCursorPaint);
            canvas.restore();
        }
        for (int i6 = 0; i6 < this.mFigures; i6++) {
            ...
            if (i6 < i9) {
                if (this.inputStyle != 1021) {
                    canvas.drawLine(i7, f4, i8, f4, this.mBottomSelectedPaint);
                }
            } else if (i6 == i9) {
                canvas.drawLine(i7, f4, i8, f4, this.mBottomLineCursorPaint);
            } else {
                canvas.drawLine(i7, f4, i8, f4, this.mBottomNormalPaint);
            }
            canvas.restore();
        }
    }
