...
public class TipToast extends Toast {
    ...
    public void setStatus(int i) {
        if (i == 0) {
            ...
            InstrumentInjector.Resources_setImageResource(this.iv_fill, R.drawable.tip_right);
            this.msgView.setText(R.string.operate_success);
        } else if (i == 1) {
            this.fl_fill.setVisibility(0);
            InstrumentInjector.Resources_setImageResource(this.iv_fill, R.drawable.tip_fail);
            this.msgView.setText(R.string.operate_fail);
        } else if (i == 2) {
            this.fl_fill.setVisibility(0);
            InstrumentInjector.Resources_setImageResource(this.iv_fill, R.drawable.tip_warn);
