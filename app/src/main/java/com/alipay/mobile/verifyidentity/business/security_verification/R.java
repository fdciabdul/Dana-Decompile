package com.alipay.mobile.verifyidentity.business.security_verification;
...
public final class R {
    ...
    public static final class drawable {
        ...
        public static int verify_confirm_selected = com.alipay.mobile.verifyidentity.international.R.drawable.verify_confirm_selected;
        public static int verify_confirm_unselected = com.alipay.mobile.verifyidentity.international.R.drawable.verify_confirm_unselected;
    ...
    public static final class layout {
        public static int activity_verifu_security = com.alipay.mobile.verifyidentity.international.R.layout.activity_verifu_security;
        public static int dialog_multiple = com.alipay.mobile.verifyidentity.international.R.layout.dialog_multiple;
        public static int fragment_verify_security = com.alipay.mobile.verifyidentity.international.R.layout.fragment_verify_security;
        public static int item_multiple_dialog = com.alipay.mobile.verifyidentity.international.R.layout.item_multiple_dialog;
        public static int security_verifyquestion_item = com.alipay.mobile.verifyidentity.international.R.layout.security_verifyquestion_item;
    }
    ...
    public static final class string {
        ...
        public static int theme_title_back = com.alipay.mobile.verifyidentity.international.R.string.theme_title_back;
        public static int verify_security_next = com.alipay.mobile.verifyidentity.international.R.string.verify_security_next;
        public static int verify_security_submit = com.alipay.mobile.verifyidentity.international.R.string.verify_security_submit;
        public static int verify_success = com.alipay.mobile.verifyidentity.international.R.string.verify_success;
    }
}
