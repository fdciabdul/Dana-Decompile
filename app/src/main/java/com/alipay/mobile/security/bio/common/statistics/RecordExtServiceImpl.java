...
public class RecordExtServiceImpl extends RecordExtService {
    ...
    protected Hashtable<RecordExtAction, MetaRecord> actionMaps = new Hashtable<RecordExtAction, MetaRecord>() { // from class: com.alipay.mobile.security.bio.common.statistics.RecordExtServiceImpl.1
        {
