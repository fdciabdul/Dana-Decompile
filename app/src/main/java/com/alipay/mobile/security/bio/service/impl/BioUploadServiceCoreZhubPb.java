        ...
        try {
            ...
            if (validateStandard == null) {
                ...
                if (validateStandard.extParams != null && validateStandard.extParams.entries != null && !validateStandard.extParams.entries.isEmpty()) {
                    ...
                    for (EntryStringString entryStringString3 : list) {
                        bioUploadResult.extParams.put(entryStringString3.key, entryStringString3.value);
                    }
                }
            }
        } catch (Exception e) {
            if ((e instanceof IRpcException) && ((code = ((IRpcException) e).getCode()) == 4001 || code == 5 || code == 16 || code == 2)) {
