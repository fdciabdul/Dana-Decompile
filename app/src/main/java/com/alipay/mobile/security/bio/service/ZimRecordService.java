...
public abstract class ZimRecordService extends BioService {
    public static final HashSet<String> EXCLUDE_EXT_PARAMS = new HashSet<>(Arrays.asList(HummerConstants.ZIM_ID, "logModelVersion", "logPlanId", "sceneId", "uiVersion", "logType", "ekycId"));
