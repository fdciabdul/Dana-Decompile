...
public interface BioDetector {
    ...
    public static final String EXT_KEY_RETRY_UI_TYPE = "retryUiType";
    ...
    public static final String EXT_KEY_UI = "ui";
    ...
    public static final String EXT_KEY_USE_CONTEXT = "use_context";
