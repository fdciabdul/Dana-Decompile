...
final /* synthetic */ class ServiceFacade$Builder$build$1 extends MutablePropertyReference0 {
    ...
    public final String getSignature() {
        return "getMyBillsEntityDataFactory()Landroid/content/Context;";
    }

    @Override // kotlin.reflect.KProperty0
    public final Object get() {
        return ServiceFacade.Builder.PlaceComponentResult((ServiceFacade.Builder) this.receiver);
    }

    @Override // kotlin.reflect.KMutableProperty0
    public final void set(Object obj) {
        ((ServiceFacade.Builder) this.receiver).getAuthRequestContext = (Context) obj;
    }
}
