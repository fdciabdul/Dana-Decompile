...
public final class FactorAPIClient$update$1 extends Lambda implements Function1<Integer, Unit> {
    ...
    public FactorAPIClient$update$1(FactorAPIClient factorAPIClient, Factor factor, UpdateFactorPayload updateFactorPayload, Function1 function1, Function1 function12) {
        super(1);
    ...
    public static /* synthetic */ void invoke$default(FactorAPIClient$update$1 factorAPIClient$update$1, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 1;
        }
        factorAPIClient$update$1.invoke(i);
    }
    ...
    public final void invoke(final int i) {
        ...
        try {
            ...
            Request.Builder builder = new Request.Builder(new RequestHelper(context, new BasicAuthorization("token", MyBillsEntityDataFactory)), FactorAPIClient.MyBillsEntityDataFactory(this.this$0, this.$$factor), null, null, null, null, null, 124, null);
            HttpMethod httpMethod = HttpMethod.Post;
            Intrinsics.checkParameterIsNotNull(httpMethod, "");
            Request.Builder builder2 = builder;
            builder.getAuthRequestContext = httpMethod;
            Map<String, ? extends Object> KClassImpl$Data$declaredNonStaticMembers$2 = FactorAPIClient.KClassImpl$Data$declaredNonStaticMembers$2(this.$$updateFactorPayload);
            Intrinsics.checkParameterIsNotNull(KClassImpl$Data$declaredNonStaticMembers$2, "");
            Request.Builder builder3 = builder;
            builder.KClassImpl$Data$declaredNonStaticMembers$2 = KClassImpl$Data$declaredNonStaticMembers$2;
            Request KClassImpl$Data$declaredNonStaticMembers$22 = builder.KClassImpl$Data$declaredNonStaticMembers$2();
            networkProvider = this.this$0.BuiltInFictitiousFunctionClassFactory;
            networkProvider.BuiltInFictitiousFunctionClassFactory(KClassImpl$Data$declaredNonStaticMembers$22, new Function1<Response, Unit>() { // from class: com.twilio.verify.api.FactorAPIClient$update$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    FactorAPIClient$update$1.this = this;
                }
                ...
                public final void invoke2(Response response) {
                    ...
                    FactorAPIClient$update$1.this.$$success.invoke(new JSONObject(response.KClassImpl$Data$declaredNonStaticMembers$2));
                }
            }, new Function1<NetworkException, Unit>() { // from class: com.twilio.verify.api.FactorAPIClient$update$1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    FactorAPIClient$update$1.this = this;
                ...
                /* renamed from: com.twilio.verify.api.FactorAPIClient$update$1$2$1 */
                /* loaded from: classes3.dex */
                public static final /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<Integer, Unit> {
                    ...
                    public final void invoke(int i) {
                        FactorAPIClient$update$1.this.invoke(i);
                    }
                }
                ...
                public final void invoke2(NetworkException networkException) {
                    ...
                    FactorAPIClient$update$1.this.this$0.MyBillsEntityDataFactory(networkException, new AnonymousClass1(), i, FactorAPIClient$update$1.this.$$error);
                }
            });
