...
public final class ServiceAPIClient$get$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ Function1 $$error;
    final /* synthetic */ Factor $$factor;
    final /* synthetic */ String $$serviceSid;
    final /* synthetic */ Function1 $$success;
    final /* synthetic */ ServiceAPIClient this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ServiceAPIClient$get$1(ServiceAPIClient serviceAPIClient, Factor factor, String str, Function1 function1, Function1 function12) {
        super(1);
        this.this$0 = serviceAPIClient;
        this.$$factor = factor;
        this.$$serviceSid = str;
    ...
    public static /* synthetic */ void invoke$default(ServiceAPIClient$get$1 serviceAPIClient$get$1, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 1;
        }
        serviceAPIClient$get$1.invoke(i);
    }
    ...
    public final void invoke(final int i) {
        ...
        try {
            ...
            context = this.this$0.KClassImpl$Data$declaredNonStaticMembers$2;
            Request.Builder builder = new Request.Builder(new RequestHelper(context, new BasicAuthorization("token", MyBillsEntityDataFactory)), ServiceAPIClient.PlaceComponentResult(this.this$0, this.$$serviceSid), null, null, null, null, null, 124, null);
            ...
            networkProvider.BuiltInFictitiousFunctionClassFactory(KClassImpl$Data$declaredNonStaticMembers$2, new Function1<Response, Unit>() { // from class: com.twilio.verify.api.ServiceAPIClient$get$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    ServiceAPIClient$get$1.this = this;
                }
                ...
                public final void invoke2(Response response) {
                    ...
                    ServiceAPIClient$get$1.this.$$success.invoke(new JSONObject(response.KClassImpl$Data$declaredNonStaticMembers$2));
                }
            }, new Function1<NetworkException, Unit>() { // from class: com.twilio.verify.api.ServiceAPIClient$get$1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    ServiceAPIClient$get$1.this = this;
                ...
                /* renamed from: com.twilio.verify.api.ServiceAPIClient$get$1$2$1 */
                /* loaded from: classes8.dex */
                public static final /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<Integer, Unit> {
                    ...
                    public final void invoke(int i) {
                        ServiceAPIClient$get$1.this.invoke(i);
                    }
                }
                ...
                public final void invoke2(NetworkException networkException) {
                    ...
                    ServiceAPIClient$get$1.this.this$0.MyBillsEntityDataFactory(networkException, new AnonymousClass1(), i, ServiceAPIClient$get$1.this.$$error);
                }
            });
