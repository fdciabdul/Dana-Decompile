...
public final class ChallengeAPIClient$update$1 extends Lambda implements Function1<Integer, Unit> {
    ...
    final /* synthetic */ FactorChallenge $$challenge;
    ...
    public static /* synthetic */ void invoke$default(ChallengeAPIClient$update$1 challengeAPIClient$update$1, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 1;
        }
        challengeAPIClient$update$1.invoke(i);
    }
    ...
    public final void invoke(final int i) {
        ...
        try {
            Factor factor = this.$$challenge.KClassImpl$Data$declaredNonStaticMembers$2;
            if (factor != null) {
                authentication = this.this$0.MyBillsEntityDataFactory;
                String MyBillsEntityDataFactory = authentication.MyBillsEntityDataFactory(factor);
                context = this.this$0.BuiltInFictitiousFunctionClassFactory;
                Request.Builder builder = new Request.Builder(new RequestHelper(context, new BasicAuthorization("token", MyBillsEntityDataFactory)), ChallengeAPIClient.KClassImpl$Data$declaredNonStaticMembers$2(this.this$0, this.$$challenge), null, null, null, null, null, 124, null);
                ...
                networkProvider.BuiltInFictitiousFunctionClassFactory(KClassImpl$Data$declaredNonStaticMembers$2, new Function1<Response, Unit>() { // from class: com.twilio.verify.api.ChallengeAPIClient$update$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                        ChallengeAPIClient$update$1.this = this;
                    }
                    ...
                    /* renamed from: com.twilio.verify.api.ChallengeAPIClient$update$1$2$1 */
                    /* loaded from: classes3.dex */
                    public static final /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<Integer, Unit> {
                        ...
                        public final void invoke(int i) {
                            ChallengeAPIClient$update$1.this.invoke(i);
                        }
                    }
                    ...
                    public final void invoke2(NetworkException networkException) {
                        ...
                        ChallengeAPIClient$update$1.this.this$0.MyBillsEntityDataFactory(networkException, new AnonymousClass1(), i, ChallengeAPIClient$update$1.this.$$error);
                    }
                });
                return;
            }
