...
public class NotInstalledHmsResolution implements IBridgeActivityDelegate {
    ...
    public final void a(Activity activity) {
        a();
        this.f7505a = NotInstalledHmsDialogHelper.getDialogBuilder(activity).setPositiveButton(NotInstalledHmsDialogHelper.getConfirmResId(activity), new a(activity)).show();
    }
