...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static class Builder {
        ...
        public DataHolder build(int i) {
            ?? r1 = 0;
            return new DataHolder(this, i, (Bundle) r1);
        }
    ...
    private void checkAvailable(String str, int i) {
        ...
        if (bundle != null && bundle.containsKey(str)) {
            if (isClosed()) {
                obj = "buffer has been closed";
            } else if (i < 0 || i >= this.dataCount) {
                StringBuilder sb = new StringBuilder();
                sb.append("row is out of index:");
                sb.append(i);
                obj = sb.toString();
            } else {
                obj = "";
            ...
            sb2.append("cannot find column: ");
            sb2.append(str);
            obj = sb2.toString();
        }
        Preconditions.checkArgument(obj.isEmpty(), obj);
    }
    ...
    private static CursorWindow[] getCursorWindows(HMSCursorWrapper hMSCursorWrapper) {
        ...
        try {
            ...
            try {
                StringBuilder sb = new StringBuilder();
                sb.append("fail to getCursorWindows: ");
    ...
    */
    private static java.util.ArrayList<android.database.CursorWindow> iterCursorWindow(com.huawei.hms.common.data.DataHolder.Builder r10, int r11, java.util.List r12) {
        ...
        L18:
            if (r4 >= r11) goto Lae
            boolean r5 = r1.allocRow()     // Catch: java.lang.RuntimeException -> L98
            java.lang.String r6 = "DataHolder"
            if (r5 != 0) goto L46
            java.lang.String r1 = "Failed to allocate a row"
            com.huawei.hms.support.log.HMSLog.d(r6, r1)     // Catch: java.lang.RuntimeException -> L98
            android.database.CursorWindow r1 = new android.database.CursorWindow     // Catch: java.lang.RuntimeException -> L98
            r1.<init>(r2)     // Catch: java.lang.RuntimeException -> L98
            r1.setStartPosition(r4)     // Catch: java.lang.RuntimeException -> L98
            java.lang.String[] r5 = com.huawei.hms.common.data.DataHolder.Builder.access$200(r10)     // Catch: java.lang.RuntimeException -> L98
            int r5 = r5.length     // Catch: java.lang.RuntimeException -> L98
            r1.setNumColumns(r5)     // Catch: java.lang.RuntimeException -> L98
            boolean r5 = r1.allocRow()     // Catch: java.lang.RuntimeException -> L98
            if (r5 != 0) goto L43
            java.lang.String r10 = "Failed to retry to allocate a row"
            com.huawei.hms.support.log.HMSLog.e(r6, r10)     // Catch: java.lang.RuntimeException -> L98
            return r0
        L43:
            r0.add(r1)     // Catch: java.lang.RuntimeException -> L98
        L46:
            java.lang.Object r5 = r12.get(r4)     // Catch: java.lang.RuntimeException -> L98
            java.util.HashMap r5 = (java.util.HashMap) r5     // Catch: java.lang.RuntimeException -> L98
            r7 = 1
            r8 = 0
        L4e:
            java.lang.String[] r9 = com.huawei.hms.common.data.DataHolder.Builder.access$200(r10)     // Catch: java.lang.RuntimeException -> L98
            int r9 = r9.length     // Catch: java.lang.RuntimeException -> L98
            if (r8 >= r9) goto L68
            java.lang.String[] r7 = com.huawei.hms.common.data.DataHolder.Builder.access$200(r10)     // Catch: java.lang.RuntimeException -> L98
            r7 = r7[r8]     // Catch: java.lang.RuntimeException -> L98
            java.lang.Object r7 = r5.get(r7)     // Catch: java.lang.RuntimeException -> L98
            boolean r7 = putValue(r1, r7, r4, r8)     // Catch: java.lang.RuntimeException -> L98
            if (r7 == 0) goto L68
            int r8 = r8 + 1
            goto L4e
        L68:
            if (r7 != 0) goto L95
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch: java.lang.RuntimeException -> L98
            r11.<init>()     // Catch: java.lang.RuntimeException -> L98
            java.lang.String r12 = "fail to put data for row "
            r11.append(r12)     // Catch: java.lang.RuntimeException -> L98
            r11.append(r4)     // Catch: java.lang.RuntimeException -> L98
            java.lang.String r11 = r11.toString()     // Catch: java.lang.RuntimeException -> L98
            com.huawei.hms.support.log.HMSLog.d(r6, r11)     // Catch: java.lang.RuntimeException -> L98
            r1.freeLastRow()     // Catch: java.lang.RuntimeException -> L98
            android.database.CursorWindow r11 = new android.database.CursorWindow     // Catch: java.lang.RuntimeException -> L98
            r11.<init>(r2)     // Catch: java.lang.RuntimeException -> L98
            r11.setStartPosition(r4)     // Catch: java.lang.RuntimeException -> L98
            java.lang.String[] r10 = com.huawei.hms.common.data.DataHolder.Builder.access$200(r10)     // Catch: java.lang.RuntimeException -> L98
            int r10 = r10.length     // Catch: java.lang.RuntimeException -> L98
            r11.setNumColumns(r10)     // Catch: java.lang.RuntimeException -> L98
            r0.add(r11)     // Catch: java.lang.RuntimeException -> L98
            goto Lae
        L95:
            int r4 = r4 + 1
            goto L18
    ...
    private static boolean putValue(CursorWindow cursorWindow, Object obj, int i, int i2) throws IllegalArgumentException {
        ...
        if (obj instanceof Boolean) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("unsupported type for column: ");
            sb.append(obj);
    ...
    public final int getWindowIndex(int i) {
        int[] iArr;
        int i2 = 0;
        boolean z = i >= 0 || i < this.dataCount;
        StringBuilder sb = new StringBuilder();
        sb.append("rowIndex is out of index:");
        sb.append(i);
