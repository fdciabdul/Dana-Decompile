...
public class s0 {
    public static String KClassImpl$Data$declaredNonStaticMembers$2(String str, String str2, String str3, String str4) {
        if (!TextUtils.isEmpty(str2)) {
            return KClassImpl$Data$declaredNonStaticMembers$2(str, str2, str3) ? str2 : str4;
        }
        StringBuilder sb = new StringBuilder();
        sb.append("checkStrParameter() Parameter verification failure! Parameter:");
        sb.append(str);
    ...
    public static boolean KClassImpl$Data$declaredNonStaticMembers$2(String str) {
        return !KClassImpl$Data$declaredNonStaticMembers$2("eventId", str, 256);
    }

    public static boolean KClassImpl$Data$declaredNonStaticMembers$2(String str, String str2, int i) {
        StringBuilder sb;
        String str3;
        if (TextUtils.isEmpty(str2)) {
    ...
    private static boolean KClassImpl$Data$declaredNonStaticMembers$2(String str, String str2, String str3) {
        StringBuilder sb;
        String str4;
        if (TextUtils.isEmpty(str2)) {
            sb = new StringBuilder();
    ...
    public static boolean MyBillsEntityDataFactory(Map<String, String> map) {
        ...
        if (map == null || map.size() == 0) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("checkMap Map data is too big! size: ");
            sb.append(map.size());
            sb.append(" length: ");
