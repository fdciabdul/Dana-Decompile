...
public class JsonUtil {
    ...
    public static Object getInfoFromJsonobject(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("getInfoFromJsonobject:parser json error :");
                sb.append(str2);
                HMSLog.e(TAG, sb.toString());
            }
        }
    ...
    private static Object getObjectValue(String str, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(InvoiceConstant.HEADER) && jSONObject.getJSONObject(InvoiceConstant.HEADER).has(str)) {
            return jSONObject.getJSONObject(InvoiceConstant.HEADER).get(str);
        }
    ...
    public static IMessageEntity jsonToEntity(String str, IMessageEntity iMessageEntity) {
        try {
            ...
            StringBuilder sb2 = new StringBuilder();
            sb2.append("catch JSONException when parse jsonString");
    ...
    private static void writeList(String str, List<?> list, JSONObject jSONObject) throws JSONException, IllegalAccessException {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            sb.append(LIST_ITEM_VALUE);
            sb.append(i);
            disposeType(sb.toString(), list.get(i), jSONObject2);
