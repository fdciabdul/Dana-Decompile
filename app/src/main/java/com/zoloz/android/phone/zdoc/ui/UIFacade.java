...
public class UIFacade {
    ...
    public static int getLayoutId(Context context, int i, String str, int i2) {
        ...
        sb.append("layout_manual_");
        sb.append(i);
        int compIdentifier = getCompIdentifier(context, sb.toString(), BoxData.ATTR_LAYOUT);
        if (compIdentifier == 0) {
    ...
    public static int readSpecialUiType(Context context, String str) {
        ...
        if (specialUiTypeInfo != null) {
            return getCompIdentifier(context, specialUiTypeInfo.getLayout(), BoxData.ATTR_LAYOUT);
        }
        return 0;
    }
    ...
    public static String getControllMessage(Context context, int i, String str, int i2) {
        String str2 = (i == 0 || i != 1) ? "zdoc_capture_" : "zdoc_confirm_";
        StringBuilder sb = new StringBuilder();
        sb.append(str2);
        sb.append(str);
        sb.append("_");
