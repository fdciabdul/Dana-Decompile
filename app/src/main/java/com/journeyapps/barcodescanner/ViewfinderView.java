...
public class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.laserVisibility) {
            ...
            canvas.drawRect(rect.left + 2, (float) (((rect.height() / 2) + rect.top) - 1), (float) (rect.right - 1), r0 + 2, this.paint);
        }
        float width2 = getWidth() / size.MyBillsEntityDataFactory;
        float height2 = getHeight() / size.KClassImpl$Data$declaredNonStaticMembers$2;
