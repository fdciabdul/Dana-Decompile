...
final class DocumentFileUtils$decompressZip$8 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Ref.LongRef $$bytesDecompressed;
    final /* synthetic */ ZipDecompressionCallback<DocumentFile> $$callback;
    final /* synthetic */ Ref.IntRef $$fileDecompressedCount;
    final /* synthetic */ Ref.IntRef $$writeSpeed;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DocumentFileUtils$decompressZip$8(Ref.LongRef longRef, Ref.IntRef intRef, Ref.IntRef intRef2, ZipDecompressionCallback<DocumentFile> zipDecompressionCallback) {
        super(0);
    ...
    public final void invoke2() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.$$callback.KClassImpl$Data$declaredNonStaticMembers$2, Dispatchers.getMain(), null, new DocumentFileUtils$decompressZip$8$invoke$$inlined$postToUi$1(null, this.$$callback, report), 2, null);
