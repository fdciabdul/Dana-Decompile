    ...
    public final void invoke(boolean z) {
        if (z) {
            ...
            if (j > 0) {
                ...
                objectRef.element = CoroutineExtKt.getAuthRequestContext(j, new Function0<Unit>() { // from class: com.anggrayudi.storage.file.DocumentFileUtils$copyFolderTo$startTimer$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                    ...
                    public final void invoke2() {
                        FolderCallback.Report report = new FolderCallback.Report((((float) Ref.LongRef.this.element) * 100.0f) / ((float) longRef2.element), Ref.LongRef.this.element, intRef.element, intRef2.element);
                        BuildersKt__Builders_commonKt.launch$default(folderCallback.PlaceComponentResult, Dispatchers.getMain(), null, new DocumentFileUtils$copyFolderTo$startTimer$1$1$invoke$$inlined$postToUi$1(null, folderCallback, report), 2, null);
                        intRef.element = 0;
                    }
                });
            }
