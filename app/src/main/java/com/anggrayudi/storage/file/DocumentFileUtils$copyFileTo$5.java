...
final class DocumentFileUtils$copyFileTo$5 extends Lambda implements Function2<InputStream, OutputStream, Unit> {
    ...
    DocumentFileUtils$copyFileTo$5(DocumentFile documentFile, DocumentFile documentFile2, boolean z, long j, FileCallback fileCallback) {
        super(2);
    ...
    public final void invoke2(InputStream inputStream, OutputStream outputStream) {
        ...
        DocumentFileUtils.PlaceComponentResult(this.$$this_copyFileTo, inputStream, outputStream, this.$$targetFile, this.$$watchProgress, this.$$reportInterval, false, this.$$callback);
    }
}
