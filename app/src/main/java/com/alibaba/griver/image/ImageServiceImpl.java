...
public class ImageServiceImpl implements GriverImageService {
    @Override // com.alibaba.griver.image.GriverImageService
    ...
    public void optimizeView(AbsListView absListView, boolean z, boolean z2, AbsListView.OnScrollListener onScrollListener) {
        ...
        try {
            ...
            sb.append("optimizeView listview setOnScrollListener exp: ");
    ...
    public void loadImage(final APImageLoadRequest aPImageLoadRequest, String str) {
        ...
        griverImageLoadRequest.callback = new GriverImageLoadCallback() { // from class: com.alibaba.griver.image.ImageServiceImpl.1
            @Override // com.alibaba.griver.image.framework.api.GriverImageLoadCallback
            ...
            public void onError() {
                if (aPImageLoadRequest.callback != null) {
                    ...
                    aPImageDownloadRsp.setRetmsg(aPImageRetMsg);
                    aPImageLoadRequest.callback.onError(aPImageDownloadRsp, null);
                }
            }
        };
    ...
    public void loadOriginalImage(String str, ImageView imageView, Drawable drawable, final APImageDownLoadCallback aPImageDownLoadCallback, String str2) {
        ...
        griverImageLoadRequest.tag = GriverImageService.IMAGE_TAG;
        griverImageLoadRequest.callback = new GriverImageLoadCallback() { // from class: com.alibaba.griver.image.ImageServiceImpl.2
            @Override // com.alibaba.griver.image.framework.api.GriverImageLoadCallback
            public void onSuccess() {
    ...
    @Override // com.alibaba.griver.image.GriverImageService
    public APEncodeResult compress(File file, APEncodeOptions aPEncodeOptions) throws Exception {
