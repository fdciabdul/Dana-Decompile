...
public class Timer {
    ...
    private final TimeoutListener f6346a;
    ...
    public void postTimeout(long j) {
        ...
        synchronized (this) {
            ...
            if (timeoutRunnable == null) {
                ...
                currentTimeMillis = this.c.f6348a;
    ...
    class TimeoutRunnable implements Runnable {
        ...
        public void run() {
            long currentTimeMillis = System.currentTimeMillis() - this.f6348a;
            ...
            if (Timer.this.f6346a != null) {
                Timer.this.f6346a.onTimeout(currentTimeMillis);
            }
            Timer.this.c = null;
        }
    }
    ...
    static class HandlerExecutor implements TimerExecutor {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Handler f6347a = new Handler(Looper.getMainLooper());
        ...
        public void removeCallbacks(Runnable runnable) {
            this.f6347a.removeCallbacks(runnable);
        }
    }
}
