...
public class ErrorConstants {
    ...
    public static final String[] ERROR_BLUETOOTH_UNAVAILABLE = {"10001", "Bluetooth unavailable"};
    public static final String[] ERROR_DEVICE_NOT_FOUND = {"10002", "Device not found"};
    public static final String[] ERROR_CONNECT_FAIL = {"10003", "Connect fail"};
    public static final String[] ERROR_SERVICE_NOT_FOUND = {"10004", "Service not found"};
    ...
    public static final String ERROR_CODE_NO_PERMISSON = "11003";
    public static final String ERROR_CODE_NO_PERMISSON_MESSAGE = "Permissions is not granted";
    public static final String[] ERROR_BEACON_LOCATION_FORBIDDEN = {ERROR_CODE_NO_PERMISSON, ERROR_CODE_NO_PERMISSON_MESSAGE};
