...
public class StartRMData implements Serializable, Parcelable {
    ...
    public static final Parcelable.Creator<StartRMData> CREATOR = new Parcelable.Creator<StartRMData>() { // from class: com.alibaba.griver.bluetooth.altbeacon.beacon.service.StartRMData.1
