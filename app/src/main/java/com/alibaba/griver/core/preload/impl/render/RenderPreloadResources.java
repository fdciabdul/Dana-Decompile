...
public class RenderPreloadResources {
    ...
    private String a(App app) {
        ...
        try {
            ...
            sb2.append(vhost);
            sb2.append("/index.js");
            String str = new String(((ResourceLoadPoint) ExtensionPoint.as(ResourceLoadPoint.class).node(app).create()).load(uri.originUrl(sb2.toString()).build()).getBytes(), HereOauthManager.ENC);
            ...
            RVLogger.w("RenderPreloadResources", "prerenderng loadIndexJs failed", e);
            return null;
        }
    }
