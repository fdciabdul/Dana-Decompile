...
public final class HashingSink extends ForwardingSink {
    ...
    public static HashingSink md5(Sink sink) {
        return new HashingSink(sink, MD5Util.ALGORIGTHM_MD5);
    }
    ...
    public static HashingSink hmacSha256(Sink sink, ByteString byteString) {
        return new HashingSink(sink, byteString, HereOauthManager.HASHING_ALGORITHM);
    }
    ...
    @Override // com.alibaba.griver.lottie.okio.ForwardingSink, com.alibaba.griver.lottie.okio.Sink
