...
public class AsyncTimeout extends Timeout {
    ...
    public final Sink sink(final Sink sink) {
        return new Sink() { // from class: com.alibaba.griver.lottie.okio.AsyncTimeout.1
    ...
    public final Source source(final Source source) {
        return new Source() { // from class: com.alibaba.griver.lottie.okio.AsyncTimeout.2
        ...
        */
        public final void run() {
            /*
                r3 = this;
            L0:
                java.lang.Class<com.alibaba.griver.lottie.okio.AsyncTimeout> r0 = com.alibaba.griver.lottie.okio.AsyncTimeout.class
                monitor-enter(r0)     // Catch: java.lang.InterruptedException -> L0
                com.alibaba.griver.lottie.okio.AsyncTimeout r1 = com.alibaba.griver.lottie.okio.AsyncTimeout.awaitTimeout()     // Catch: java.lang.Throwable -> L19
                if (r1 != 0) goto Lb
                monitor-exit(r0)
                goto L0
            Lb:
                com.alibaba.griver.lottie.okio.AsyncTimeout r2 = com.alibaba.griver.lottie.okio.AsyncTimeout.head     // Catch: java.lang.Throwable -> L19
                if (r1 != r2) goto L14
                r1 = 0
                com.alibaba.griver.lottie.okio.AsyncTimeout.head = r1     // Catch: java.lang.Throwable -> L19
                monitor-exit(r0)
                return
            L14:
                monitor-exit(r0)
            ...
            L1d:
                goto L1c
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.griver.lottie.okio.AsyncTimeout.Watchdog.run():void");
        }
    }
