...
public final class HashingSource extends ForwardingSource {
    ...
    public static HashingSource md5(Source source) {
        return new HashingSource(source, MD5Util.ALGORIGTHM_MD5);
    }
    ...
    public static HashingSource hmacSha256(Source source, ByteString byteString) {
        return new HashingSource(source, byteString, HereOauthManager.HASHING_ALGORITHM);
    }
    ...
    @Override // com.alibaba.griver.lottie.okio.ForwardingSource, com.alibaba.griver.lottie.okio.Source
