...
public class LottieValueAnimator extends BaseLottieAnimator implements Choreographer.FrameCallback {
    ...
    @Override // com.alibaba.griver.lottie.utils.BaseLottieAnimator, android.animation.ValueAnimator
    public Object getAnimatedValue() {
        float animatedValueAbsolute = getAnimatedValueAbsolute();
        if (this.needLog) {
            StringBuilder sb = new StringBuilder();
            sb.append("getAnimatedValue(),animatedValueAbsolute=");
            sb.append(animatedValueAbsolute);
            GriverLogger.d("LottieValueAnimator", sb.toString());
        }
        this.needLog = false;
        return Float.valueOf(animatedValueAbsolute);
    }

    @Override // com.alibaba.griver.lottie.utils.BaseLottieAnimator
