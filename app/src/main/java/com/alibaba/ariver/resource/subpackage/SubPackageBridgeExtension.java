...
public class SubPackageBridgeExtension implements BridgeExtension {
    ...
    private Set<String> f6246a = new HashSet();
            ...
            if (subPackage == null) {
                ...
                for (int i = 0; i < jSONArray.size(); i++) {
                    ...
                    if (!TextUtils.isEmpty(string)) {
                        ...
                        if (!this.f6246a.contains(string)) {
            ...
            if (list != null) {
                if (!list.isEmpty()) {
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        sb2.append(string);
                        RVLogger.d("AriverRes:SubPackageBridgeExtension", sb2.toString());
                        ISubPackageDownloader.Callback callback = new ISubPackageDownloader.Callback() { // from class: com.alibaba.ariver.resource.subpackage.SubPackageBridgeExtension.2
                            ...
                            public void onSuccess(String str2) {
                                ...
                                try {
                                    ...
                                    SubPackageBridgeExtension.this.f6246a.add(str);
                                    ...
                                    StringBuilder sb3 = new StringBuilder();
                                    sb3.append(LangResourceUtil.getString(R.string.ariver_resource_parse_error));
                                    sb3.append(str);
                            ...
                            public void onFail(String str2) {
                                BridgeCallback bridgeCallback2;
                                StringBuilder sb3 = new StringBuilder();
                                sb3.append(LangResourceUtil.getString(R.string.ariver_resource_download_error));
                                sb3.append(str);
    ...
    public class ResultDispatchFuture implements Future<BridgeResponse> {
        ...
        private ResultDispatchFuture() {
            this.f6247a = new CountDownLatch(1);
            this.b = null;
        }
        ...
        public BridgeResponse get() throws InterruptedException, ExecutionException {
            ...
            this.f6247a.await(30L, TimeUnit.SECONDS);
            StringBuilder sb = new StringBuilder();
