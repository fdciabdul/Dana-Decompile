...
public class RVEvents {
    ...
    public static final String EMBED_WEBVIEW_LOAD_ERROR_EVENT = "onError";
    public static final String EMBED_WEBVIEW_LOAD_FINISH_EVENT = "onLoad";
    public static final String FIRE_PULL_TO_REFRESH = "firePullToRefresh";
    public static final String MESSAGE = "message";
    public static final String NBCOMPONENT_CAMERA_ERROR = "nbcomponent.camera.error";
    ...
    public static final String SELECTED_TAB_CLICK = "selectedTabItemTap";
