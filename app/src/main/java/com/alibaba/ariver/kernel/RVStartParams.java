...
public class RVStartParams {
    ...
    public static final String KEY_CLOSE_ACTIVITY_WITH_CUSTOM_ANIMATION = "closeActivityWithCustomAnimation";
    ...
    public static final String KEY_ENABLE_HTML_SNAPSHOT = "enableSnapshot";
    ...
    public static final String KEY_FROM_EMBED_H5 = "fromEmbedH5";
