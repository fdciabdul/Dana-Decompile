...
public class RVAppRecord {
    ...
    RVAppRecord(String str, long j, Bundle bundle, Bundle bundle2) {
    ...
    public static RVAppRecord generate(String str, Bundle bundle, Bundle bundle2) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("AppRecord{mStartToken=");
