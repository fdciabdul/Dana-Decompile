...
public class R2 {
    ...
    public static class string {
        public static String title_back() {
            ...
            return viewLoadService == null ? "" : viewLoadService.getString("title_back", R.string.title_back);
        }

        public static String btn_exit() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Close" : viewLoadService.getString("btn_exit", R.string.btn_exit);
        }

        public static String btn_retry() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Retry" : viewLoadService.getString("btn_retry", R.string.btn_retry);
        }

        public static String alert_timeout_error_title() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Hey there, good lookin\\'!" : viewLoadService.getString("alert_timeout_error_title", R.string.alert_timeout_error_title);
        }

        public static String system_error_title() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Yikes, something\\'s wrong!" : viewLoadService.getString("system_error_title", R.string.system_error_title);
        }

        public static String system_error_msg() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Hang on, we are working on this. Please try again later!" : viewLoadService.getString("system_error_msg", R.string.system_error_msg);
        }

        public static String system_error_got_it() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "OK" : viewLoadService.getString("system_error_got_it", R.string.system_error_got_it);
        }

        public static String network_error_title() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Connection Lost" : viewLoadService.getString("network_error_title", R.string.network_error_title);
        }

        public static String network_error_msg() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Whoopsies, please check your Internet connection and try again." : viewLoadService.getString("network_error_msg", R.string.network_error_msg);
        }

        public static String network_error_retry() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Retry" : viewLoadService.getString("network_error_retry", R.string.network_error_retry);
        }

        public static String network_error_exit() {
            ViewLoadService viewLoadService = R2.getViewLoadService();
            return viewLoadService == null ? "Close" : viewLoadService.getString("network_error_exit", R.string.network_error_exit);
        }
    }
