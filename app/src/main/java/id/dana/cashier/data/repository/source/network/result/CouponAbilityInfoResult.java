...
public final /* data */ class CouponAbilityInfoResult {
    ...
    public final CouponAbilityInfoResult copy(Boolean canFundbackBack, Boolean canLuckMoneyPayment, Boolean canPartUse, Boolean canRefundBack, Boolean canRegularPayment, Boolean canSuperpose, Boolean canTransfer, Boolean canWithDraw) {
        return new CouponAbilityInfoResult(canFundbackBack, canLuckMoneyPayment, canPartUse, canRefundBack, canRegularPayment, canSuperpose, canTransfer, canWithDraw);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other instanceof CouponAbilityInfoResult) {
            CouponAbilityInfoResult couponAbilityInfoResult = (CouponAbilityInfoResult) other;
            return Intrinsics.areEqual(this.canFundbackBack, couponAbilityInfoResult.canFundbackBack) && Intrinsics.areEqual(this.canLuckMoneyPayment, couponAbilityInfoResult.canLuckMoneyPayment) && Intrinsics.areEqual(this.canPartUse, couponAbilityInfoResult.canPartUse) && Intrinsics.areEqual(this.canRefundBack, couponAbilityInfoResult.canRefundBack) && Intrinsics.areEqual(this.canRegularPayment, couponAbilityInfoResult.canRegularPayment) && Intrinsics.areEqual(this.canSuperpose, couponAbilityInfoResult.canSuperpose) && Intrinsics.areEqual(this.canTransfer, couponAbilityInfoResult.canTransfer) && Intrinsics.areEqual(this.canWithDraw, couponAbilityInfoResult.canWithDraw);
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        sb.append("CouponAbilityInfoResult(canFundbackBack=");
    ...
    public CouponAbilityInfoResult(Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, Boolean bool6, Boolean bool7, Boolean bool8) {
