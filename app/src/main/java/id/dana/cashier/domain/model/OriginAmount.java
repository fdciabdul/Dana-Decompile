...
public final class OriginAmount {
    ...
    public OriginAmount(Double d, Long l, Long l2, String str, String str2, String str3) {
        this.amount = d;
        this.cent = l;
        this.centFactor = l2;
        this.currency = str;
