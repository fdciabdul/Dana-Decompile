...
public class InboxNotificationDirector extends NotificationDirector {
    public InboxNotificationDirector(Context context, NotificationData notificationData) {
    ...
    public final void MyBillsEntityDataFactory() {
        ...
        sb.append(String.format(DanaUrl.CDP_DETAIL, this.PlaceComponentResult.DatabaseTableConfigUtil));
