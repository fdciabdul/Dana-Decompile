...
public final class LocalGlobalSendEntityData implements GlobalSendEntityData {
    ...
    public final Flow<SenderDetail> getAuthRequestContext() {
        return FlowKt.flow(new LocalGlobalSendEntityData$getSenderDetail$1(this, null));
    }

    @Override // id.dana.sendmoney.data.repository.globalsend.source.GlobalSendEntityData
    public final Flow<Unit> getAuthRequestContext(SenderDetail p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        return FlowKt.flow(new LocalGlobalSendEntityData$saveSenderDetail$1(this, p0, null));
    }

    @Override // id.dana.sendmoney.data.repository.globalsend.source.GlobalSendEntityData
    public final Flow<Unit> KClassImpl$Data$declaredNonStaticMembers$2(String p0) {
        Intrinsics.checkNotNullParameter(p0, "");
        return FlowKt.flow(new LocalGlobalSendEntityData$saveSortBeneficiaryList$1(this, p0, null));
    }

    @Override // id.dana.sendmoney.data.repository.globalsend.source.GlobalSendEntityData
    public final Flow<String> PlaceComponentResult() {
        return FlowKt.flow(new LocalGlobalSendEntityData$getSortBeneficiaryList$1(this, null));
    }
