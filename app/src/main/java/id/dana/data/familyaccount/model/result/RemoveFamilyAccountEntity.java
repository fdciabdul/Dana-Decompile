...
public final /* data */ class RemoveFamilyAccountEntity extends BaseRpcResult {
    ...
    public static /* synthetic */ RemoveFamilyAccountEntity copy$default(RemoveFamilyAccountEntity removeFamilyAccountEntity, List list, String str, SecurityContextResult securityContextResult, int i, Object obj) {
        if ((i & 1) != 0) {
            list = removeFamilyAccountEntity.verificationMethodInfoList;
        }
        if ((i & 2) != 0) {
            str = removeFamilyAccountEntity.securityId;
        }
        if ((i & 4) != 0) {
            securityContextResult = removeFamilyAccountEntity.securityContext;
        }
        return removeFamilyAccountEntity.copy(list, str, securityContextResult);
    }
    ...
    public final RemoveFamilyAccountEntity copy(List<VerificationMethodInfoEntity> verificationMethodInfoList, String securityId, SecurityContextResult securityContext) {
        return new RemoveFamilyAccountEntity(verificationMethodInfoList, securityId, securityContext);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other instanceof RemoveFamilyAccountEntity) {
            RemoveFamilyAccountEntity removeFamilyAccountEntity = (RemoveFamilyAccountEntity) other;
            return Intrinsics.areEqual(this.verificationMethodInfoList, removeFamilyAccountEntity.verificationMethodInfoList) && Intrinsics.areEqual(this.securityId, removeFamilyAccountEntity.securityId) && Intrinsics.areEqual(this.securityContext, removeFamilyAccountEntity.securityContext);
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        sb.append("RemoveFamilyAccountEntity(verificationMethodInfoList=");
    ...
    public RemoveFamilyAccountEntity(List<VerificationMethodInfoEntity> list, String str, SecurityContextResult securityContextResult) {
