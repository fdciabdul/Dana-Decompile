...
public final class BaseTrafficType$getTreatmentWithConfigSdkReady$1<T> implements ObservableOnSubscribe {
    final /* synthetic */ String $MyBillsEntityDataFactory;
    final /* synthetic */ boolean $PlaceComponentResult;
    final /* synthetic */ T $getAuthRequestContext;
    ...
    public final void subscribe(final ObservableEmitter<T> observableEmitter) {
        ...
        this.KClassImpl$Data$declaredNonStaticMembers$2.KClassImpl$Data$declaredNonStaticMembers$2(this.$MyBillsEntityDataFactory);
        ...
        MyBillsEntityDataFactory.KClassImpl$Data$declaredNonStaticMembers$2(str, BuiltInFictitiousFunctionClassFactory, Object.class, t, new ToggleCallback<T>() { // from class: id.dana.data.toggle.traffictype.BaseTrafficType$getTreatmentWithConfigSdkReady$1.1
