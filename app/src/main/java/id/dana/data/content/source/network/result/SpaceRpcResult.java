package id.dana.data.content.source.network.result;
...
public class SpaceRpcResult extends BaseRpcResult {
    private String allowedContent;
    private List<CdpContentEntity> cdpContents;
    ...
    public List<CdpContentEntity> getCdpContents() {
        return this.cdpContents;
    }

    public void setCdpContents(List<CdpContentEntity> list) {
