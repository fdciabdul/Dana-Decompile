...
@DebugMetadata(c = "id.dana.mybills.domain.interactor.ValidateFormUseCase$buildUseCase$1", f = "ValidateFormUseCase.kt", i = {}, l = {35, 37}, m = "invokeSuspend", n = {}, s = {})
...
final class ValidateFormUseCase$buildUseCase$1 extends SuspendLambda implements Function2<FlowCollector<? super Map<String, ? extends String>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Map<String, String> fields = this.$param.MyBillsEntityDataFactory.getFields();
            ValidateFormUseCase.Params params = this.$param;
            for (Map.Entry<String, String> entry : fields.entrySet()) {
                String key = entry.getKey();
                String value = entry.getValue();
                List<Function1<String, Boolean>> list = params.MyBillsEntityDataFactory.getRules().get(key);
                if (list != null) {
