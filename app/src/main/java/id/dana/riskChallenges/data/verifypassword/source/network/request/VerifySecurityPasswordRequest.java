...
public final /* data */ class VerifySecurityPasswordRequest extends BaseRpcRequest {
    ...
    public VerifySecurityPasswordRequest() {
    ...
    public final VerifySecurityPasswordRequest copy(@JSONField(name = "token") String token, @JSONField(name = "securityId") String securityId, @JSONField(name = "verificationMethod") String verificationMethod, @JSONField(name = "validateData") String validateData, @JSONField(name = "sendStrategy") String sendStrategy, @JSONField(name = "sendOtpStrategy") String sendOtpStrategy, @JSONField(name = "userIdType") String userIdType, @JSONField(name = "correlationId") String correlationId, @JSONField(name = "phoneNumber") String phoneNumber) {
        ...
        return new VerifySecurityPasswordRequest(token, securityId, verificationMethod, validateData, sendStrategy, sendOtpStrategy, userIdType, correlationId, phoneNumber);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other instanceof VerifySecurityPasswordRequest) {
            VerifySecurityPasswordRequest verifySecurityPasswordRequest = (VerifySecurityPasswordRequest) other;
            return Intrinsics.areEqual(this.token, verifySecurityPasswordRequest.token) && Intrinsics.areEqual(this.securityId, verifySecurityPasswordRequest.securityId) && Intrinsics.areEqual(this.verificationMethod, verifySecurityPasswordRequest.verificationMethod) && Intrinsics.areEqual(this.validateData, verifySecurityPasswordRequest.validateData) && Intrinsics.areEqual(this.sendStrategy, verifySecurityPasswordRequest.sendStrategy) && Intrinsics.areEqual(this.sendOtpStrategy, verifySecurityPasswordRequest.sendOtpStrategy) && Intrinsics.areEqual(this.userIdType, verifySecurityPasswordRequest.userIdType) && Intrinsics.areEqual(this.correlationId, verifySecurityPasswordRequest.correlationId) && Intrinsics.areEqual(this.phoneNumber, verifySecurityPasswordRequest.phoneNumber);
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        sb.append("VerifySecurityPasswordRequest(token=");
    ...
    public /* synthetic */ VerifySecurityPasswordRequest(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public VerifySecurityPasswordRequest(@JSONField(name = "token") String str, @JSONField(name = "securityId") String str2, @JSONField(name = "verificationMethod") String str3, @JSONField(name = "validateData") String str4, @JSONField(name = "sendStrategy") String str5, @JSONField(name = "sendOtpStrategy") String str6, @JSONField(name = "userIdType") String str7, @JSONField(name = "correlationId") String str8, @JSONField(name = "phoneNumber") String str9) {
        Intrinsics.checkNotNullParameter(str, "");
