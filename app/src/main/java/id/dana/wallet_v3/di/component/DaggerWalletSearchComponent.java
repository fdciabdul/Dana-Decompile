...
public final class DaggerWalletSearchComponent {
    ...
    public static final class Builder {
        ...
        public final Builder walletSearchModule(WalletSearchModule walletSearchModule) {
            this.walletSearchModule = (WalletSearchModule) Preconditions.getAuthRequestContext(walletSearchModule);
            return this;
        }
        ...
        public final WalletSearchComponent build() {
            Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.walletSearchModule, WalletSearchModule.class);
            ...
            return new WalletSearchComponentImpl(this.walletSearchModule, this.servicesModule, this.getBalanceModule, this.deepLinkModule, this.scanQrModule, this.restoreUrlModule, this.featureModule, this.oauthModule, this.loyaltyWalletDetailModule, this.applicationComponent);
        }
    }
    ...
    public static final class WalletSearchComponentImpl implements WalletSearchComponent {
        ...
        private WalletSearchComponentImpl(WalletSearchModule walletSearchModule, ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, LoyaltyWalletDetailModule loyaltyWalletDetailModule, ApplicationComponent applicationComponent) {
            ...
            initialize(walletSearchModule, servicesModule, getBalanceModule, deepLinkModule, scanQrModule, restoreUrlModule, featureModule, oauthModule, loyaltyWalletDetailModule, applicationComponent);
            initialize2(walletSearchModule, servicesModule, getBalanceModule, deepLinkModule, scanQrModule, restoreUrlModule, featureModule, oauthModule, loyaltyWalletDetailModule, applicationComponent);
        }
        ...
        private void initialize2(WalletSearchModule walletSearchModule, ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, LoyaltyWalletDetailModule loyaltyWalletDetailModule, ApplicationComponent applicationComponent) {
            ...
            this.provideViewProvider4 = authRequestContext2;
            ...
            Provider<FeaturePresenter> authRequestContext3 = DoubleCheck.getAuthRequestContext(FeaturePresenter_Factory.PlaceComponentResult(this.provideViewProvider4, this.featureServicesHandlerProvider, this.checkDeepLinkActionVisibilityProvider, this.checkWhitelistedValidDomainProvider, this.getNearbyConfigProvider, this.getFeedConfigProvider, this.getPromoCenterVersionProvider, this.getUpdateAvailabilityProvider, this.checkMyBillsVersionConfigProvider, this.providePushVerifyTrackerProvider, create));
            this.featurePresenterProvider = authRequestContext3;
            this.providePresenterProvider3 = DoubleCheck.getAuthRequestContext(FeatureModule_ProvidePresenterFactory.getAuthRequestContext(featureModule, authRequestContext3));
            ...
            this.provideViewProvider5 = DoubleCheck.getAuthRequestContext(OauthModule_ProvideViewFactory.getAuthRequestContext(oauthModule, authRequestContext4));
            ...
            Provider<DeepLinkView> authRequestContext5 = DoubleCheck.getAuthRequestContext(DeepLinkView_Factory.getAuthRequestContext(this.providePresenterProvider, this.providePresenterProvider2, this.providePresenterProvider3, this.providePresenterProvider4, this.servicesPresenterProvider, applicationProvider, this.getUserLoanInfoProvider));
            this.deepLinkViewProvider = authRequestContext5;
            this.provideViewProvider6 = DoubleCheck.getAuthRequestContext(DeepLinkModule_ProvideViewFactory.PlaceComponentResult(deepLinkModule, authRequestContext5));
            ...
            Provider<ReadLinkPropertiesPresenter> authRequestContext6 = DoubleCheck.getAuthRequestContext(ReadLinkPropertiesPresenter_Factory.getAuthRequestContext(this.provideViewProvider6, this.readDeepLinkPropertiesProvider, this.deepLinkPayloadModelMapperProvider, create2, this.mixpanelDeeplinkTrackerProvider));
            ...
            Provider<LoyaltyWalletContract.View> authRequestContext7 = DoubleCheck.getAuthRequestContext(LoyaltyWalletDetailModule_ProvideViewFactory.create(loyaltyWalletDetailModule));
            this.provideViewProvider7 = authRequestContext7;
            LoyaltyWalletPresenter_Factory create3 = LoyaltyWalletPresenter_Factory.create(this.getKycLevelProvider, this.getLoyaltyTokenProvider, this.getUserPocketWalletAssetProvider, authRequestContext7);
            this.loyaltyWalletPresenterProvider = create3;
            this.providePresenterProvider5 = DoubleCheck.getAuthRequestContext(LoyaltyWalletDetailModule_ProvidePresenterFactory.create(loyaltyWalletDetailModule, create3));
            this.provideViewProvider8 = DoubleCheck.getAuthRequestContext(GetBalanceModule_ProvideViewFactory.MyBillsEntityDataFactory(getBalanceModule));
            ...
            Provider<GetBalancePresenter> authRequestContext8 = DoubleCheck.getAuthRequestContext(GetBalancePresenter_Factory.KClassImpl$Data$declaredNonStaticMembers$2(this.provideViewProvider8, this.getBalanceProvider, this.getSingleBalanceProvider, CurrencyAmountModelMapper_Factory.MyBillsEntityDataFactory(), this.getBalanceVisibilityProvider, this.setBalanceVisibilityProvider, this.getAllBalanceVisibilityProvider, this.getDanaHomeBalanceConfigProvider, this.getUserInvestmentSummaryProvider));
            this.getBalancePresenterProvider = authRequestContext8;
            this.providePresenterProvider6 = DoubleCheck.getAuthRequestContext(GetBalanceModule_ProvidePresenterFactory.getAuthRequestContext(getBalanceModule, authRequestContext8));
        ...
        private WalletSearchFragment injectWalletSearchFragment(WalletSearchFragment walletSearchFragment) {
            ...
            WalletSearchFragment_MembersInjector.injectDynamicUrlWrapper(walletSearchFragment, (DynamicUrlWrapper) Preconditions.PlaceComponentResult(this.applicationComponent.PrepareContext()));
            WalletSearchFragment_MembersInjector.injectDeviceInformationProvider(walletSearchFragment, (DeviceInformationProvider) Preconditions.PlaceComponentResult(this.applicationComponent.NetworkUserEntityData$$ExternalSyntheticLambda7()));
