...
public final class InvestmentEmptyCardViewHolder extends BaseRecyclerViewHolder<WalletV3CardModel> {
    ...
    public final void bindData(WalletV3CardModel item) {
        super.bindData((InvestmentEmptyCardViewHolder) item);
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "");
        DefaultEmptyCardView defaultEmptyCardView = new DefaultEmptyCardView(context, "FINANCIAL", this.walletCardAssetClickListener);
