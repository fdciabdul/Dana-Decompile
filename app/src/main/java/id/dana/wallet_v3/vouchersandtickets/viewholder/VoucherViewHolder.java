...
public final class VoucherViewHolder extends BaseRecyclerViewHolder<WalletV3CardModel> {
    ...
    public /* synthetic */ VoucherViewHolder(Context context, ViewGroup viewGroup, PublishSubject publishSubject, WalletCardAssetClickListener walletCardAssetClickListener, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, viewGroup, publishSubject, (i & 8) != 0 ? null : walletCardAssetClickListener);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VoucherViewHolder(Context context, ViewGroup viewGroup, PublishSubject<Integer> publishSubject, WalletCardAssetClickListener walletCardAssetClickListener) {
    ...
    public final void bindData(WalletV3CardModel item) {
        super.bindData((VoucherViewHolder) item);
        if (item == null || !(item instanceof VoucherAndTicketCardModel.VoucherCard)) {
            return;
        }
        ...
        VoucherWalletV3CardView voucherWalletV3CardView = new VoucherWalletV3CardView(context, walletCardAssetClickListener, (VoucherAndTicketCardModel.VoucherCard) item, publishSubject, 0, 16, null);
        ConstraintLayout constraintLayout = (ConstraintLayout) this.itemView.findViewById(R.id.cl_item_wallet_container);
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "");
        voucherWalletV3CardView.addCardViewInto(constraintLayout);
    }
}
