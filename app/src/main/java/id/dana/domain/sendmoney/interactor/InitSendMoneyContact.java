...
public class InitSendMoneyContact extends UseCase<SendMoneyInit, Params> {
    private final SendMoneyRepository sendMoneyRepository;

    @Inject
    public InitSendMoneyContact(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SendMoneyRepository sendMoneyRepository) {
