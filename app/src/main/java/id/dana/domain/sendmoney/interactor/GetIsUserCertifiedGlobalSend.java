...
public final class GetIsUserCertifiedGlobalSend extends BaseUseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> isUserCertifiedGlobalSend = this.sendMoneyRepository.getIsUserCertifiedGlobalSend();
        Intrinsics.checkNotNullExpressionValue(isUserCertifiedGlobalSend, "");
        return isUserCertifiedGlobalSend;
    }
}
