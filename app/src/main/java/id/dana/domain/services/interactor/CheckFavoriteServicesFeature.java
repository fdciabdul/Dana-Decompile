...
public final class CheckFavoriteServicesFeature extends BaseUseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> onErrorReturnItem = this.featureConfigRepository.isFavoriteServicesEnable().onErrorReturnItem(Boolean.FALSE);
