...
public class GetLeaderboardEntryBanner extends UseCase<Space, Void> {
    private final PromotionRepository promotionRepository;

    @Inject
    public GetLeaderboardEntryBanner(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, PromotionRepository promotionRepository) {
