...
public final class SaveShowOnboardingTooltip extends UseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCaseObservable(NoParams params) {
        ...
        return this.nearbyMeRepository.saveShowOnboardingTooltip();
    }
}
