...
public final class IsStatementFeatureEnabled extends BaseUseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> isStatementEnable = this.featureConfigRepository.isStatementEnable();
        Intrinsics.checkNotNullExpressionValue(isStatementEnable, "");
        return isStatementEnable;
    }
}
