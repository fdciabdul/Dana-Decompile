...
public final class GetMinimumRadiusInMeter extends BaseUseCase<Integer, NoParams> {
    ...
    public final Observable<Integer> buildUseCase(NoParams params) {
        ...
        Observable<Integer> minimumRadiusInMeter = this.featureConfigRepository.getMinimumRadiusInMeter();
        Intrinsics.checkNotNullExpressionValue(minimumRadiusInMeter, "");
        return minimumRadiusInMeter;
    }
}
