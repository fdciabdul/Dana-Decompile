...
public class SaveSyncProcessStatusComplete extends UseCase<Boolean, Void> {
    private final SyncContactRepository syncContactRepository;

    @Inject
    public SaveSyncProcessStatusComplete(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SyncContactRepository syncContactRepository) {
