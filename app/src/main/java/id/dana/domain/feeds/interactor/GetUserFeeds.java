...
public class GetUserFeeds extends BaseGetFeeds {
    private final FeedsRepository feedsRepository;

    @Inject
    public GetUserFeeds(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, FeedsRepository feedsRepository) {
    ...
    public Observable<Feeds> buildUseCaseObservable(BaseGetFeeds.Params params) {
        return this.feedsRepository.getUserFeeds(params.pageSize, params.maxId);
    }
}
