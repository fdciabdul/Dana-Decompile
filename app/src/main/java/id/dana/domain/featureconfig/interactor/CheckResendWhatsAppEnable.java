...
public final class CheckResendWhatsAppEnable extends BaseUseCase<Boolean, NoParams> {
    private final FeatureConfigRepository featureConfigRepository;

    @Inject
    public CheckResendWhatsAppEnable(FeatureConfigRepository featureConfigRepository) {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        Observable<Boolean> checkIsResendWhatsAppEnable = this.featureConfigRepository.checkIsResendWhatsAppEnable();
        Intrinsics.checkNotNullExpressionValue(checkIsResendWhatsAppEnable, "");
        return checkIsResendWhatsAppEnable;
    }
}
