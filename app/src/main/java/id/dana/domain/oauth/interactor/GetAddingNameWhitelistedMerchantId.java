...
public final class GetAddingNameWhitelistedMerchantId extends BaseUseCase<Set<? extends String>, NoParams> {
    private final FeatureConfigRepository featureConfigRepository;

    @Inject
    public GetAddingNameWhitelistedMerchantId(FeatureConfigRepository featureConfigRepository) {
    ...
    public final Observable<Set<String>> buildUseCase(NoParams params) {
        ...
        Observable<Set<String>> addingNameWhitelistedSubMerchantId = this.featureConfigRepository.getAddingNameWhitelistedSubMerchantId();
        Intrinsics.checkNotNullExpressionValue(addingNameWhitelistedSubMerchantId, "");
