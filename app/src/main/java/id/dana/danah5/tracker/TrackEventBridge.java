...
public final class TrackEventBridge extends StrictBaseBridge {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:189:0x0126 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:201:0x0087 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
