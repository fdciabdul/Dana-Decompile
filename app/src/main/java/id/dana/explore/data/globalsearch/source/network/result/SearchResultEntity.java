...
public final /* data */ class SearchResultEntity extends BaseRpcResult {
    ...
    public final SearchResultEntity copy(List<PaySearchInfoEntity> searchResultList, PaginatorEntity paginator) {
        Intrinsics.checkNotNullParameter(searchResultList, "");
        Intrinsics.checkNotNullParameter(paginator, "");
        return new SearchResultEntity(searchResultList, paginator);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other instanceof SearchResultEntity) {
            ...
            return Intrinsics.areEqual(this.searchResultList, searchResultEntity.searchResultList) && Intrinsics.areEqual(this.paginator, searchResultEntity.paginator);
        }
        return false;
    }

    public final int hashCode() {
        return (this.searchResultList.hashCode() * 31) + this.paginator.hashCode();
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("SearchResultEntity(searchResultList=");
    ...
    public SearchResultEntity(List<PaySearchInfoEntity> list, PaginatorEntity paginatorEntity) {
