...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002\"\b\b\u0000\u0010\u0001*\u00020\u00002\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"", "T", "Lio/reactivex/Maybe;", "p0", "KClassImpl$Data$declaredNonStaticMembers$2", "(Lio/reactivex/Maybe;)Lio/reactivex/Maybe;"}, k = 3, mv = {1, 8, 0})
/* loaded from: classes9.dex */
final class MaybeKt$mergeAllMaybes$1<T, R> implements Function<T, MaybeSource<? extends R>> {
    public static final MaybeKt$mergeAllMaybes$1 BuiltInFictitiousFunctionClassFactory = new MaybeKt$mergeAllMaybes$1();
    ...
    public final Maybe<T> apply(Maybe<T> maybe) {
        Intrinsics.checkParameterIsNotNull(maybe, "");
        return maybe;
    }
}
