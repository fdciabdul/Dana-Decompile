...
final class FlowablesKt$zipWith$2<T1, T2, R, T, U> implements BiFunction<T, U, Pair<? extends T, ? extends U>> {
    public static final FlowablesKt$zipWith$2 PlaceComponentResult = new FlowablesKt$zipWith$2();
