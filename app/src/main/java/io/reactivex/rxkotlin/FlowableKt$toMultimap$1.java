...
final class FlowableKt$toMultimap$1<T, R, K> implements Function<T, K> {
    public static final FlowableKt$toMultimap$1 PlaceComponentResult = new FlowableKt$toMultimap$1();
