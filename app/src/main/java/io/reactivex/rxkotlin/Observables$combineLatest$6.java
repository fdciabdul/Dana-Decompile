...
public final class Observables$combineLatest$6<T1, T2, T3, T4, T5, R> implements Function5<T1, T2, T3, T4, T5, R> {
    final /* synthetic */ kotlin.jvm.functions.Function5 $KClassImpl$Data$declaredNonStaticMembers$2;
    ...
    public final R apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
        ...
        return (R) this.$KClassImpl$Data$declaredNonStaticMembers$2.invoke(t1, t2, t3, t4, t5);
    }
}
