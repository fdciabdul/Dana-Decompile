...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    public final void KClassImpl$Data$declaredNonStaticMembers$2(Subscriber<? super R> subscriber) {
        this.KClassImpl$Data$declaredNonStaticMembers$2.MyBillsEntityDataFactory(new FlatMapIterableObserver(subscriber, this.MyBillsEntityDataFactory));
    }
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        final void slowPath(Subscriber<? super R> subscriber, Iterator<? extends R> it) {
