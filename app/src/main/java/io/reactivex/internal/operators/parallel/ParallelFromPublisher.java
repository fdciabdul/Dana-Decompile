...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    final Publisher<? extends T> PlaceComponentResult;
    ...
    public final void getAuthRequestContext(Subscriber<? super T>[] subscriberArr) {
        if (MyBillsEntityDataFactory(subscriberArr)) {
            this.PlaceComponentResult.subscribe(new ParallelDispatcher(subscriberArr, this.KClassImpl$Data$declaredNonStaticMembers$2));
        }
    }
        ...
        public final class RailSubscription implements Subscription {
            ...
            public final void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.MyBillsEntityDataFactory);
                        if (j2 == LongCompanionObject.MAX_VALUE) {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.MyBillsEntityDataFactory, j2, BackpressureHelper.KClassImpl$Data$declaredNonStaticMembers$2(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.KClassImpl$Data$declaredNonStaticMembers$2) {
            ...
            public final void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.MyBillsEntityDataFactory + this.KClassImpl$Data$declaredNonStaticMembers$2, 0L, 1L)) {
