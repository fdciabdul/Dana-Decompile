...
public final class FlowableObserveOn<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public final void KClassImpl$Data$declaredNonStaticMembers$2(Subscriber<? super T> subscriber) {
        ...
        if (subscriber instanceof ConditionalSubscriber) {
            this.BuiltInFictitiousFunctionClassFactory.getAuthRequestContext(new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, createWorker, this.KClassImpl$Data$declaredNonStaticMembers$2, this.getAuthRequestContext));
        } else {
            this.BuiltInFictitiousFunctionClassFactory.getAuthRequestContext(new ObserveOnSubscriber(subscriber, createWorker, this.KClassImpl$Data$declaredNonStaticMembers$2, this.getAuthRequestContext));
        }
    }
