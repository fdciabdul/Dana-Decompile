...
public final class ObservableRetryWhen<T> extends AbstractObservableWithUpstream<T, T> {
    final Function<? super Observable<Throwable>, ? extends ObservableSource<?>> BuiltInFictitiousFunctionClassFactory;
    ...
    public final void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.PlaceComponentResult(this.BuiltInFictitiousFunctionClassFactory.apply(serializedSubject), "The handler returned a null ObservableSource");
