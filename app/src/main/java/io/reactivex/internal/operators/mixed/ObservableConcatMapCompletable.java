...
public final class ObservableConcatMapCompletable<T> extends Completable {
    ...
    final Observable<T> PlaceComponentResult;
    ...
    public ObservableConcatMapCompletable(Observable<T> observable, Function<? super T, ? extends CompletableSource> function, ErrorMode errorMode, int i) {
        ...
        this.KClassImpl$Data$declaredNonStaticMembers$2 = errorMode;
        this.BuiltInFictitiousFunctionClassFactory = i;
    }

    @Override // io.reactivex.Completable
    public final void MyBillsEntityDataFactory(CompletableObserver completableObserver) {
        if (ScalarXMapZHelper.MyBillsEntityDataFactory(this.PlaceComponentResult, this.getAuthRequestContext, completableObserver)) {
            return;
        }
        this.PlaceComponentResult.subscribe(new ConcatMapCompletableObserver(completableObserver, this.getAuthRequestContext, this.KClassImpl$Data$declaredNonStaticMembers$2, this.BuiltInFictitiousFunctionClassFactory));
    }
            ...
            while (!this.disposed) {
                if (!this.active) {
                    ...
                    try {
                        ...
                        if (poll != null) {
                            completableSource = (CompletableSource) ObjectHelper.PlaceComponentResult(this.mapper.apply(poll), "The mapper returned a null CompletableSource");
                            z = false;
                        } else {
                            z = true;
                        }
                        if (z2 && z) {
                            ...
                            this.active = true;
                            completableSource.getAuthRequestContext(this.inner);
                        }
                    } catch (Throwable th) {
