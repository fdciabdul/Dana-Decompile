...
public final class FlowableSequenceEqual<T> extends Flowable<Boolean> {
    ...
    public FlowableSequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        ...
        this.MyBillsEntityDataFactory = publisher2;
        this.KClassImpl$Data$declaredNonStaticMembers$2 = biPredicate;
        this.getAuthRequestContext = i;
    }

    @Override // io.reactivex.Flowable
    public final void KClassImpl$Data$declaredNonStaticMembers$2(Subscriber<? super Boolean> subscriber) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(subscriber, this.getAuthRequestContext, this.KClassImpl$Data$declaredNonStaticMembers$2);
        subscriber.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.BuiltInFictitiousFunctionClassFactory, this.MyBillsEntityDataFactory);
    }
