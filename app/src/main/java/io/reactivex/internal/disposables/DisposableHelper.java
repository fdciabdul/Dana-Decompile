...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.KClassImpl$Data$declaredNonStaticMembers$2(atomicReference, disposable2, disposable));
        if (disposable2 != null) {
            disposable2.dispose();
            return true;
        }
    ...
    public static void reportDisposableSet() {
        RxJavaPlugins.PlaceComponentResult(new ProtocolViolationException("Disposable already set!"));
    }
