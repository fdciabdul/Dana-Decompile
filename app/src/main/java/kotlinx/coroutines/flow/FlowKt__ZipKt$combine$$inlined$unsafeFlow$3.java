...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements Flow<R> {
    ...
    public final Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        final Flow[] flowArr2 = this.$flowArray$inlined;
        Function0 function0 = new Function0<T[]>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1
        ...
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new FlowKt__ZipKt$combine$6$2(this.$transform$inlined, null), continuation);
