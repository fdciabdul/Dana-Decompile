...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    ...
    private final transient String typeId = "Hijrah-umalqura";
    private final transient String calendarType = "islamic-umalqura";
    ...
    public abstract /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                PlaceComponentResult[ChronoField.YEAR.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                PlaceComponentResult[ChronoField.YEAR_OF_ERA.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                PlaceComponentResult[ChronoField.ERA.ordinal()] = 6;
    ...
    static {
        try {
            HijrahChronology hijrahChronology = new HijrahChronology();
    ...
    private void checkCalendarInit() {
        ...
        try {
            ...
            for (int i = SecExceptionCode.SEC_ERROR_MALDETECT; i <= 1600; i++) {
            ...
            int[] createEpochMonths = createEpochMonths(epochDay, hashMap);
            this.hijrahEpochMonthStartDays = createEpochMonths;
            this.maxEpochDay = createEpochMonths[3612];
            for (int i2 = SecExceptionCode.SEC_ERROR_MALDETECT; i2 < 1600; i2++) {
            ...
            StringBuilder PlaceComponentResult = DayOfWeek$$ExternalSyntheticOutline0.PlaceComponentResult("Unable to initialize HijrahCalendar: ");
            PlaceComponentResult.append(this.typeId);
            throw new DateTimeException(PlaceComponentResult.toString(), e);
        }
    }

    private int[] createEpochMonths(int i, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.minMonthLength = Integer.MAX_VALUE;
        this.maxMonthLength = Integer.MIN_VALUE;
        int i2 = 0;
        for (int i3 = SecExceptionCode.SEC_ERROR_MALDETECT; i3 <= 1600; i3++) {
            ...
            while (i4 < 12) {
                ...
                i += i5;
                this.minMonthLength = Math.min(this.minMonthLength, i5);
                this.maxMonthLength = Math.max(this.maxMonthLength, i5);
                i4++;
                i2++;
            }
        }
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("Did not fill epochMonths exactly: ndx = ");
        sb.append(i6);
        sb.append(" should be ");
        sb.append(3613);
    ...
    public final ChronoLocalDate dateNow() {
        return HijrahDate.ofEpochDay(this, LocalDate.now(Clock.systemDefaultZone()).getLong(ChronoField.EPOCH_DAY));
    }
    ...
    public final int getDayOfYear(int i, int i2) {
        int i3 = (i * 12) - this.hijrahStartEpochMonth;
        int[] iArr = this.hijrahEpochMonthStartDays;
        return iArr[(i2 - 1) + i3] - iArr[i3];
    }

    public final long getEpochDay(int i, int i2, int i3) {
        checkCalendarInit();
        if (i2 <= 0 || i2 > 12) {
            StringBuilder sb = new StringBuilder();
        ...
        int i4 = (i2 - 1) + ((i * 12) - this.hijrahStartEpochMonth);
        if (i4 < 0 || i4 >= this.hijrahEpochMonthStartDays.length) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Invalid Hijrah date, year: ");
            sb2.append(i);
            sb2.append(", month: ");
            sb2.append(i2);
            throw new DateTimeException(sb2.toString());
        } else if (i3 <= 0 || i3 > getMonthLength(i, i2)) {
            StringBuilder sb3 = new StringBuilder();
            sb3.append("Invalid Hijrah day of month: ");
            sb3.append(i3);
            throw new DateTimeException(sb3.toString());
        } else {
            return (i3 - 1) + this.hijrahEpochMonthStartDays[i4];
        }
    }

    public final int[] getHijrahDateInfo(int i) {
        checkCalendarInit();
        ...
        int i2 = this.hijrahStartEpochMonth + binarySearch;
        return new int[]{i2 / 12, (i2 % 12) + 1, (i - this.hijrahEpochMonthStartDays[binarySearch]) + 1};
    }
    ...
    public final int getMaximumYear() {
        return (((this.hijrahEpochMonthStartDays.length - 1) + this.hijrahStartEpochMonth) / 12) - 1;
    }

    public final int getMinimumYear() {
        return (this.hijrahStartEpochMonth + 0) / 12;
    }

    public final int getMonthLength(int i, int i2) {
        int i3 = (i2 - 1) + ((i * 12) - this.hijrahStartEpochMonth);
        if (i3 >= 0) {
            int[] iArr = this.hijrahEpochMonthStartDays;
            if (i3 < iArr.length) {
    ...
    public final int getYearLength(int i) {
        int i2 = (i * 12) - this.hijrahStartEpochMonth;
        int[] iArr = this.hijrahEpochMonthStartDays;
    ...
    public final ValueRange range(ChronoField chronoField) {
        ...
        if (chronoField instanceof ChronoField) {
            switch (AnonymousClass1.PlaceComponentResult[chronoField.ordinal()]) {
                case 1:
                    return ValueRange.of(1L, this.minMonthLength, this.maxMonthLength);
                case 2:
                    return ValueRange.of(1L, this.maxYearLength);
                case 3:
    ...
    public final ChronoLocalDate resolveDate(HashMap hashMap, ResolverStyle resolverStyle) {
        return (HijrahDate) super.resolveDate(hashMap, resolverStyle);
    }
