...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void onTargetFound(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        if (calculateTimeForDeceleration > 0) {
            ...
            action.BuiltInFictitiousFunctionClassFactory = -calculateDxToMakeVisible;
            action.getAuthRequestContext = -calculateDyToMakeVisible;
    ...
    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        if (computeScrollVectorForPosition != null && (computeScrollVectorForPosition.x != 0.0f || computeScrollVectorForPosition.y != 0.0f)) {
            ...
            int i3 = (int) (calculateTimeForScrolling * TARGET_SEEK_EXTRA_SCROLL_RATIO);
            ...
            action.MyBillsEntityDataFactory = i3;
            action.KClassImpl$Data$declaredNonStaticMembers$2 = linearInterpolator;
            action.PlaceComponentResult = true;
            return;
        }
        action.lookAheadTest = getTargetPosition();
        stop();
    }
