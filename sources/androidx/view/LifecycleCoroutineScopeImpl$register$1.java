...
final class LifecycleCoroutineScopeImpl$register$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.this$0.PlaceComponentResult.PlaceComponentResult().compareTo(Lifecycle.State.INITIALIZED) < 0) {
                JobKt__JobKt.cancel$default(coroutineScope.getPlaceComponentResult(), null, 1, null);
            } else {
                this.this$0.PlaceComponentResult.BuiltInFictitiousFunctionClassFactory(this.this$0);
            }
