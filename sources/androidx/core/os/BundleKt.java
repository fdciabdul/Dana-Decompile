...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\b\u0003\u001a\r\u0010\u0001\u001a\u00020\u0000¢\u0006\u0004\b\u0001\u0010\u0002\u001a=\u0010\b\u001a\u00020\u00002.\u0010\u0007\u001a\u0018\u0012\u0014\b\u0001\u0012\u0010\u0012\u0004\u0012\u00020\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u00040\u0003\"\u0010\u0012\u0004\u0012\u00020\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u0004¢\u0006\u0004\b\b\u0010\t"}, d2 = {"Landroid/os/Bundle;", "BuiltInFictitiousFunctionClassFactory", "()Landroid/os/Bundle;", "", "Lkotlin/Pair;", "", "", "p0", "PlaceComponentResult", "([Lkotlin/Pair;)Landroid/os/Bundle;"}, k = 2, mv = {1, 7, 1}, xi = 48)
/* loaded from: classes.dex */
public final class BundleKt {
    public static final Bundle PlaceComponentResult(Pair<String, ? extends Object>... pairArr) {
        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (component2 == null) {
                ...
                BundleApi18ImplKt.getAuthRequestContext(bundle, component1, (IBinder) component2);
            } else if (Build.VERSION.SDK_INT >= 21 && (component2 instanceof Size)) {
                BundleApi21ImplKt.getAuthRequestContext(bundle, component1, (Size) component2);
            } else if (Build.VERSION.SDK_INT >= 21 && (component2 instanceof SizeF)) {
                BundleApi21ImplKt.KClassImpl$Data$declaredNonStaticMembers$2(bundle, component1, (SizeF) component2);
            } else {
    ...
    public static final Bundle BuiltInFictitiousFunctionClassFactory() {
        return new Bundle(0);
    }
}
