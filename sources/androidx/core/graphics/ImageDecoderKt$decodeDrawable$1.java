...
public final class ImageDecoderKt$decodeDrawable$1 implements ImageDecoder.OnHeaderDecodedListener {
    final /* synthetic */ Function3<ImageDecoder, ImageDecoder.ImageInfo, ImageDecoder.Source, Unit> $BuiltInFictitiousFunctionClassFactory;
    ...
    public final void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
        ...
        this.$BuiltInFictitiousFunctionClassFactory.invoke(imageDecoder, imageInfo, source);
    }
}
