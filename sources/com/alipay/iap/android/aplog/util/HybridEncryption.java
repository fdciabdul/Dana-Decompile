...
public class HybridEncryption {
    ...
    static {
        ...
        sb.append(android.util.Base64.class.getName());
    ...
    public static HybridEncryption createInstance(Context context) {
    ...
    public static HybridEncryption createInstance(String str) {
        HybridEncryption hybridEncryption;
        synchronized (HybridEncryption.class) {
            if (INSTANCE == null) {
        ...
        if (this.rawSeed == null || this.secureSeed == null) {
            try {
                ...
                if (!this.isRandomUUIDError) {
                    ...
                    InstrumentInjector.log_e(TAG, "encrypt", th);
                }
                bArr2 = null;
            }
            if (bArr2 == null) {
                try {
                    ...
                    if (!this.isGenerateSeedError) {
                        ...
                        InstrumentInjector.log_e(TAG, "encrypt", th2);
                    }
                }
            }
        ...
        if (bArr3 != null && this.secureSeed != null) {
            try {
                ...
                if (!this.isCreatePairError) {
                    ...
                    InstrumentInjector.log_e(TAG, "encrypt", th3);
                }
            }
        }
        return null;
