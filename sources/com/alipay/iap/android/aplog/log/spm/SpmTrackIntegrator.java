...
public class SpmTrackIntegrator {
    ...
    public static SpmTrackIntegrator getInstance() {
    ...
    public void logPageStartWithSpmId(String str, final Object obj) {
        ...
        if (obj instanceof View) {
            try {
                ((View) obj).addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.alipay.iap.android.aplog.log.spm.SpmTrackIntegrator.1
    ...
    public void pageOnDestroy(Object obj) {
        ...
        myHandler.postDelayed(new Runnable() { // from class: com.alipay.iap.android.aplog.log.spm.SpmTrackIntegrator.2
