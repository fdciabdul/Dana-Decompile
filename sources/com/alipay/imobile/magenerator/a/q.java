...
public final class q {
    ...
    private static final int[][] f7019a = {new int[]{1, 1, 1, 1, 1, 1, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 1, 1, 1, 1, 1, 1}};
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void a(b bVar, m mVar, y yVar, int i, e eVar) {
        a(eVar);
        a(yVar, eVar);
        a(mVar, i, eVar);
        b(yVar, eVar);
    ...
    static void a(m mVar, int i, b bVar) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("should not happen but we got: ");
        sb.append(bVar.a());
        throw new ac(sb.toString());
    }
    ...
    private static void d(int i, int i2, e eVar) {
        for (int i3 = 0; i3 < 7; i3++) {
            for (int i4 = 0; i4 < 7; i4++) {
                eVar.a(i + i4, i2 + i3, f7019a[i3][i4]);
            }
        }
    }

    private static void d(e eVar) {
        int length = f7019a[0].length;
        d(0, 0, eVar);
