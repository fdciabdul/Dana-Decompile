...
public class HttpTaskUtil {
    ...
    private static MICRpcResponse requestPost(String str, String str2, MICRpcRequest mICRpcRequest) {
        try {
            ...
            HttpURLConnection httpURLConnection = (HttpURLConnection) ((URLConnection) FirebasePerfUrlConnection.instrument(InstrumentInjector.urlconnection_wrapInstance(new URL(str2).openConnection())));
    ...
    private static MICRpcResponse parseJson(String str, MICRpcRequest mICRpcRequest) {
        ...
        try {
            ...
            mICRpcResponse.finishCode = "00000000".equals(optJSONObject2.optString(optJSONObject2.getString("resultCodeId"))) ? "1000" : "1001";
