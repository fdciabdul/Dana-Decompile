...
public class ProductConstants {
    ...
    public static final String KEY_PRODUCT_ENV_DATA = "envData";
    public static final String KEY_PRODUCT_ENV_IFFA = "secData";
    public static final String KEY_PRODUCT_ENV_ZOLOZ = "bioMetaInfo";
    public static final String KEY_PRODUCT_STATE_ZOLOZ = "SecVIAPStatusZoloz";
