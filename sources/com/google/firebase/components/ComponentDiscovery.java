...
public final class ComponentDiscovery<T> {
    ...
    public final List<ComponentRegistrar> discover() {
        ...
        while (it.hasNext()) {
            try {
                ...
                InstrumentInjector.log_w(TAG, "Invalid component registrar.", e);
            }
        }
        return arrayList;
    }
    ...
    public static ComponentRegistrar instantiate(String str) {
        try {
            ...
            InstrumentInjector.log_w(TAG, String.format("Class %s is not an found.", str));
            return null;
    ...
    public static class MetadataRegistrarNameRetriever implements RegistrarNameRetriever<Context> {
        ...
        public List<String> retrieve(Context context) {
            ...
            if (metadata == null) {
                InstrumentInjector.log_w(ComponentDiscovery.TAG, "Could not retrieve metadata, returning empty list of registrars.");
        ...
        private Bundle getMetadata(Context context) {
            try {
                ...
                if (packageManager == null) {
                    InstrumentInjector.log_w(ComponentDiscovery.TAG, "Context has no PackageManager.");
                    return null;
                }
                ...
                if (serviceInfo == null) {
                    ...
                    InstrumentInjector.log_w(ComponentDiscovery.TAG, sb.toString());
                    return null;
                }
                return serviceInfo.metaData;
            } catch (PackageManager.NameNotFoundException unused) {
                InstrumentInjector.log_w(ComponentDiscovery.TAG, "Application info not found.");
                return null;
            }
        }
    }
