...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        String str;
        String str2 = z ? "ENABLED" : NewSwitchFaceAuthenticationView.DISABLED;
        if (this.crashlyticsDataCollectionEnabled == null) {
            str = "global Firebase setting";
        } else {
            str = this.setInManifest ? "firebase_crashlytics_collection_enabled manifest flag" : KybDataSource.API;
        }
