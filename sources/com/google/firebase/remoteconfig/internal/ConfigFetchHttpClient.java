...
public class ConfigFetchHttpClient {
    ...
    public HttpURLConnection createHttpURLConnection() throws FirebaseRemoteConfigException {
        try {
            return (HttpURLConnection) InstrumentInjector.urlconnection_wrapInstance(new URL(getFetchUrl(this.projectNumber, this.namespace)).openConnection());
        } catch (IOException e) {
    ...
    public ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date) throws FirebaseRemoteConfigException {
        ...
        try {
            try {
                setFetchRequestBody(httpURLConnection, createFetchRequestBody(str, str2, map, l).toString().getBytes(HereOauthManager.ENC));
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            if (packageCertificateHashBytes == null) {
                ...
                InstrumentInjector.log_e(FirebaseRemoteConfig.TAG, sb.toString());
                return null;
            }
            ...
            InstrumentInjector.log_e(FirebaseRemoteConfig.TAG, sb2.toString(), e);
            return null;
        }
    }
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l) throws FirebaseRemoteConfigClientException {
        ...
        hashMap.put(RemoteConfigConstants.RequestFieldKey.LANGUAGE_CODE, obj);
        ...
        try {
            ...
            if (packageInfo != null) {
                ...
                hashMap.put(RemoteConfigConstants.RequestFieldKey.APP_BUILD, Long.toString(PackageInfoCompat.getAuthRequestContext(packageInfo)));
            }
    ...
    private JSONObject getFetchResponseBody(URLConnection uRLConnection) throws IOException, JSONException {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(uRLConnection.getInputStream(), HereOauthManager.ENC));
        StringBuilder sb = new StringBuilder();
        while (true) {
