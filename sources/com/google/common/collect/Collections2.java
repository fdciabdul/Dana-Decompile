...
public final class Collections2 {
    ...
    public static StringBuilder newStringBuilderForCollection(int i) {
        CollectPreconditions.checkNonnegative(i, GriverMonitorConstants.KEY_SIZE);
        return new StringBuilder((int) Math.min(i * 8, (long) ConvertUtils.GB));
    }
