...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class AsSet extends ImmutableSortedSet<C> {
        ...
        final ImmutableSortedSet<C> headSetImpl(C c, boolean z) {
            return subSet(Range.upTo(c, BoundType.forBoolean(z)));
        }

        final ImmutableSortedSet<C> subSetImpl(C c, boolean z, C c2, boolean z2) {
        ...
        final ImmutableSortedSet<C> tailSetImpl(C c, boolean z) {
