...
public final class EnumHashBiMap<K extends Enum<K>, V> extends AbstractBiMap<K, V> {
    ...
    @CheckForNull
    public final /* bridge */ /* synthetic */ Object forcePut(Object obj, @ParametricNullness Object obj2) {
    ...
    @CheckForNull
    public final V put(K k, @ParametricNullness V v) {
        return (V) super.put((EnumHashBiMap<K, V>) k, (K) v);
    }

    @CheckForNull
    public final V forcePut(K k, @ParametricNullness V v) {
