...
public final class Multimaps {
    ...
    public static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(@ParametricNullness final K k) {
            return new Sets.ImprovedAbstractSet<V>() { // from class: com.google.common.collect.Multimaps.MapMultimap.1
                {
                    MapMultimap.this = this;
                }

                /* renamed from: com.google.common.collect.Multimaps$MapMultimap$1$1 */
                /* loaded from: classes7.dex */
                class C01001 implements Iterator<V>, j$.util.Iterator {
                    int i;
    ...
    public static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m124x893217c0(@ParametricNullness K k, Collection<V1> collection) {
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer() { // from class: com.google.common.collect.Multimaps$TransformedEntriesMultimap$$ExternalSyntheticLambda0
                ...
                public final Object transformEntry(Object obj, Object obj2) {
                    return Multimaps.TransformedEntriesMultimap.this.m124x893217c0(obj, (Collection) obj2);
                }
            });
        }
        ...
        public Collection<V2> get(@ParametricNullness K k) {
            return m124x893217c0(k, this.fromMultimap.get(k));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object obj) {
            return m124x893217c0(obj, this.fromMultimap.removeAll(obj));
        }
    ...
    public static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        /* renamed from: transform */
        public final /* bridge */ /* synthetic */ Collection m124x893217c0(@ParametricNullness Object obj, Collection collection) {
            return m124x893217c0((TransformedEntriesListMultimap<K, V1, V2>) obj, collection);
        }
        ...
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap
        /* renamed from: transform */
        public final List<V2> m124x893217c0(@ParametricNullness K k, Collection<V1> collection) {
            return Lists.transform((List) collection, Maps.asValueToValueFunction(this.transformer, k));
        }

        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.Multimap
        public final List<V2> get(@ParametricNullness K k) {
            return m124x893217c0((TransformedEntriesListMultimap<K, V1, V2>) k, (Collection) this.fromMultimap.get(k));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.Multimap
        public final List<V2> removeAll(@CheckForNull Object obj) {
            return m124x893217c0((TransformedEntriesListMultimap<K, V1, V2>) obj, (Collection) this.fromMultimap.removeAll(obj));
        }

        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.AbstractMultimap, com.google.common.collect.Multimap
        public final List<V2> replaceValues(@ParametricNullness K k, Iterable<? extends V2> iterable) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    public static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        public java.util.Iterator<Multiset.Entry<K>> entryIterator() {
    ...
    public static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        final void removeValuesForKey(@CheckForNull Object obj) {
        ...
        public class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public java.util.Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new Function() { // from class: com.google.common.collect.Multimaps$AsMap$EntrySet$$ExternalSyntheticLambda0
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return Multimaps.AsMap.EntrySet.this.m123xda360ac8(obj);
                    }
                });
            }

            /* renamed from: lambda$iterator$0$com-google-common-collect-Multimaps$AsMap$EntrySet */
            public /* synthetic */ Collection m123xda360ac8(Object obj) {
