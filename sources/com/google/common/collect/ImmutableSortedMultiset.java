    ...
    public static class Builder<E> extends ImmutableMultiset.Builder<E> {
        ...
        private void dedupAndCoalesce(boolean z) {
            ...
            if (z) {
                int i4 = this.length;
                if (i2 * 4 > i4 * 3) {
                    eArr = (E[]) Arrays.copyOf(eArr, IntMath.saturatedAdd(i4, (i4 / 2) + 1));
                }
            }
            int[] iArr = new int[eArr.length];
            for (int i5 = 0; i5 < this.length; i5++) {
                int binarySearch = Arrays.binarySearch(eArr, 0, i2, this.elements[i5], this.comparator);
                int i6 = this.counts[i5];
                if (i6 >= 0) {
                    iArr[binarySearch] = iArr[binarySearch] + i6;
                } else {
                    iArr[binarySearch] = i6 ^ (-1);
                }
            }
            this.elements = eArr;
            this.counts = iArr;
