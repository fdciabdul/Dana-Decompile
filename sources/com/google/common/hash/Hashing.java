...
public final class Hashing {
    ...
    static class Md5Holder {
        static final HashFunction MD5 = new MessageDigestHashFunction(MD5Util.ALGORIGTHM_MD5, "Hashing.md5()");
    ...
    public static HashFunction hmacSha256(Key key) {
        return new MacHashFunction(HereOauthManager.HASHING_ALGORITHM, key, hmacToString("hmacSha256", key));
    }

    public static HashFunction hmacSha256(byte[] bArr) {
        return hmacSha256(new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), HereOauthManager.HASHING_ALGORITHM));
    }
