...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        ...
        return hashLength16((LittleEndianByteArray.load64(bArr, i3 - 16) * K2) + Long.rotateRight(load64 + load642, 43) + Long.rotateRight(load643, 30), load643 + load64 + Long.rotateRight(load642 - 7286425919675154353L, 18), j);
    }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        int i7 = i;
        while (true) {
            long rotateRight = Long.rotateRight(load64 + j + jArr[0] + LittleEndianByteArray.load64(bArr, i7 + 8), 37);
            long rotateRight2 = Long.rotateRight(j + jArr[1] + LittleEndianByteArray.load64(bArr, i7 + 48), 42);
            long j2 = (rotateRight * K1) ^ jArr2[1];
            long load642 = (rotateRight2 * K1) + jArr[0] + LittleEndianByteArray.load64(bArr, i7 + 40);
            ...
            if (i7 == i4) {
                ...
                weakHashLength32WithSeeds(bArr, i6, jArr[1] * j3, j6 + jArr2[0], jArr);
