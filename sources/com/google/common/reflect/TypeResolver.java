...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f7438id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            StringBuilder sb = new StringBuilder();
            sb.append("capture#");
            sb.append(this.f7438id.incrementAndGet());
            sb.append("-of ? extends ");
            sb.append(Joiner.on((char) Typography.amp).join(typeArr));
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f7438id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
                {
                    AnonymousClass1 anonymousClass1 = null;
                }
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f7438id);
        }
