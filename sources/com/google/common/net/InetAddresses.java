...
public final class InetAddresses {
    ...
    private static final Inet4Address LOOPBACK4 = (Inet4Address) forString(OneklikAnnotations.ONEKLIK_STATIC_IP);
    ...
    */
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address inet6Address) {
        ...
        return new TeredoInfo(inet4Address, getInet4Address(copyOfRange), (readShort2 ^ (-1)) & 65535, readShort & UShort.MAX_VALUE);
    }
