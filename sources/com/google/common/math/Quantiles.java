        ...
        public final Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                if (i < iArr6.length) {
                    ...
                    int i8 = iArr4[i];
                    if (i8 == 0) {
                        linkedHashMap2.put(Integer.valueOf(iArr6[i]), Double.valueOf(dArr[i7]));
                    } else {
                        linkedHashMap2.put(Integer.valueOf(iArr6[i]), Double.valueOf(Quantiles.interpolate(dArr[i7], dArr[i7 + 1], i8, this.scale)));
                    }
                    i++;
                } else {
