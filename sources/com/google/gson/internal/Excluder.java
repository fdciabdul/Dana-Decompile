...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public final Excluder m209clone() {
        try {
    ...
    public final Excluder withModifiers(int... iArr) {
        Excluder m209clone = m209clone();
        m209clone.modifiers = 0;
        for (int i : iArr) {
            m209clone.modifiers = i | m209clone.modifiers;
        }
        return m209clone;
    }
    ...
    public final Excluder disableInnerClassSerialization() {
        Excluder m209clone = m209clone();
        m209clone.serializeInnerClasses = false;
        return m209clone;
    }

    public final Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder m209clone = m209clone();
        m209clone.requireExpose = true;
        return m209clone;
    }
    ...
    public final Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            m209clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            m209clone.deserializationStrategies = arrayList2;
