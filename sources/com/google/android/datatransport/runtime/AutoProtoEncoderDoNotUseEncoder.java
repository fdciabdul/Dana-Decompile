...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    static final class ClientMetricsEncoder implements ObjectEncoder<ClientMetrics> {
        ...
        @Override // com.google.firebase.encoders.Encoder
        public final void encode(ClientMetrics clientMetrics, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static final class TimeWindowEncoder implements ObjectEncoder<TimeWindow> {
        ...
        @Override // com.google.firebase.encoders.Encoder
        public final void encode(TimeWindow timeWindow, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static final class LogSourceMetricsEncoder implements ObjectEncoder<LogSourceMetrics> {
        ...
        @Override // com.google.firebase.encoders.Encoder
        public final void encode(LogSourceMetrics logSourceMetrics, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static final class LogEventDroppedEncoder implements ObjectEncoder<LogEventDropped> {
        ...
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.builder(ZdocRecordService.REASON).withProperty(AtProtobuf.builder().tag(3).build()).build();

        private LogEventDroppedEncoder() {
        }

        @Override // com.google.firebase.encoders.Encoder
        public final void encode(LogEventDropped logEventDropped, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static final class GlobalMetricsEncoder implements ObjectEncoder<GlobalMetrics> {
        ...
        @Override // com.google.firebase.encoders.Encoder
        public final void encode(GlobalMetrics globalMetrics, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static final class StorageMetricsEncoder implements ObjectEncoder<StorageMetrics> {
        ...
        @Override // com.google.firebase.encoders.Encoder
        public final void encode(StorageMetrics storageMetrics, ObjectEncoderContext objectEncoderContext) throws IOException {
