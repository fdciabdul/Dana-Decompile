...
public class UvmEntry extends AbstractSafeParcelable {
    ...
    public static final class Builder {
        ...
        public final UvmEntry build() {
            return new UvmEntry(this.zza, this.zzb, this.zzc);
        }

        public final Builder setKeyProtectionType(short s) {
            this.zzb = s;
            return this;
        }

        public final Builder setMatcherProtectionType(short s) {
            this.zzc = s;
            return this;
        }

        public final Builder setUserVerificationMethod(int i) {
            this.zza = i;
            return this;
        }
    }
