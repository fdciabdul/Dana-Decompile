...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable, FSDraw {
    ...
    public static final byte[] KClassImpl$Data$declaredNonStaticMembers$2 = {114, -79, -70, 22, -16, 5, 2, 15, -7, -4, 34, -18, -8, 15, 6, -1, 11, -19, Ascii.ETB, TarHeader.LF_DIR, -60, 13, -11, 9, 59, -36, -18, -8, 15, 6, -1};
    public static final int getAuthRequestContext = 219;
    ...
    */
    private static void a(int r6, short r7, byte r8, java.lang.Object[] r9) {
        /*
            int r8 = r8 * 7
            int r8 = 106 - r8
            byte[] r0 = com.google.android.material.shape.MaterialShapeDrawable.KClassImpl$Data$declaredNonStaticMembers$2
            int r7 = r7 * 3
            int r7 = 16 - r7
            int r6 = r6 + 4
            byte[] r1 = new byte[r7]
        ...
        L36:
            ...
            goto L1a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.shape.MaterialShapeDrawable.a(int, short, byte, java.lang.Object[]):void");
    }
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        try {
            ...
            a(b3, b4, b4, objArr2);
            this.pathProvider = thread == cls.getMethod((String) objArr2[0], null).invoke(null, null) ? ShapeAppearancePathProvider.getInstance() : new ShapeAppearancePathProvider();
    ...
    private void drawCompatShadow(Canvas canvas) {
        if (this.containsIncompatibleShadowOp.cardinality() > 0) {
            InstrumentInjector.log_w(TAG, "Compatibility shadow requested but can't be drawn for all operations in this shape.");
        }
    ...
    private boolean updateTintFilter() {
        ...
        return (ObjectsCompat.MyBillsEntityDataFactory(porterDuffColorFilter, this.tintFilter) && ObjectsCompat.MyBillsEntityDataFactory(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
