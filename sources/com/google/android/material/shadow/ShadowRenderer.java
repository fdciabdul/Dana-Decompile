...
public class ShadowRenderer {
    ...
    public void setShadowColor(int i) {
        this.shadowStartColor = ColorUtils.MyBillsEntityDataFactory(i, 68);
        this.shadowMiddleColor = ColorUtils.MyBillsEntityDataFactory(i, 20);
        this.shadowEndColor = ColorUtils.MyBillsEntityDataFactory(i, 0);
