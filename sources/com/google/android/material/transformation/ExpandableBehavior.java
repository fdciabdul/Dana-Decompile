...
public abstract class ExpandableBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, final View view, int i) {
        ...
        if (ViewCompat.getValueOfTouchPositionAbsolute(view) || (findExpandableWidget = findExpandableWidget(coordinatorLayout, view)) == null || !didStateChange(findExpandableWidget.isExpanded())) {
            return false;
        }
