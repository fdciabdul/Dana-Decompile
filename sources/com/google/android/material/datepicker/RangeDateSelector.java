...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public void setSelection(Pair<Long, Long> pair) {
        if (pair.getAuthRequestContext != null && pair.PlaceComponentResult != null) {
            Preconditions.getAuthRequestContext(isValidRange(pair.getAuthRequestContext.longValue(), pair.PlaceComponentResult.longValue()));
        }
        this.selectedStartItem = pair.getAuthRequestContext == null ? null : Long.valueOf(UtcDates.canonicalYearMonthDay(pair.getAuthRequestContext.longValue()));
        this.selectedEndItem = pair.PlaceComponentResult != null ? Long.valueOf(UtcDates.canonicalYearMonthDay(pair.PlaceComponentResult.longValue())) : null;
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        return resources.getString(R.string.mtrl_picker_range_header_selected, dateRangeString.getAuthRequestContext, dateRangeString.PlaceComponentResult);
    }
