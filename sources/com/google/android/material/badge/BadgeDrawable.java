...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate, FSDraw {
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        if (i4 == 8388659 || i4 == 8388691) {
            this.badgeCenterX = ViewCompat.initRecordTimeStamp(view) == 0 ? (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i3 : ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i3;
        } else {
            this.badgeCenterX = ViewCompat.initRecordTimeStamp(view) == 0 ? ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i3 : (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i3;
        }
    }
