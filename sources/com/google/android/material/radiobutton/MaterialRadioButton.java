    ...
    */
    public MaterialRadioButton(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            androidx.core.widget.CompoundButtonCompat.KClassImpl$Data$declaredNonStaticMembers$2(r7, r8)
        L2a:
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.useMaterialThemeColors && CompoundButtonCompat.PlaceComponentResult(this) == null) {
    ...
    public void setUseMaterialThemeColors(boolean z) {
        ...
        if (z) {
            CompoundButtonCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, getMaterialThemeColorsTintList());
        } else {
            CompoundButtonCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, null);
        }
    }
