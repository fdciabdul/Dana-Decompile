...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    */
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (BuiltInFictitiousFunctionClassFactory = MathUtils.BuiltInFictitiousFunctionClassFactory(i, i2, i3))) {
            return 0;
        }
        setTopAndBottomOffset(BuiltInFictitiousFunctionClassFactory);
        return topAndBottomOffset - BuiltInFictitiousFunctionClassFactory;
    }
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f) {
        ...
        if (this.scroller.computeScrollOffset()) {
            ...
            ViewCompat.PlaceComponentResult(v, flingRunnable);
            return true;
        }
    ...
    public class FlingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (HeaderBehavior.this.scroller.computeScrollOffset()) {
                ...
                ViewCompat.PlaceComponentResult(this.layout, this);
                return;
            }
