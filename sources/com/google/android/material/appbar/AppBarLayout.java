...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior, FSDraw, FSDispatchDraw {
    ...
    public static final byte[] getAuthRequestContext = {Ascii.FS, 71, 97, TarHeader.LF_DIR, Ascii.NAK, -2, 22, 5, 2, 3, -46, 61, Ascii.DC4, 7, 14, -7, 17, 14, -62, Ascii.GS, TarHeader.LF_BLK, 7, 14, -7, Ascii.ESC, 4};
    public static final int PlaceComponentResult = 186;
    ...
    */
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L27:
            ...
            android.graphics.drawable.Drawable r12 = __fsTypeCheck_9006fe4ec1394eae9d20ad9ddd1cb05d(r11, r12)
            androidx.core.view.ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(r9, r12)
            ...
            androidx.core.view.ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(r9, r0)
        L5f:
        ...
        Lae:
            ...
            android.graphics.drawable.Drawable r10 = __fsTypeCheck_9006fe4ec1394eae9d20ad9ddd1cb05d(r11, r10)
            r9.setStatusBarForeground(r10)
            r11.recycle()
            com.google.android.material.appbar.AppBarLayout$1 r10 = new com.google.android.material.appbar.AppBarLayout$1
            r10.<init>()
            androidx.core.view.ViewCompat.MyBillsEntityDataFactory(r9, r10)
            return
        */
    ...
    public void setStatusBarForeground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (mutate != null) {
                ...
                DrawableCompat.getAuthRequestContext(this.statusBarForeground, ViewCompat.initRecordTimeStamp(this));
    ...
    public void setStatusBarForegroundResource(int i) {
        ...
        setStatusBarForeground(BuiltInFictitiousFunctionClassFactory);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && ViewCompat.DatabaseTableConfigUtil(this) && shouldOffsetFirstChild()) {
            int measuredHeight = getMeasuredHeight();
            if (mode == Integer.MIN_VALUE) {
                measuredHeight = MathUtils.BuiltInFictitiousFunctionClassFactory(getMeasuredHeight() + getTopInset(), 0, View.MeasureSpec.getSize(i2));
            } else if (mode == 0) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (ViewCompat.DatabaseTableConfigUtil(this) && shouldOffsetFirstChild()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                ViewCompat.BuiltInFictitiousFunctionClassFactory(getChildAt(childCount), topInset);
            }
        }
        invalidateScrollRanges();
    ...
    public void setExpanded(boolean z) {
        setExpanded(z, ViewCompat.getValueOfTouchPositionAbsolute(this));
    }
    ...
    public final int getTotalScrollRange() {
        ...
        while (true) {
            ...
            if (i3 == 0 && ViewCompat.DatabaseTableConfigUtil(childAt)) {
                i2 -= getTopInset();
            }
            if ((i4 & 2) != 0) {
                i2 -= ViewCompat.PrepareContext(childAt);
                break;
            }
            i3++;
        }
    ...
    int getDownNestedPreScrollRange() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i4 & 5) != 5) {
                ...
                if ((i4 & 8) != 0) {
                    PrepareContext = ViewCompat.PrepareContext(childAt);
                } else if ((i4 & 2) != 0) {
                    PrepareContext = measuredHeight - ViewCompat.PrepareContext(childAt);
                } else {
                    i = i5 + measuredHeight;
                    if (childCount == 0 && ViewCompat.DatabaseTableConfigUtil(childAt)) {
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        int topInset = getTopInset();
        int PrepareContext = ViewCompat.PrepareContext(this);
        if (PrepareContext == 0) {
            int childCount = getChildCount();
            PrepareContext = childCount > 0 ? ViewCompat.PrepareContext(getChildAt(childCount - 1)) : 0;
            if (PrepareContext == 0) {
                return getHeight() / 3;
            }
        }
        return (PrepareContext * 2) + topInset;
    }
    ...
    final int getTopInset() {
        ...
        if (windowInsetsCompat != null) {
            return windowInsetsCompat.initRecordTimeStamp();
        }
        return 0;
    }
    ...
    private boolean shouldOffsetFirstChild() {
        if (getChildCount() > 0) {
            ...
            return (childAt.getVisibility() == 8 || ViewCompat.DatabaseTableConfigUtil(childAt)) ? false : true;
        }
        return false;
    }

    WindowInsetsCompat onWindowInsetChanged(WindowInsetsCompat windowInsetsCompat) {
        WindowInsetsCompat windowInsetsCompat2 = ViewCompat.DatabaseTableConfigUtil(this) ? windowInsetsCompat : null;
        if (!ObjectsCompat.MyBillsEntityDataFactory(this.lastInsets, windowInsetsCompat2)) {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    if (checkFlag(scrollFlags, 2)) {
                        ...
                        int PrepareContext = ViewCompat.PrepareContext(childAt) + i2;
                        if (topBottomOffsetForScrollingSibling < PrepareContext) {
                            i = PrepareContext;
                        } else {
                            i2 = PrepareContext;
                        }
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.BuiltInFictitiousFunctionClassFactory(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    round = ViewCompat.PrepareContext(childAt) + t.getTopInset();
                } else {
            ...
            this.offsetToChildIndexOnLayout = -1;
            setTopAndBottomOffset(MathUtils.BuiltInFictitiousFunctionClassFactory(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T t) {
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.C.MyBillsEntityDataFactory());
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2((View) coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.getCallingPid.MyBillsEntityDataFactory());
            View findFirstScrollingChild = findFirstScrollingChild(coordinatorLayout);
            if (findFirstScrollingChild == null || t.getTotalScrollRange() == 0 || !(((CoordinatorLayout.LayoutParams) findFirstScrollingChild.getLayoutParams()).lookAheadTest instanceof ScrollingViewBehavior)) {
                return;
            }
        ...
        private void addAccessibilityScrollActions(final CoordinatorLayout coordinatorLayout, final T t, final View view) {
            if (getTopBottomOffsetForScrollingSibling() != (-t.getTotalScrollRange()) && view.canScrollVertically(1)) {
                addActionToExpand(coordinatorLayout, t, AccessibilityNodeInfoCompat.AccessibilityActionCompat.C, false);
            }
            if (getTopBottomOffsetForScrollingSibling() != 0) {
                if (view.canScrollVertically(-1)) {
                    final int i = -t.getDownNestedPreScrollRange();
                    if (i != 0) {
                        ViewCompat.PlaceComponentResult(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.getCallingPid, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.2
                            /* JADX WARN: Multi-variable type inference failed */
                ...
                addActionToExpand(coordinatorLayout, t, AccessibilityNodeInfoCompat.AccessibilityActionCompat.getCallingPid, true);
            }
        }
        ...
        private void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
            ViewCompat.PlaceComponentResult(coordinatorLayout, accessibilityActionCompat, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.3
                @Override // androidx.core.view.accessibility.AccessibilityViewCommand
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 != 0 && topBottomOffsetForScrollingSibling >= i2 && topBottomOffsetForScrollingSibling <= i3) {
                int BuiltInFictitiousFunctionClassFactory = MathUtils.BuiltInFictitiousFunctionClassFactory(i, i2, i3);
                if (topBottomOffsetForScrollingSibling != BuiltInFictitiousFunctionClassFactory) {
                    int interpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, BuiltInFictitiousFunctionClassFactory) : BuiltInFictitiousFunctionClassFactory;
                    boolean topAndBottomOffset = setTopAndBottomOffset(interpolateOffset);
                    i4 = topBottomOffsetForScrollingSibling - BuiltInFictitiousFunctionClassFactory;
                    this.offsetDelta = BuiltInFictitiousFunctionClassFactory - interpolateOffset;
                    if (!topAndBottomOffset && t.hasChildWithInterpolator()) {
                        coordinatorLayout.dispatchDependentViewsChanged(t);
                    }
                    t.onOffsetChanged(getTopAndBottomOffset());
                    updateAppBarLayoutDrawableState(coordinatorLayout, t, BuiltInFictitiousFunctionClassFactory, BuiltInFictitiousFunctionClassFactory < topBottomOffsetForScrollingSibling ? -1 : 1, false);
                }
            } else {
                this.offsetDelta = 0;
            }
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                boolean z2 = false;
                if ((scrollFlags & 1) != 0) {
                    int PrepareContext = ViewCompat.PrepareContext(appBarChildOnOffset);
                    if (i2 <= 0 || (scrollFlags & 12) == 0 ? !((scrollFlags & 2) == 0 || (-i) < (appBarChildOnOffset.getBottom() - PrepareContext) - t.getTopInset()) : (-i) >= (appBarChildOnOffset.getBottom() - PrepareContext) - t.getTopInset()) {
                        z2 = true;
                    }
                }
                if (t.isLiftOnScroll()) {
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < size; i++) {
                CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) dependents.get(i).getLayoutParams()).lookAheadTest;
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.firstVisibleChildAtMinimumHeight = bottom == ViewCompat.PrepareContext(childAt) + t.getTopInset();
    ...
    */
    public static android.graphics.drawable.Drawable __fsTypeCheck_9006fe4ec1394eae9d20ad9ddd1cb05d(android.content.res.TypedArray r10, int r11) {
        /*
            byte[] r0 = com.google.android.material.appbar.AppBarLayout.getAuthRequestContext
            r1 = 23
            byte[] r1 = new byte[r1]
            r2 = 0
            r3 = 4
        ...
        L44:
            ...
            goto L1b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.appbar.AppBarLayout.__fsTypeCheck_9006fe4ec1394eae9d20ad9ddd1cb05d(android.content.res.TypedArray, int):android.graphics.drawable.Drawable");
    }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(View view, View view2) {
            CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) view2.getLayoutParams()).lookAheadTest;
            if (behavior instanceof BaseBehavior) {
                int bottom = view2.getBottom();
                int top = view.getTop();
                int i = ((BaseBehavior) behavior).offsetDelta;
                ViewCompat.BuiltInFictitiousFunctionClassFactory(view, (((bottom - top) + i) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
        ...
        private static int getAppBarLayoutOffset(AppBarLayout appBarLayout) {
            CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) appBarLayout.getLayoutParams()).lookAheadTest;
            if (behavior instanceof BaseBehavior) {
