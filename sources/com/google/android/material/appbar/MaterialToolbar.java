    ...
    */
    ...
    private void initBackground(Context context) {
        ...
        if (background == null || (background instanceof ColorDrawable)) {
            ...
            materialShapeDrawable.setElevation(ViewCompat.getErrorConfigVersion(this));
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, materialShapeDrawable);
        }
    }
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        DrawableCompat.MyBillsEntityDataFactory(scheduleImpl, this.navigationIconTint.intValue());
        return scheduleImpl;
    }
}
