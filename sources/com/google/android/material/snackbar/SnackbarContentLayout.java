    ...
    */
    ...
    private static void updateTopBottomPadding(View view, int i, int i2) {
        if (ViewCompat.D(view)) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory(view, ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(view), i, ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(view), i2);
        } else {
