...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public BaseTransientBottomBar(Context context, ViewGroup viewGroup, View view, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.3
            ...
            public void run() {
                ...
                if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                    InstrumentInjector.log_w(BaseTransientBottomBar.TAG, "Unable to apply gesture inset because layout params are not MarginLayoutParams");
                    return;
                }
        ...
        ViewCompat.lookAheadTest(snackbarBaseLayout, 1);
        ViewCompat.moveToNextValue((View) snackbarBaseLayout, 1);
        ViewCompat.MyBillsEntityDataFactory((View) snackbarBaseLayout, true);
        ViewCompat.MyBillsEntityDataFactory(snackbarBaseLayout, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.4
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat) {
                BaseTransientBottomBar.this.extraBottomMarginWindowInset = windowInsetsCompat.moveToNextValue();
                BaseTransientBottomBar.this.extraLeftMarginWindowInset = windowInsetsCompat.lookAheadTest();
                BaseTransientBottomBar.this.extraRightMarginWindowInset = windowInsetsCompat.getErrorConfigVersion();
                BaseTransientBottomBar.this.updateMargins();
                return windowInsetsCompat;
            }
        });
        ViewCompat.MyBillsEntityDataFactory(snackbarBaseLayout, new AccessibilityDelegateCompat() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.5
            @Override // androidx.core.view.AccessibilityDelegateCompat
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                super.onInitializeAccessibilityNodeInfo(view2, accessibilityNodeInfoCompat);
                accessibilityNodeInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(CrashCombineUtils.DEFAULT_MAX_INFO_LEN);
                accessibilityNodeInfoCompat.getErrorConfigVersion(true);
            }
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams) || (rect = this.originalMargins) == null) {
            InstrumentInjector.log_w(TAG, "Unable to update margins because layout params are not MarginLayoutParams");
            return;
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        return (layoutParams instanceof CoordinatorLayout.LayoutParams) && (((CoordinatorLayout.LayoutParams) layoutParams).lookAheadTest instanceof SwipeDismissBehavior);
    }
    ...
    final void showView() {
        ...
        if (ViewCompat.getValueOfTouchPositionAbsolute(this.view)) {
            showViewImpl();
        } else {
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams layoutParams) {
        ...
        layoutParams.MyBillsEntityDataFactory(swipeDismissBehavior);
        if (this.anchorView == null) {
            layoutParams.MyBillsEntityDataFactory = 80;
        }
    }
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory((View) this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.16
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.BuiltInFictitiousFunctionClassFactory((View) BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.MyBillsEntityDataFactory(this, obtainStyledAttributes.getDimensionPixelSize(R.styleable.SnackbarLayout_elevation, 0));
            }
            ...
            if (getBackground() == null) {
                ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, createThemedBackground());
            }
        }
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (drawable != null && this.backgroundTint != null) {
                ...
                DrawableCompat.PlaceComponentResult(drawable, this.backgroundTint);
                DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                Drawable scheduleImpl = DrawableCompat.scheduleImpl(getBackground().mutate());
                DrawableCompat.PlaceComponentResult(scheduleImpl, colorStateList);
                DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(scheduleImpl, this.backgroundTintMode);
                if (scheduleImpl != getBackground()) {
                    super.setBackgroundDrawable(scheduleImpl);
                }
            }
        }
        ...
        public void setBackgroundTintMode(PorterDuff.Mode mode) {
            ...
            if (getBackground() != null) {
                Drawable scheduleImpl = DrawableCompat.scheduleImpl(getBackground().mutate());
                DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(scheduleImpl, mode);
                if (scheduleImpl != getBackground()) {
                    super.setBackgroundDrawable(scheduleImpl);
                }
            }
        ...
        private Drawable createThemedBackground() {
            ...
            if (this.backgroundTint != null) {
                ...
                DrawableCompat.PlaceComponentResult(scheduleImpl, this.backgroundTint);
                return scheduleImpl;
            }
            return DrawableCompat.scheduleImpl(gradientDrawable);
        }
    }
