    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            float r0 = androidx.core.view.ViewCompat.getErrorConfigVersion(r7)
            r6.setElevation(r0)
        ...
        L8e:
            ...
            r7.setMinHeight(r8)
        La2:
            int r8 = androidx.core.view.ViewCompat.initRecordTimeStamp(r7)
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).MyBillsEntityDataFactory(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.PlaceComponentResult(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, false, isChecked()));
        }
    }

    private void updateAccessibilityDelegate() {
        if (hasCloseIcon() && isCloseIconVisible() && this.onCloseIconClickListener != null) {
            ViewCompat.MyBillsEntityDataFactory(this, this.touchHelper);
        } else {
            ViewCompat.MyBillsEntityDataFactory(this, (AccessibilityDelegateCompat) null);
        }
    }
    ...
    private void updatePaddingInternal() {
        ...
        ViewCompat.BuiltInFictitiousFunctionClassFactory(this, chipStartPadding, getPaddingTop(), chipEndPadding, getPaddingBottom());
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, ZebraData.ATTR_BACKGROUND) != null) {
            InstrumentInjector.log_w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
        ...
        if (attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "gravity", 8388627) != 8388627) {
            InstrumentInjector.log_w(TAG, "Chip text must be vertically center and start aligned");
        }
    }
    ...
    private void updateBackgroundDrawable() {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, getBackgroundDrawable());
        updatePaddingInternal();
    ...
    private void updateFrameworkRippleBackground() {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, this.ripple);
        updatePaddingInternal();
    }
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        InstrumentInjector.log_w(TAG, "Do not set the background tint list; Chip manages its own background drawable.");
    }

    @Override // android.view.View
    public void setBackgroundTintMode(PorterDuff.Mode mode) {
        InstrumentInjector.log_w(TAG, "Do not set the background tint mode; Chip manages its own background drawable.");
    }

    @Override // android.view.View
    public void setBackgroundColor(int i) {
        InstrumentInjector.log_w(TAG, "Do not set the background color; Chip manages its own background drawable.");
    }

    @Override // androidx.appcompat.widget.AppCompatCheckBox, android.view.View
    public void setBackgroundResource(int i) {
        InstrumentInjector.log_w(TAG, "Do not set the background resource; Chip manages its own background drawable.");
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable != getBackgroundDrawable() && drawable != this.ripple) {
            InstrumentInjector.log_w(TAG, "Do not set the background drawable; Chip manages its own background drawable.");
        } else {
    ...
    private boolean handleAccessibilityExit(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 10) {
            try {
                ...
                InstrumentInjector.log_e(TAG, "Unable to send Accessibility Exit event", e);
            } catch (NoSuchFieldException e2) {
                InstrumentInjector.log_e(TAG, "Unable to send Accessibility Exit event", e2);
            } catch (NoSuchMethodException e3) {
                InstrumentInjector.log_e(TAG, "Unable to send Accessibility Exit event", e3);
            } catch (InvocationTargetException e4) {
                InstrumentInjector.log_e(TAG, "Unable to send Accessibility Exit event", e4);
            }
        }
        return false;
    }
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    accessibilityNodeInfoCompat.PlaceComponentResult(closeIconContentDescription);
                } else {
                    ...
                    accessibilityNodeInfoCompat.PlaceComponentResult((CharSequence) context.getString(i2, objArr).trim());
                }
                accessibilityNodeInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(Chip.this.getCloseIconTouchBoundsInt());
                accessibilityNodeInfoCompat.PlaceComponentResult(AccessibilityNodeInfoCompat.AccessibilityActionCompat.BuiltInFictitiousFunctionClassFactory);
                accessibilityNodeInfoCompat.moveToNextValue(Chip.this.isEnabled());
                return;
            }
            accessibilityNodeInfoCompat.PlaceComponentResult("");
            accessibilityNodeInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(Chip.EMPTY_BOUNDS);
        }

        @Override // androidx.customview.widget.ExploreByTouchHelper
        public void onPopulateNodeForHost(AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            accessibilityNodeInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(Chip.this.isCheckable());
            accessibilityNodeInfoCompat.PlaceComponentResult(Chip.this.isClickable());
            if (Chip.this.isCheckable() || Chip.this.isClickable()) {
                accessibilityNodeInfoCompat.BuiltInFictitiousFunctionClassFactory(Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME);
            } else {
                accessibilityNodeInfoCompat.BuiltInFictitiousFunctionClassFactory(Chip.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME);
            }
            CharSequence text = Chip.this.getText();
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityNodeInfoCompat.getErrorConfigVersion(text);
            } else {
                accessibilityNodeInfoCompat.PlaceComponentResult(text);
            }
        }
