...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate, FSDraw {
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.MyBillsEntityDataFactory(-16777216, 127));
            ...
            this.debugPaint.setColor(ColorUtils.MyBillsEntityDataFactory(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.MyBillsEntityDataFactory(-16711936, 127));
    ...
    private void calculateChipIconBounds(Rect rect, RectF rectF) {
        ...
        if (showsChipIcon() || showsCheckedIcon()) {
            ...
            if (DrawableCompat.PlaceComponentResult(this) == 0) {
    ...
    */
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.getAuthRequestContext(this.chipIcon, i);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.getAuthRequestContext(this.checkedIcon, i);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.getAuthRequestContext(this.closeIcon, i);
        }
    ...
    private void applyChildDrawable(Drawable drawable) {
        ...
        if (drawable == this.closeIcon) {
            ...
            DrawableCompat.PlaceComponentResult(drawable, this.closeIconTint);
            return;
        }
        if (drawable.isStateful()) {
        ...
        if (drawable == drawable2 && this.hasChipIconTint) {
            DrawableCompat.PlaceComponentResult(drawable2, this.chipIconTint);
        }
    }
    ...
    public void setChipBackgroundColorResource(int i) {
        setChipBackgroundColor(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public void setChipStrokeColorResource(int i) {
        setChipStrokeColor(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public void setRippleColorResource(int i) {
        setRippleColor(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public Drawable getChipIcon() {
        ...
        if (drawable != null) {
            return DrawableCompat.getErrorConfigVersion(drawable);
        }
        return null;
    }
    ...
    public void setChipIconResource(int i) {
        ...
        BuiltInFictitiousFunctionClassFactory = ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(this.context, i);
        setChipIcon(BuiltInFictitiousFunctionClassFactory);
    }
    ...
    public void setChipIcon(Drawable drawable) {
        ...
        if (chipIcon != drawable) {
            float calculateChipIconWidth = calculateChipIconWidth();
            this.chipIcon = drawable != null ? DrawableCompat.scheduleImpl(drawable).mutate() : null;
    ...
    public void setChipIconTintResource(int i) {
        setChipIconTint(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public void setChipIconTint(ColorStateList colorStateList) {
        ...
        if (this.chipIconTint != colorStateList) {
            ...
            if (showsChipIcon()) {
                DrawableCompat.PlaceComponentResult(this.chipIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconResource(int i) {
        Drawable BuiltInFictitiousFunctionClassFactory;
        BuiltInFictitiousFunctionClassFactory = ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(this.context, i);
        setCloseIcon(BuiltInFictitiousFunctionClassFactory);
    }
    ...
    public void setCloseIcon(Drawable drawable) {
        ...
        if (closeIcon != drawable) {
            ...
            this.closeIcon = drawable != null ? DrawableCompat.scheduleImpl(drawable).mutate() : null;
            if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
    ...
    public void setCloseIconTintResource(int i) {
        setCloseIconTint(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public void setCloseIconTint(ColorStateList colorStateList) {
        if (this.closeIconTint != colorStateList) {
            ...
            if (showsCloseIcon()) {
                DrawableCompat.PlaceComponentResult(this.closeIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconContentDescription(CharSequence charSequence) {
        if (this.closeIconContentDescription != charSequence) {
            BidiFormatter MyBillsEntityDataFactory = BidiFormatter.MyBillsEntityDataFactory();
            this.closeIconContentDescription = MyBillsEntityDataFactory.MyBillsEntityDataFactory(charSequence, MyBillsEntityDataFactory.MyBillsEntityDataFactory);
            invalidateSelf();
        }
    }
    ...
    public void setCheckedIconResource(int i) {
        Drawable BuiltInFictitiousFunctionClassFactory;
        BuiltInFictitiousFunctionClassFactory = ResourceManagerInternal.KClassImpl$Data$declaredNonStaticMembers$2().BuiltInFictitiousFunctionClassFactory(this.context, i);
        setCheckedIcon(BuiltInFictitiousFunctionClassFactory);
    }
    ...
    public void setCheckedIconTintResource(int i) {
        setCheckedIconTint(AppCompatResources.getAuthRequestContext(this.context, i));
    }
    ...
    public void setCheckedIconTint(ColorStateList colorStateList) {
        if (this.checkedIconTint != colorStateList) {
            ...
            if (canShowCheckedIcon()) {
                DrawableCompat.PlaceComponentResult(this.checkedIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
