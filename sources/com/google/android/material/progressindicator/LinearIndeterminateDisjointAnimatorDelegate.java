...
public final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {533, 567, 850, Config.WIDTH};
    ...
    public LinearIndeterminateDisjointAnimatorDelegate(Context context, LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        ...
        this.interpolatorArray = new Interpolator[]{AnimationUtilsCompat.getAuthRequestContext(context, R.animator.linear_indeterminate_line1_head_interpolator), AnimationUtilsCompat.getAuthRequestContext(context, R.animator.linear_indeterminate_line1_tail_interpolator), AnimationUtilsCompat.getAuthRequestContext(context, R.animator.linear_indeterminate_line2_head_interpolator), AnimationUtilsCompat.getAuthRequestContext(context, R.animator.linear_indeterminate_line2_tail_interpolator)};
    }
    ...
    @Override // com.google.android.material.progressindicator.IndeterminateAnimatorDelegate
    public final void registerAnimatorsCompleteCallback(Animatable2Compat.AnimationCallback animationCallback) {
