...
public class MaterialColors {
    ...
    public static int layer(int i, int i2, float f) {
        return layer(i, ColorUtils.MyBillsEntityDataFactory(i2, Math.round(Color.alpha(i2) * f)));
    }

    public static int layer(int i, int i2) {
        return ColorUtils.BuiltInFictitiousFunctionClassFactory(i2, i);
    }

    public static int compositeARGBWithAlpha(int i, int i2) {
        return ColorUtils.MyBillsEntityDataFactory(i, (Color.alpha(i) * i2) / 255);
    }

    public static boolean isColorLight(int i) {
        return i != 0 && ColorUtils.MyBillsEntityDataFactory(i) > 0.5d;
    }
}
