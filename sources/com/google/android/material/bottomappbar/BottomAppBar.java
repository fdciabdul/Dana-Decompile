    ...
    */
    public BottomAppBar(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            float r0 = (float) r2
            r10.setElevation(r0)
            androidx.core.graphics.drawable.DrawableCompat.PlaceComponentResult(r11, r1)
            androidx.core.view.ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(r10, r11)
    ...
    public void setBackgroundTint(ColorStateList colorStateList) {
        DrawableCompat.PlaceComponentResult(this.materialShapeDrawable, colorStateList);
    }
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !ViewCompat.getValueOfTouchPositionAbsolute(this)) {
            return;
        }
    ...
    protected int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int i, boolean z) {
        if (i == 1 && z) {
            ...
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                ...
                if ((childAt.getLayoutParams() instanceof Toolbar.LayoutParams) && (((Toolbar.LayoutParams) childAt.getLayoutParams()).BuiltInFictitiousFunctionClassFactory & 8388615) == 8388611) {
                    if (isLayoutRtl) {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            if (findDependentView != null && !ViewCompat.getValueOfTouchPositionAbsolute(findDependentView)) {
                CoordinatorLayout.LayoutParams layoutParams = (CoordinatorLayout.LayoutParams) findDependentView.getLayoutParams();
                layoutParams.BuiltInFictitiousFunctionClassFactory = 49;
