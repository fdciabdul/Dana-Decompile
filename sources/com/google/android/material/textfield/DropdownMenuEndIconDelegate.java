...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
        ...
        this.accessibilityDelegate = new TextInputLayout.AccessibilityDelegate(this.textInputLayout) { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (!DropdownMenuEndIconDelegate.isEditable(DropdownMenuEndIconDelegate.this.textInputLayout.getEditText())) {
                    accessibilityNodeInfoCompat.BuiltInFictitiousFunctionClassFactory(Spinner.class.getName());
                }
                if (accessibilityNodeInfoCompat.NetworkUserEntityData$$ExternalSyntheticLambda6()) {
                    accessibilityNodeInfoCompat.MyBillsEntityDataFactory((CharSequence) null);
                }
            }
        ...
        this.dropdownMenuOnEditTextAttachedListener = new TextInputLayout.OnEditTextAttachedListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.4
            ...
            public void onEditTextAttached(TextInputLayout textInputLayout2) {
                ...
                if (!DropdownMenuEndIconDelegate.isEditable(castAutoCompleteTextViewOrThrow)) {
                    ViewCompat.moveToNextValue((View) DropdownMenuEndIconDelegate.this.endIconView, 2);
                }
    ...
    public void initialize() {
        ...
        int i = IS_LOLLIPOP ? R.drawable.mtrl_dropdown_arrow : R.drawable.mtrl_ic_arrow_drop_down;
        ...
        textInputLayout.setEndIconDrawable(BuiltInFictitiousFunctionClassFactory);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(autoCompleteTextView, layerDrawable);
    }
    ...
    private void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        if (IS_LOLLIPOP) {
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(autoCompleteTextView, new RippleDrawable(new ColorStateList(iArr, iArr2), materialShapeDrawable, materialShapeDrawable));
            return;
        }
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        materialShapeDrawable2.setFillColor(new ColorStateList(iArr, iArr2));
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{materialShapeDrawable, materialShapeDrawable2});
        int NetworkUserEntityData$$ExternalSyntheticLambda4 = ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(autoCompleteTextView);
        int paddingTop = autoCompleteTextView.getPaddingTop();
        int NetworkUserEntityData$$ExternalSyntheticLambda6 = ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(autoCompleteTextView);
        int paddingBottom = autoCompleteTextView.getPaddingBottom();
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(autoCompleteTextView, layerDrawable);
        ViewCompat.BuiltInFictitiousFunctionClassFactory(autoCompleteTextView, NetworkUserEntityData$$ExternalSyntheticLambda4, paddingTop, NetworkUserEntityData$$ExternalSyntheticLambda6, paddingBottom);
    }
