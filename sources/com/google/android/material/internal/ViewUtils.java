...
public class ViewUtils {
    ...
    public static class RelativePadding {
        ...
        public void applyToView(View view) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory(view, this.start, this.top, this.end, this.bottom);
        }
    }
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attributeSet, int i, int i2, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        ...
        doOnApplyWindowInsets(view, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.internal.ViewUtils.2
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat, RelativePadding relativePadding) {
                if (z) {
                ...
                if (z2) {
                    if (isLayoutRtl) {
                        relativePadding.end += windowInsetsCompat.lookAheadTest();
                    } else {
                        relativePadding.start += windowInsetsCompat.lookAheadTest();
                    }
                }
                if (z3) {
                    if (isLayoutRtl) {
                        relativePadding.start += windowInsetsCompat.getErrorConfigVersion();
                    } else {
                        relativePadding.end += windowInsetsCompat.getErrorConfigVersion();
                    }
                }
    ...
    public static void doOnApplyWindowInsets(View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        final RelativePadding relativePadding = new RelativePadding(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(view), view.getPaddingTop(), ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(view), view.getPaddingBottom());
        ViewCompat.MyBillsEntityDataFactory(view, new androidx.core.view.OnApplyWindowInsetsListener() { // from class: com.google.android.material.internal.ViewUtils.3
    ...
    public static float getParentAbsoluteElevation(View view) {
        ...
        for (ViewParent parent = view.getParent(); parent instanceof View; parent = parent.getParent()) {
            f += ViewCompat.getErrorConfigVersion((View) parent);
        }
        return f;
    }
