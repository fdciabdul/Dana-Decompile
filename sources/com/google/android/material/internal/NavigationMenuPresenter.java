...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void dispatchApplyWindowInsets(WindowInsetsCompat windowInsetsCompat) {
        ...
        if (this.paddingTopDefault != initRecordTimeStamp) {
            this.paddingTopDefault = initRecordTimeStamp;
            updateTopPadding();
        }
        NavigationMenuView navigationMenuView = this.menuView;
        navigationMenuView.setPadding(0, navigationMenuView.getPaddingTop(), 0, windowInsetsCompat.moveToNextValue());
        ViewCompat.PlaceComponentResult(this.headerLayout, windowInsetsCompat);
    }
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(navigationMenuItemView, NavigationMenuPresenter.this.itemBackground != null ? NavigationMenuPresenter.this.itemBackground.getConstantState().newDrawable() : null);
        ...
        private void prepareMenuItems() {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (menuItemImpl.isCheckable()) {
                    menuItemImpl.MyBillsEntityDataFactory = (menuItemImpl.MyBillsEntityDataFactory & (-5)) | 0;
                }
                        ...
                        for (int i4 = 0; i4 < size3; i4++) {
                            ...
                            if (menuItemImpl2.isVisible()) {
                                ...
                                if (menuItemImpl2.isCheckable()) {
                                    menuItemImpl2.MyBillsEntityDataFactory = (menuItemImpl2.MyBillsEntityDataFactory & (-5)) | 0;
                                }
                                if (menuItemImpl.isChecked()) {
                                    setCheckedItem(menuItemImpl);
                                }
        ...
        int getRowCount() {
            ...
            for (int i2 = 0; i2 < NavigationMenuPresenter.this.adapter.getPlaceComponentResult(); i2++) {
    ...
    public class NavigationMenuViewAccessibilityDelegate extends RecyclerViewAccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.getAuthRequestContext(NavigationMenuPresenter.this.adapter.getRowCount(), 0, false));
        }
    }
}
