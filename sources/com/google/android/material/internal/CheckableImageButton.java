...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.checkable = true;
        this.pressable = true;
        ViewCompat.MyBillsEntityDataFactory(this, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(CheckableImageButton.this.isCheckable());
                accessibilityNodeInfoCompat.MyBillsEntityDataFactory(CheckableImageButton.this.isChecked());
            }
        });
    }
