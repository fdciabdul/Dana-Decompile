...
public class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup implements FSDispatchDraw {
        ...
        public boolean drawChild(Canvas canvas, View view, long j) {
            return fsSuperDrawChild_1af4ec08c3c501c2acb9d15835da1697(canvas, view, j);
        }

        public void fsSuperDispatchDraw_1af4ec08c3c501c2acb9d15835da1697(Canvas canvas) {
        ...
        public boolean fsSuperDrawChild_1af4ec08c3c501c2acb9d15835da1697(Canvas canvas, View view, long j) {
        ...
        public void add(View view) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (viewGroup != this.hostView && viewGroup.getParent() != null && ViewCompat.C(viewGroup)) {
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            fsSuperDispatchDraw_1af4ec08c3c501c2acb9d15835da1697(canvas);
            ArrayList<Drawable> arrayList = this.drawables;
