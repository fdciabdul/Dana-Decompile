...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        return (MotionSpec) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.defaultMotionSpec);
    }
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(H5MapRenderOptimizer.KEY_SCALE)) {
            arrayList.add(motionSpec.getAnimator(H5MapRenderOptimizer.KEY_SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(H5MapRenderOptimizer.KEY_SCALE, this.fab, View.SCALE_X));
        }
        if (motionSpec.hasPropertyValues(ZebraData.ATTR_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(ZebraData.ATTR_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(ZebraData.ATTR_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(ZebraData.ATTR_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
