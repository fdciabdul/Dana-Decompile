...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, ZebraData.ATTR_WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, ZebraData.ATTR_HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.5
        @Override // android.util.Property
        public final void set(View view, Float f) {
    ...
    static final Property<View, Float> PADDING_START = new Property<View, Float>(Float.class, "paddingStart") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
        @Override // android.util.Property
        public final void set(View view, Float f) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory(view, f.intValue(), view.getPaddingTop(), ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(view), view.getPaddingBottom());
        }

        @Override // android.util.Property
        public final Float get(View view) {
            return Float.valueOf(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(view));
        }
    };
    static final Property<View, Float> PADDING_END = new Property<View, Float>(Float.class, "paddingEnd") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        @Override // android.util.Property
        public final void set(View view, Float f) {
            ViewCompat.BuiltInFictitiousFunctionClassFactory(view, ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(view), view.getPaddingTop(), f.intValue(), view.getPaddingBottom());
        }

        @Override // android.util.Property
        public final Float get(View view) {
            return Float.valueOf(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(view));
        }
    };
    ...
    */
    public ExtendedFloatingActionButton(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            r0.collapsedSize = r6
            int r6 = androidx.core.view.ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(r16)
            r0.extendedPaddingStart = r6
            int r6 = androidx.core.view.ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(r16)
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        ...
        this.extendedPaddingStart = ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(this);
        this.extendedPaddingEnd = ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(this);
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return (ViewCompat.getValueOfTouchPositionAbsolute(this) || (!isOrWillBeShown() && this.animateShowBeforeLayout)) && !isInEditMode();
    }

    int getCollapsedSize() {
        int i = this.collapsedSize;
        return i < 0 ? (Math.min(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(this), ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(this)) * 2) + getIconSize() : i;
    }
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public void onAttachedToLayoutParams(CoordinatorLayout.LayoutParams layoutParams) {
            if (layoutParams.getAuthRequestContext == 0) {
                layoutParams.getAuthRequestContext = 80;
            }
        }
        ...
        private static boolean isBottomSheet(View view) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                return ((CoordinatorLayout.LayoutParams) layoutParams).lookAheadTest instanceof BottomSheetBehavior;
            }
            return false;
        }
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.LayoutParams) extendedFloatingActionButton.getLayoutParams()).NetworkUserEntityData$$ExternalSyntheticLambda0 == view.getId();
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public void performNow() {
            ...
            ViewCompat.BuiltInFictitiousFunctionClassFactory(ExtendedFloatingActionButton.this, this.size.getPaddingStart(), ExtendedFloatingActionButton.this.getPaddingTop(), this.size.getPaddingEnd(), ExtendedFloatingActionButton.this.getPaddingBottom());
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(ZebraData.ATTR_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(ZebraData.ATTR_WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(ZebraData.ATTR_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(ZebraData.ATTR_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(ZebraData.ATTR_HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(ZebraData.ATTR_HEIGHT, propertyValues2);
            }
            if (currentMotionSpec.hasPropertyValues("paddingStart")) {
                PropertyValuesHolder[] propertyValues3 = currentMotionSpec.getPropertyValues("paddingStart");
                propertyValues3[0].setFloatValues(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda4(ExtendedFloatingActionButton.this), this.size.getPaddingStart());
                currentMotionSpec.setPropertyValues("paddingStart", propertyValues3);
            }
            if (currentMotionSpec.hasPropertyValues("paddingEnd")) {
                PropertyValuesHolder[] propertyValues4 = currentMotionSpec.getPropertyValues("paddingEnd");
                propertyValues4[0].setFloatValues(ViewCompat.NetworkUserEntityData$$ExternalSyntheticLambda6(ExtendedFloatingActionButton.this), this.size.getPaddingEnd());
