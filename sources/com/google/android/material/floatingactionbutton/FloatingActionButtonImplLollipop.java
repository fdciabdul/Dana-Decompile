...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            drawable = new LayerDrawable(new Drawable[]{(Drawable) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.borderDrawable), (Drawable) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.shapeDrawable)});
        } else {
    ...
    BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.shapeAppearance));
        borderDrawable.setGradientColors(ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_stroke_top_outer_color), ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_stroke_top_inner_color), ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_stroke_end_inner_color), ContextCompat.BuiltInFictitiousFunctionClassFactory(context, R.color.design_fab_stroke_end_outer_color));
    ...
    MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.shapeAppearance));
    }
