...
public class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.KClassImpl$Data$declaredNonStaticMembers$2(this, createBackground());
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (view.getId() == -1) {
            view.setId(ViewCompat.MyBillsEntityDataFactory());
        }
    ...
    protected void updateLayoutParams() {
        ...
        constraintSet.getAuthRequestContext(this);
        float f = 0.0f;
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getId() != R.id.circle_center && !shouldSkipView(childAt)) {
                ...
                int i5 = this.radius;
                ConstraintSet.Constraint KClassImpl$Data$declaredNonStaticMembers$2 = constraintSet.KClassImpl$Data$declaredNonStaticMembers$2(id2);
                KClassImpl$Data$declaredNonStaticMembers$2.BuiltInFictitiousFunctionClassFactory.NetworkUserEntityData$$ExternalSyntheticLambda0 = i4;
                KClassImpl$Data$declaredNonStaticMembers$2.BuiltInFictitiousFunctionClassFactory.moveToNextValue = i5;
                KClassImpl$Data$declaredNonStaticMembers$2.BuiltInFictitiousFunctionClassFactory.getErrorConfigVersion = f;
