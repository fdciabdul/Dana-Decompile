...
public class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        int defaultColor = AppCompatResources.getAuthRequestContext(context, R.color.material_timepicker_clockface).getDefaultColor();
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() { // from class: com.google.android.material.timepicker.ClockFaceView.2
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (intValue > 0) {
                    accessibilityNodeInfoCompat.MyBillsEntityDataFactory((View) ClockFaceView.this.textViewPool.get(intValue - 1));
                }
                accessibilityNodeInfoCompat.MyBillsEntityDataFactory(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.PlaceComponentResult(0, 1, intValue, 1, false, view.isSelected()));
            }
        };
    ...
    private void updateTextViews(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, size); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                ViewCompat.MyBillsEntityDataFactory(textView, this.valueAccessibilityDelegate);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.MyBillsEntityDataFactory(accessibilityNodeInfo).PlaceComponentResult(AccessibilityNodeInfoCompat.CollectionInfoCompat.KClassImpl$Data$declaredNonStaticMembers$2(1, this.values.length, false, 1));
    }
