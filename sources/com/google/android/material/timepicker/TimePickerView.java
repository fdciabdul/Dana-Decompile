...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public void setMinuteHourDelegate(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ViewCompat.MyBillsEntityDataFactory(this.hourView, accessibilityDelegateCompat);
    }

    public void setHourClickDelegate(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ViewCompat.MyBillsEntityDataFactory(this.minuteView, accessibilityDelegateCompat);
    }
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.MyBillsEntityDataFactory(R.id.material_clock_display, ViewCompat.initRecordTimeStamp(this) == 0 ? 2 : 1);
