...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, SecExceptionCode.SEC_ERROR_STA_INCORRECT_DATA_FILE, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, DeepRecoverARiverProxy.TYPE_ENTITY_PLUGIN, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 168, 162, 138, 42};
    ...
    public final Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (true) {
            ...
            if (patternToChar == '*') {
                ...
                float f = i;
                return new Result(obj, null, new ResultPoint[]{new ResultPoint((r2[1] + r2[0]) / 2.0f, f), new ResultPoint(nextSet + (i4 / 2.0f), f)}, BarcodeFormat.CODE_39);
            }
            nextSet = nextSet2;
        }
    }
                ...
                if (charAt != '$') {
                    if (charAt != '%') {
                        if (charAt != '+') {
                            ...
                            i = charAt2 + InputCardNumberView.DIVIDER;
                        }
