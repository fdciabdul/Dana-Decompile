...
public final class Detector {
    ...
    private static int getRotation(int[] iArr, int i) throws NotFoundException {
        ...
        for (int i4 = 0; i4 < 4; i4++) {
            if (Integer.bitCount(EXPECTED_CORNER_BITS[i4] ^ (((i2 & 1) << 11) + (i2 >> 1))) <= 2) {
                return i4;
            }
        }
        throw NotFoundException.getNotFoundInstance();
    ...
    private Point getMatrixCenter() {
        ...
        try {
            ...
            int i4 = width - 7;
            ResultPoint resultPoint10 = getFirstDifferent(new Point(i4, i3), false, -1, 1).toResultPoint();
            resultPoint2 = getFirstDifferent(new Point(i4, i2), false, -1, -1).toResultPoint();
            resultPoint3 = resultPoint10;
            resultPoint4 = resultPoint9;
        }
        int round = MathUtils.round((((resultPoint4.getX() + resultPoint2.getX()) + resultPoint.getX()) + resultPoint3.getX()) / 4.0f);
        int round2 = MathUtils.round((((resultPoint4.getY() + resultPoint2.getY()) + resultPoint.getY()) + resultPoint3.getY()) / 4.0f);
        try {
            ...
            ResultPoint resultPoint12 = getFirstDifferent(new Point(i8, i6), false, -1, -1).toResultPoint();
