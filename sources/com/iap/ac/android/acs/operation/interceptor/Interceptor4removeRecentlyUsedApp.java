...
public class Interceptor4removeRecentlyUsedApp extends BaseInterceptor {
    ...
    public void handle(IAPConnectPluginContext iAPConnectPluginContext, final IAPConnectPluginCallback iAPConnectPluginCallback) {
        if (!NetworkUtils.isNetworkAvailable(iAPConnectPluginContext.getContext().getApplicationContext())) {
            ACLog.e("IAPConnectPlugin", "Interceptor4removeRecentlyUsedApp network error");
        ...
        if (jSONObject == null) {
            ACLog.e("IAPConnectPlugin", "Interceptor4removeRecentlyUsedApp#handle, jsParameters is null");
            ErrorCodeConvertUtil.callback2Failure(10102, "Parameters is invalid", iAPConnectPluginCallback);
            return;
        }
        final String optString = jSONObject.optString("appId");
        if (ParameterCheckUtil.stringInvalid(optString)) {
            ACLog.e("IAPConnectPlugin", "Interceptor4removeRecentlyUsedApp appId is null");
            ErrorCodeConvertUtil.callback2Failure(10102, "Parameters is invalid", iAPConnectPluginCallback);
            return;
        }
        IAPAsyncTask.asyncTask(new Runnable() { // from class: com.iap.ac.android.acs.operation.interceptor.Interceptor4removeRecentlyUsedApp.1
            @Override // java.lang.Runnable
            public void run() {
                new RegionOperationProvider().removeRecentlyUsedApp(optString, new Callback<Bundle>() { // from class: com.iap.ac.android.acs.operation.interceptor.Interceptor4removeRecentlyUsedApp.1.1
                    @Override // com.iap.ac.android.common.container.callback.Callback
                    public void onResultFailed(int i, String str) {
                        StringBuilder sb = new StringBuilder();
                        sb.append("Interceptor4removeRecentlyUsedApp onResultFailed: error = ");
                        sb.append(i);
                    ...
                    public void onResultSuccess(Bundle bundle) {
                        ...
                        StringBuilder sb = new StringBuilder();
                        sb.append("Interceptor4removeRecentlyUsedApp onResultSuccess: ");
                        sb.append(string);
                        ACLog.e("IAPConnectPlugin", sb.toString());
