...
import com.iap.ac.android.acs.operation.downgrade.amcs.JSAPIModeManager;
import com.iap.ac.android.acs.operation.downgrade.resource.JSAPIModeResourceManager;
import com.iap.ac.android.acs.operation.utils.DeviceUtils;
...
public class JSAPIRegisterUtils {
    ...
    public static void parseAssetConfig(Context context, String str, final JSAPIConfigCallback<JSAPIRegisterBean> jSAPIConfigCallback) {
        ...
        jSAPIModeResourceManager.loadConfigFromAsset(context, str, new JSAPIReadAssetCallback() { // from class: com.iap.ac.android.acs.operation.downgrade.jsapi.JSAPIRegisterUtils.1
            @Override // com.iap.ac.android.acs.operation.downgrade.jsapi.JSAPIReadAssetCallback
