...
import com.iap.ac.android.acs.operation.downgrade.jsapi.JSAPIReadAssetCallback;
...
public abstract class BaseConfigModel<T> {
    ...
    public void loadConfigFromAsset(final Context context, final String str, final JSAPIReadAssetCallback jSAPIReadAssetCallback) {
        IAPAsyncTask.asyncTask(new Runnable() { // from class: com.iap.ac.android.acs.operation.downgrade.resource.BaseConfigModel.1
