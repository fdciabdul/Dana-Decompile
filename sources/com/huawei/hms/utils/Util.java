...
public class Util {
    ...
    public static boolean isAvailableLibExist(Context context) {
            ...
            if (!availableInit) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ...
                        HMSLog.e(TAG, "In isAvailableLibExist, Failed to find class AvailableAdapter.");
                    }
        ...
        sb.append("available exist: ");
        sb.append(isAvailableAvailable);
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("Trying to unbind service from ");
            sb.append(serviceConnection);
            HMSLog.i(TAG, sb.toString());
            context.unbindService(serviceConnection);
        } catch (Exception e) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("On unBindServiceException:");
