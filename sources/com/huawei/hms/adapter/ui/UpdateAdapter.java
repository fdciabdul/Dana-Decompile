...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    public WeakReference<Activity> f7456a;
    public int b;
    ...
    public final Activity b() {
        WeakReference<Activity> weakReference = this.f7456a;
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        this.f7456a = new WeakReference<>(activity);
        if (a.b.a(b())) {
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        ...
        sb.append("onBridgeActivityResult ");
        sb.append(i2);
        HMSLog.i("UpdateAdapter", sb.toString());
        if (i2 == -1) {
            if (intent != null) {
