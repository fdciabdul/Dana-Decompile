...
@DebugMetadata(c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2", f = "DocumentFileExt.kt", i = {}, l = {60}, m = "invokeSuspend", n = {}, s = {})
...
public final class DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Long>, Object> {
    ...
    @DebugMetadata(c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2$1", f = "DocumentFileExt.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                cancellableContinuation.resumeWith(Result.m3179constructorimpl(Boxing.boxLong(FileCallback.MyBillsEntityDataFactory(documentFile, this.$thread$inlined))));
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        DocumentFileUtils$copyFileTo$$inlined$awaitUiResult$2 documentFileUtils$copyFileTo$$inlined$awaitUiResult$2 = this;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(documentFileUtils$copyFileTo$$inlined$awaitUiResult$2), 1);
        cancellableContinuationImpl.initCancellability();
        BuildersKt__Builders_commonKt.launch$default(coroutineScope2, Dispatchers.getMain(), null, new AnonymousClass1(cancellableContinuationImpl, null, this.$callback$inlined, this.$this_copyFileTo$inlined, this.$thread$inlined), 2, null);
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(documentFileUtils$copyFileTo$$inlined$awaitUiResult$2);
        }
