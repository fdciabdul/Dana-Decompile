...
final class DocumentFileUtils$copyFolderTo$copy$1 extends Lambda implements Function2<DocumentFile, DocumentFile, Unit> {
    ...
    DocumentFileUtils$copyFolderTo$copy$1(Context context, FolderCallback folderCallback, Ref.IntRef intRef, boolean z, byte[] bArr, Ref.LongRef longRef, Ref.IntRef intRef2) {
        super(2);
    ...
    public final void invoke2(DocumentFile documentFile, DocumentFile documentFile2) {
        ...
        DocumentFileUtils.MyBillsEntityDataFactory(context, documentFile, documentFile2, folderCallback, new Function2<InputStream, OutputStream, Unit>() { // from class: com.anggrayudi.storage.file.DocumentFileUtils$copyFolderTo$copy$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
