...
@DebugMetadata(c = "com.anggrayudi.storage.media.MediaFile$moveTo$$inlined$awaitUiResult$1", f = "MediaFile.kt", i = {}, l = {60}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes7.dex */
public final class MediaFile$moveTo$$inlined$awaitUiResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Long>, Object> {
    ...
    public MediaFile$moveTo$$inlined$awaitUiResult$1(CoroutineScope coroutineScope, Continuation continuation, FileCallback fileCallback, MediaFile mediaFile, Thread thread) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MediaFile$moveTo$$inlined$awaitUiResult$1(this.$uiScope, continuation, this.$callback$inlined, this.this$0, this.$thread$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Long> continuation) {
        return ((MediaFile$moveTo$$inlined$awaitUiResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    @DebugMetadata(c = "com.anggrayudi.storage.media.MediaFile$moveTo$$inlined$awaitUiResult$1$1", f = "MediaFile.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.anggrayudi.storage.media.MediaFile$moveTo$$inlined$awaitUiResult$1$1  reason: invalid class name */
    /* loaded from: classes7.dex */
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        MediaFile$moveTo$$inlined$awaitUiResult$1 mediaFile$moveTo$$inlined$awaitUiResult$1 = this;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(mediaFile$moveTo$$inlined$awaitUiResult$1), 1);
        ...
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(mediaFile$moveTo$$inlined$awaitUiResult$1);
        }
