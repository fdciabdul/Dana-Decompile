...
public final class FactorAPIClient$verify$1 extends Lambda implements Function1<Integer, Unit> {
    ...
    public FactorAPIClient$verify$1(FactorAPIClient factorAPIClient, Factor factor, String str, Function1 function1, Function1 function12) {
        super(1);
    ...
    public static /* synthetic */ void invoke$default(FactorAPIClient$verify$1 factorAPIClient$verify$1, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 1;
        }
        factorAPIClient$verify$1.invoke(i);
    }
    ...
    public final void invoke(final int i) {
        ...
        try {
            ...
            Request.Builder builder = new Request.Builder(new RequestHelper(context, new BasicAuthorization("token", MyBillsEntityDataFactory)), FactorAPIClient.getAuthRequestContext(this.this$0, this.$$factor), null, null, null, null, null, 124, null);
            HttpMethod httpMethod = HttpMethod.Post;
            Intrinsics.checkParameterIsNotNull(httpMethod, "");
            Request.Builder builder2 = builder;
            builder.getAuthRequestContext = httpMethod;
            mapOf = MapsKt.mapOf(TuplesKt.to("AuthPayload", this.$$authPayload));
            Intrinsics.checkParameterIsNotNull(mapOf, "");
            Request.Builder builder3 = builder;
            builder.KClassImpl$Data$declaredNonStaticMembers$2 = mapOf;
            ...
            networkProvider.BuiltInFictitiousFunctionClassFactory(KClassImpl$Data$declaredNonStaticMembers$2, new Function1<Response, Unit>() { // from class: com.twilio.verify.api.FactorAPIClient$verify$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    FactorAPIClient$verify$1.this = this;
                }
                ...
                public final void invoke2(Response response) {
                    ...
                    FactorAPIClient$verify$1.this.$$success.invoke(new JSONObject(response.KClassImpl$Data$declaredNonStaticMembers$2));
                }
            }, new Function1<NetworkException, Unit>() { // from class: com.twilio.verify.api.FactorAPIClient$verify$1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                    FactorAPIClient$verify$1.this = this;
                ...
                /* renamed from: com.twilio.verify.api.FactorAPIClient$verify$1$2$1 */
                /* loaded from: classes3.dex */
                public static final /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<Integer, Unit> {
                    ...
                    public final void invoke(int i) {
                        FactorAPIClient$verify$1.this.invoke(i);
                    }
                }
                ...
                public final void invoke2(NetworkException networkException) {
                    ...
                    FactorAPIClient$verify$1.this.this$0.MyBillsEntityDataFactory(networkException, new AnonymousClass1(), i, FactorAPIClient$verify$1.this.$$error);
                }
            });
