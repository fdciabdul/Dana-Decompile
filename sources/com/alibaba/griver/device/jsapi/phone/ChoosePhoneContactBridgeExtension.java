...
public class ChoosePhoneContactBridgeExtension extends SimpleBridgeExtension {
    ...
    public void contact(@BindingNode(App.class) App app, @BindingCallback final BridgeCallback bridgeCallback) {
        ContactUtils.pickFromContactsList(app, new ContactPickerCallback() { // from class: com.alibaba.griver.device.jsapi.phone.ChoosePhoneContactBridgeExtension.1
            @Override // com.alibaba.griver.device.jsapi.phone.contact.ContactPickerCallback
