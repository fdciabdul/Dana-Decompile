...
public class GriverJSAPIPermission implements NodeAware<App>, GriverJSAPIPermissionProxy {
    ...
    @Override // com.alibaba.griver.api.h5.permission.GriverJSAPIPermissionProxy
    ...
    public Map<String, List<String>> getJSApiPermissionConfig() {
        ...
        try {
            return (Map) JSON.parseObject(config, new TypeReference<Map<String, List<String>>>() { // from class: com.alibaba.griver.h5.permission.GriverJSAPIPermission.1
            }, new Feature[0]);
        } catch (Exception e) {
    ...
    private boolean a(JSONObject jSONObject, String str, List<String> list) {
        ...
        if (list == null || list.isEmpty()) {
            return "yes".equalsIgnoreCase(jSONObject.getString("disableHttp")) && !str.startsWith(PROTOCOL_HTTPS);
        }
        return !inWhitelist(str, list);
    }
