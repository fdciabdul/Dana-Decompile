    ...
    public SettingMenu() {
        ...
        this.listener = new OnMenuItemClickListener() { // from class: com.alibaba.griver.core.ui.menu.SettingMenu.1
            ...
            public void onItemClick(Page page, String str) {
                ...
                MonitorUtil.trackMenuClick(SettingMenu.this.name);
            }
        };
    }
}
