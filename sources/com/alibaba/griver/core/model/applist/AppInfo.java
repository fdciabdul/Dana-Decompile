...
public class AppInfo implements Serializable {
    ...
    public static AppInfo convertAppInfo(DeployAppInfo deployAppInfo) {
        ...
        if (deployAppInfo.getCategoryInfos() != null) {
            for (CategoryInfo categoryInfo : deployAppInfo.getCategoryInfos()) {
                arrayList.add(new AppCategory(categoryInfo.getCategory(), categoryInfo.getCategoryId(), categoryInfo.getCategory2(), categoryInfo.getCategory3(), categoryInfo.getCategoryCode2(), categoryInfo.getCategoryCode3()));
            }
        }
