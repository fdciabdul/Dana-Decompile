...
public class RVConstants {
    ...
    public static final String DYNAMIC_PLUGIN_REQUIRED_VERSION = "dynamicPluginRequiredVersion";
    ...
    public static final String EXTRA_EMBED_FRAGMENT_CONTAINER_ID = "EmbedFragmentContainerId";
    ...
    public static final String EXTRA_PREPARE_STEP_TYPE = "prepareStepType";
    ...
    public static final String EXTRA_RES_PARAM_MAP = "paramMap";
    ...
    public static final String EXTRA_SHELL_PAGE_ID = "ariverShellPageId";
    ...
    public static final String JSON_TABBAR = "Json_tabBar";
    public static final String KERNEL_TAG = "AriverKernel";
    public static final String KEY_CAPRIMULGUS = "caprMode";
    public static final String KEY_CAPR_MANIFEST_KEY = "cparManifest";
    public static final String KEY_CHECK_PERMISSION = "checkPermission";
    ...
    public static final String ONLY_IF_CACHED_KEY = "only-if-cached";
    public static final String PERMISSION_TAG = "AriverPermission";
    public static final String PKG_EXT_PREFIX = "ariver_ext";
    public static final String PKG_XRIVER_EXT_PREFIX = "xriver_ext_";
    public static final String PLUGIN_LOG_SEED_ID = "TA_Plugin_Log";
    ...
    public static final String VALUE_CAPRIMULGUS_SYNC = "sync";
