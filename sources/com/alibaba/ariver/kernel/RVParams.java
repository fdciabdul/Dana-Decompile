...
public interface RVParams {
    ...
    public static final String AROME_ACCENT_TITLE_COLOR = "accentTitleColor";
    public static final String AROME_BG_COLOR = "bgColor";
    public static final String AROME_CHINFO = "arome_chInfo";
    public static final String AROME_HARDWARE_NAME = "arome_hardwareName";
    public static final String AROME_HARDWARE_TYPE = "arome_hardwareType";
    public static final String AROME_LAUNCH_WIDTH = "arome_launchWidth";
    public static final String AROME_LOGO_SHAPE = "logoShape";
    public static final String AROME_PANEL_BG_COLOR = "panelBgColor";
    public static final String AROME_REQUIRE_VERSION = "arome_requireVersion";
    public static final String AROME_SAVE_TO_RECENT = "saveToRecent";
    public static final String AROME_SHOW_TYPE = "showType";
    public static final String AROME_SUB_TITLE_COLOR = "subTitleColor";
    public static final String AROME_THEME_CONFIG = "themeConfig";
    public static final String AROME_TITLE_COLOR = "titleColor";
    public static final String AROME_TYPE_FACE = "typeFace";
    ...
    public static final String IS_PAGE_PRERENDER = "isPagePreRender";
    ...
    public static final String LONG_PUSHWINDOW_WITH_CUSTOM_TRANS_ANIM = "pushWindowWithCustomTransAnim";
    ...
    public static final String REQUIRE_VERSION = "requireVersion";
