...
public final class R {
    ...
    public static final class color {
        public static final int console_container_background = com.alibaba.griver.forbuild.R.color.console_container_background;
        public static final int console_toggle_button_background = com.alibaba.griver.forbuild.R.color.console_toggle_button_background;
        public static final int default_remote_debug_modal_bg_color = com.alibaba.griver.forbuild.R.color.default_remote_debug_modal_bg_color;
        public static final int remote_debug_state_exit_button_color = com.alibaba.griver.forbuild.R.color.remote_debug_state_exit_button_color;
    }
    ...
    public static final class drawable {
        ...
        public static final int remote_debug_exit_btn_bg = com.alibaba.griver.forbuild.R.drawable.remote_debug_exit_btn_bg;
    }
    ...
    public static final class id {
        ...
        public static final int remote_debug_exit = com.alibaba.griver.forbuild.R.id.remote_debug_exit;
        public static final int remote_debug_text = com.alibaba.griver.forbuild.R.id.remote_debug_text;
    }

    /* loaded from: classes6.dex */
    public static final class layout {
        public static final int ariver_tabbar_item = com.alibaba.griver.forbuild.R.layout.ariver_tabbar_item;
        public static final int remote_debug_modal = com.alibaba.griver.forbuild.R.layout.remote_debug_modal;
    }
    ...
    public static final class string {
        ...
        public static final int ariver_jsapi_websocket_already_exist = com.alibaba.griver.forbuild.R.string.ariver_jsapi_websocket_already_exist;
        public static final int ariver_resource_download_error = com.alibaba.griver.forbuild.R.string.ariver_resource_download_error;
        public static final int ariver_resource_network_is_dismatch = com.alibaba.griver.forbuild.R.string.ariver_resource_network_is_dismatch;
        public static final int ariver_resource_none_subpackage_mode = com.alibaba.griver.forbuild.R.string.ariver_resource_none_subpackage_mode;
        public static final int ariver_resource_parse_error = com.alibaba.griver.forbuild.R.string.ariver_resource_parse_error;
        ...
        public static final int console_toggle_button_text = com.alibaba.griver.forbuild.R.string.console_toggle_button_text;
        public static final int remote_debug_exit = com.alibaba.griver.forbuild.R.string.remote_debug_exit;
        ...
        public static final int tiny_remote_debug_connect_interrupt = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_connect_interrupt;
        public static final int tiny_remote_debug_connected = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_connected;
        public static final int tiny_remote_debug_connecting = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_connecting;
        public static final int tiny_remote_debug_disconnected = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_disconnected;
        public static final int tiny_remote_debug_exit_cancel = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_exit_cancel;
        public static final int tiny_remote_debug_exit_confirm = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_exit_confirm;
        public static final int tiny_remote_debug_exit_dialog_title = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_exit_dialog_title;
        public static final int tiny_remote_debug_hit_break_point = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_hit_break_point;
        public static final int tiny_remote_debug_no_network = com.alibaba.griver.forbuild.R.string.tiny_remote_debug_no_network;
