        ...
        if (i == 1) {
            ...
            while (i2 < str.length()) {
                ...
                if (charAt2 >= 'A' && charAt2 <= 'Z') {
                    char c = (char) (charAt2 + InputCardNumberView.DIVIDER);
                    if (i2 > 0) {
                        sb.append('_');
                    }
                    sb.append(c);
            ...
            while (i2 < str.length()) {
                ...
                if (charAt3 >= 'A' && charAt3 <= 'Z') {
                    char c2 = (char) (charAt3 + InputCardNumberView.DIVIDER);
                    if (i2 > 0) {
                        sb2.append('-');
                    }
                    sb2.append(c2);
            ...
            if (i == 4 && (charAt = str.charAt(0)) >= 'A' && charAt <= 'Z') {
                ...
                charArray[0] = (char) (charArray[0] + InputCardNumberView.DIVIDER);
