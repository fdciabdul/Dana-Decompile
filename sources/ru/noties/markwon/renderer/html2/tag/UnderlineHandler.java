...
public class UnderlineHandler extends TagHandler {
    ...
    public final void MyBillsEntityDataFactory(SpannableConfiguration spannableConfiguration, SpannableBuilder spannableBuilder, HtmlTag htmlTag) {
        ...
        SpannableBuilder.PlaceComponentResult(spannableBuilder, spannableConfiguration.MyBillsEntityDataFactory.MyBillsEntityDataFactory(), htmlTag.moveToNextValue(), htmlTag.MyBillsEntityDataFactory());
    }
}
