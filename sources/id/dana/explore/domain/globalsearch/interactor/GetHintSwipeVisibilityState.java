...
public final class GetHintSwipeVisibilityState extends BaseUseCase<Boolean, NoParams> {
    ...
    @Inject
    public GetHintSwipeVisibilityState(GlobalSearchRepository globalSearchRepository) {
