...
public final class SaveShareFeedConsent extends SingleUseCase<Boolean, Unit> {
    ...
    public final /* synthetic */ Object buildUseCase(Object obj, Continuation continuation) {
        this.MyBillsEntityDataFactory.PlaceComponentResult(((Boolean) obj).booleanValue());
    ...
    */
    public SaveShareFeedConsent(id.dana.feeds.domain.share.FeedsShareRepository r3) {
        /*
            r2 = this;
            java.lang.String r0 = ""
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: id.dana.feeds.domain.share.interactor.SaveShareFeedConsent.<init>(id.dana.feeds.domain.share.FeedsShareRepository):void");
    }
}
