...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B7\u0012\u0006\u0010\u0014\u001a\u00020\u0013\u0012\u0006\u0010\u0016\u001a\u00020\u0015\u0012\u0006\u0010\u000b\u001a\u00020\n\u0012\n\b\u0002\u0010\u0011\u001a\u0004\u0018\u00010\u0010\u0012\n\b\u0002\u0010\b\u001a\u0004\u0018\u00010\u0007¢\u0006\u0004\b\u0017\u0010\u0018J\u0019\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006R\u0016\u0010\b\u001a\u0004\u0018\u00010\u00078\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\tR\"\u0010\u000b\u001a\u00020\n8\u0007@\u0007X\u0086\u000e¢\u0006\u0012\n\u0004\b\u000b\u0010\f\u001a\u0004\b\u000b\u0010\r\"\u0004\b\u000e\u0010\u000fR\u0016\u0010\u0011\u001a\u0004\u0018\u00010\u00108\u0002X\u0083\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012"}, d2 = {"Lid/dana/wallet_v3/investment/viewholder/DanaPlusWalletViewHolder;", "Lid/dana/base/BaseRecyclerViewHolder;", "Lid/dana/wallet_v3/model/WalletV3CardModel;", "item", "", "bindData", "(Lid/dana/wallet_v3/model/WalletV3CardModel;)V", "Lid/dana/wallet_v3/listener/DanaPlusClickListener;", "danaPlusClickListener", "Lid/dana/wallet_v3/listener/DanaPlusClickListener;", "", "isBalanceVisible", "Z", "()Z", "setBalanceVisible", "(Z)V", "Lid/dana/wallet_v3/listener/WalletCardAssetClickListener;", "walletCardAssetClickListener", "Lid/dana/wallet_v3/listener/WalletCardAssetClickListener;", "Landroid/content/Context;", HummerConstants.CONTEXT, "Landroid/view/ViewGroup;", "parent", "<init>", "(Landroid/content/Context;Landroid/view/ViewGroup;ZLid/dana/wallet_v3/listener/WalletCardAssetClickListener;Lid/dana/wallet_v3/listener/DanaPlusClickListener;)V"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class DanaPlusWalletViewHolder extends BaseRecyclerViewHolder<WalletV3CardModel> {
    ...
    public /* synthetic */ DanaPlusWalletViewHolder(Context context, ViewGroup viewGroup, boolean z, WalletCardAssetClickListener walletCardAssetClickListener, DanaPlusClickListener danaPlusClickListener, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, viewGroup, z, (i & 8) != 0 ? null : walletCardAssetClickListener, (i & 16) != 0 ? null : danaPlusClickListener);
    }
    ...
    public DanaPlusWalletViewHolder(Context context, ViewGroup viewGroup, boolean z, WalletCardAssetClickListener walletCardAssetClickListener, DanaPlusClickListener danaPlusClickListener) {
    ...
    public final void bindData(WalletV3CardModel item) {
        super.bindData((DanaPlusWalletViewHolder) item);
        if (item == null || !(item instanceof InvestmentCardModel.DanaPlusCard)) {
            return;
        }
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "");
        InvestmentCardModel.DanaPlusCard danaPlusCard = (InvestmentCardModel.DanaPlusCard) item;
        boolean z = this.isBalanceVisible;
        DanaPlusWalletV3CardView danaPlusWalletV3CardView = new DanaPlusWalletV3CardView(context, danaPlusCard, Boolean.valueOf(z), this.walletCardAssetClickListener, this.danaPlusClickListener);
        ConstraintLayout constraintLayout = (ConstraintLayout) this.itemView.findViewById(R.id.cl_item_wallet_container);
        Intrinsics.checkNotNullExpressionValue(constraintLayout, "");
        danaPlusWalletV3CardView.addCardViewInto(constraintLayout);
    }
}
