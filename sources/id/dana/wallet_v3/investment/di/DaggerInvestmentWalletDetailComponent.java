...
import id.dana.wallet_v3.investment.presenter.InvestmentWalletDetailPresenter_Factory;
...
public final class DaggerInvestmentWalletDetailComponent {
    ...
    public static final class Builder {
        ...
        private InvestmentWalletDetailModule investmentWalletDetailModule;
        ...
        public final Builder investmentWalletDetailModule(InvestmentWalletDetailModule investmentWalletDetailModule) {
            this.investmentWalletDetailModule = (InvestmentWalletDetailModule) Preconditions.getAuthRequestContext(investmentWalletDetailModule);
            return this;
        }
        ...
        public final InvestmentWalletDetailComponent build() {
            ...
            Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.investmentWalletDetailModule, InvestmentWalletDetailModule.class);
            Preconditions.KClassImpl$Data$declaredNonStaticMembers$2(this.applicationComponent, ApplicationComponent.class);
            return new InvestmentWalletDetailComponentImpl(this.servicesModule, this.getBalanceModule, this.deepLinkModule, this.scanQrModule, this.restoreUrlModule, this.featureModule, this.oauthModule, this.investmentWalletDetailModule, this.applicationComponent, null);
        }
    }
    ...
    public static final class InvestmentWalletDetailComponentImpl implements InvestmentWalletDetailComponent {
        ...
        private final InvestmentWalletDetailComponentImpl investmentWalletDetailComponentImpl;
        private Provider<InvestmentWalletDetailPresenter> investmentWalletDetailPresenterProvider;
        ...
        private Provider<InvestmentWalletDetailContract.Presenter> providePresenterProvider;
        private Provider<GetBalanceContract.Presenter> providePresenterProvider2;
        private Provider<ScanQrContract.Presenter> providePresenterProvider3;
        private Provider<RestoreUrlContract.Presenter> providePresenterProvider4;
        private Provider<FeatureContract.Presenter> providePresenterProvider5;
        private Provider<OauthContract.Presenter> providePresenterProvider6;
        ...
        private Provider<InvestmentWalletDetailContract.View> provideViewProvider;
        private Provider<ServicesContract.View> provideViewProvider2;
        private Provider<GetBalanceContract.View> provideViewProvider3;
        private Provider<ScanQrContract.View> provideViewProvider4;
        private Provider<RestoreUrlContract.View> provideViewProvider5;
        private Provider<FeatureContract.View> provideViewProvider6;
        private Provider<OauthContract.View> provideViewProvider7;
        private Provider<DeepLinkContract.View> provideViewProvider8;
        ...
        /* synthetic */ InvestmentWalletDetailComponentImpl(ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, InvestmentWalletDetailModule investmentWalletDetailModule, ApplicationComponent applicationComponent, AnonymousClass1 anonymousClass1) {
            this(servicesModule, getBalanceModule, deepLinkModule, scanQrModule, restoreUrlModule, featureModule, oauthModule, investmentWalletDetailModule, applicationComponent);
        }

        private InvestmentWalletDetailComponentImpl(ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, InvestmentWalletDetailModule investmentWalletDetailModule, ApplicationComponent applicationComponent) {
            this.investmentWalletDetailComponentImpl = this;
            this.servicesModule = servicesModule;
            this.applicationComponent = applicationComponent;
            initialize(servicesModule, getBalanceModule, deepLinkModule, scanQrModule, restoreUrlModule, featureModule, oauthModule, investmentWalletDetailModule, applicationComponent);
            initialize2(servicesModule, getBalanceModule, deepLinkModule, scanQrModule, restoreUrlModule, featureModule, oauthModule, investmentWalletDetailModule, applicationComponent);
        }
        ...
        private void initialize(ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, InvestmentWalletDetailModule investmentWalletDetailModule, ApplicationComponent applicationComponent) {
            ...
            this.provideViewProvider = DoubleCheck.getAuthRequestContext(InvestmentWalletDetailModule_ProvideViewFactory.create(investmentWalletDetailModule));
            ...
            GetUserPaymentWalletAsset_Factory create = GetUserPaymentWalletAsset_Factory.create(this.provideWalletV3RepositoryProvider, accountRepositoryProvider);
            this.getUserPaymentWalletAssetProvider = create;
            InvestmentWalletDetailPresenter_Factory create2 = InvestmentWalletDetailPresenter_Factory.create(this.provideViewProvider, create);
            this.investmentWalletDetailPresenterProvider = create2;
            this.providePresenterProvider = DoubleCheck.getAuthRequestContext(InvestmentWalletDetailModule_ProvidePresenterFactory.create(investmentWalletDetailModule, create2));
            this.contextProvider = new ContextProvider(applicationComponent);
            this.provideViewProvider2 = ServicesModule_ProvideViewFactory.MyBillsEntityDataFactory(servicesModule);
            ...
            this.getEmptyUserInfoProvider = create3;
            this.getAuthCodeProvider = GetAuthCode_Factory.create(this.oauthRepositoryProvider, create3);
            ...
            UpdateServiceHighlighted_Factory create4 = UpdateServiceHighlighted_Factory.create(this.servicesRepositoryProvider);
            this.updateServiceHighlightedProvider = create4;
            this.servicesPresenterProvider = DoubleCheck.getAuthRequestContext(ServicesPresenter_Factory.PlaceComponentResult(this.contextProvider, this.provideViewProvider2, this.getAuthCodeProvider, this.thirdPartyServicesMapperProvider, this.isNeedToShowToolTipProvider, this.saveShowToolTipProvider, this.getServicesWithCategoryProvider, this.getDefaultServiceWithCategoryProvider, this.getFavoriteServiceRemoteProvider, this.getServicesByNameProvider, this.getServicesByKeyProvider, this.getFavoriteServicesProvider, this.checkFavoriteServicesFeatureProvider, this.getRawServicesProvider, this.getFavoriteServiceWithCacheFirstProvider, this.getServiceHighlightedProvider, create4));
            this.provideViewProvider3 = DoubleCheck.getAuthRequestContext(GetBalanceModule_ProvideViewFactory.MyBillsEntityDataFactory(getBalanceModule));
            ...
            Provider<GetBalancePresenter> authRequestContext2 = DoubleCheck.getAuthRequestContext(GetBalancePresenter_Factory.KClassImpl$Data$declaredNonStaticMembers$2(this.provideViewProvider3, this.getBalanceProvider, this.getSingleBalanceProvider, CurrencyAmountModelMapper_Factory.MyBillsEntityDataFactory(), this.getBalanceVisibilityProvider, this.setBalanceVisibilityProvider, this.getAllBalanceVisibilityProvider, this.getDanaHomeBalanceConfigProvider, this.getUserInvestmentSummaryProvider));
            this.getBalancePresenterProvider = authRequestContext2;
            this.providePresenterProvider2 = DoubleCheck.getAuthRequestContext(GetBalanceModule_ProvidePresenterFactory.getAuthRequestContext(getBalanceModule, authRequestContext2));
            ...
            this.provideViewProvider4 = DoubleCheck.getAuthRequestContext(ScanQrModule_ProvideViewFactory.getAuthRequestContext(scanQrModule, authRequestContext4));
            ...
            Provider<ScanQrPresenter> authRequestContext5 = DoubleCheck.getAuthRequestContext(ScanQrPresenter_Factory.BuiltInFictitiousFunctionClassFactory(this.contextProvider, this.provideViewProvider4, this.getDecodedQrBarcodeProvider, this.getDecodedQrisTopUpProvider, this.scanResultMapperProvider, this.deviceInformationProvider, this.getUserStatusInfoProvider, this.getCashierNativeConfigProvider, GetNativelyDecodedQr_Factory.create(), this.isNativeDecodeEnabledProvider, this.validateNativelyDecodedQrProvider, this.getMerchantQrWhitelistProvider, this.getQrBindingConfigProvider, this.isFeaturePaylaterCicilScannerEnabledProvider, this.getUserLoanInfoProvider, this.getQrisCpmSendmoneyConfigProvider, this.saveShowDialogProvider));
            this.scanQrPresenterProvider = authRequestContext5;
            this.providePresenterProvider3 = DoubleCheck.getAuthRequestContext(ScanQrModule_ProvidePresenterFactory.MyBillsEntityDataFactory(scanQrModule, authRequestContext5));
            ...
            this.provideViewProvider5 = DoubleCheck.getAuthRequestContext(RestoreUrlModule_ProvideViewFactory.PlaceComponentResult(restoreUrlModule, authRequestContext6));
            ...
            Provider<RestoreUrlPresenter> authRequestContext7 = DoubleCheck.getAuthRequestContext(RestoreUrlPresenter_Factory.MyBillsEntityDataFactory(this.provideViewProvider5, create6));
            this.restoreUrlPresenterProvider = authRequestContext7;
            this.providePresenterProvider4 = DoubleCheck.getAuthRequestContext(RestoreUrlModule_ProvidePresenterFactory.PlaceComponentResult(restoreUrlModule, authRequestContext7));
            ...
            GetRequestMoneyInfoFeature_Factory create7 = GetRequestMoneyInfoFeature_Factory.create(this.threadExecutorProvider, this.postExecutionThreadProvider, this.featureConfigRepositoryProvider);
            this.getRequestMoneyInfoFeatureProvider = create7;
            ...
            this.featureSplitBillProvider = FeatureSplitBill_Factory.MyBillsEntityDataFactory(provider, create7, requestMoneyInfoModelMapper_Factory);
            ...
            this.getMissionDetailProvider = create8;
            this.featurePromoQuestProvider = FeaturePromoQuest_Factory.getAuthRequestContext(create8, PromoQuestMapper_Factory.MyBillsEntityDataFactory());
        ...
        private void initialize2(ServicesModule servicesModule, GetBalanceModule getBalanceModule, DeepLinkModule deepLinkModule, ScanQrModule scanQrModule, RestoreUrlModule restoreUrlModule, FeatureModule featureModule, OauthModule oauthModule, InvestmentWalletDetailModule investmentWalletDetailModule, ApplicationComponent applicationComponent) {
            ...
            this.provideViewProvider6 = authRequestContext2;
            ...
            Provider<FeaturePresenter> authRequestContext3 = DoubleCheck.getAuthRequestContext(FeaturePresenter_Factory.PlaceComponentResult(this.provideViewProvider6, this.featureServicesHandlerProvider, this.checkDeepLinkActionVisibilityProvider, this.checkWhitelistedValidDomainProvider, this.getNearbyConfigProvider, this.getFeedConfigProvider, this.getPromoCenterVersionProvider, this.getUpdateAvailabilityProvider, this.checkMyBillsVersionConfigProvider, this.providePushVerifyTrackerProvider, create));
            this.featurePresenterProvider = authRequestContext3;
            this.providePresenterProvider5 = DoubleCheck.getAuthRequestContext(FeatureModule_ProvidePresenterFactory.getAuthRequestContext(featureModule, authRequestContext3));
            ...
            this.provideViewProvider7 = DoubleCheck.getAuthRequestContext(OauthModule_ProvideViewFactory.getAuthRequestContext(oauthModule, authRequestContext4));
            ...
            Provider<OauthContract.View> provider = this.provideViewProvider7;
            ...
            this.providePresenterProvider6 = DoubleCheck.getAuthRequestContext(OauthModule_ProvidePresenterFactory.BuiltInFictitiousFunctionClassFactory(oauthModule, KClassImpl$Data$declaredNonStaticMembers$2));
            ApplicationProvider applicationProvider = new ApplicationProvider(applicationComponent);
            this.applicationProvider = applicationProvider;
            Provider<DeepLinkView> authRequestContext5 = DoubleCheck.getAuthRequestContext(DeepLinkView_Factory.getAuthRequestContext(this.providePresenterProvider3, this.providePresenterProvider4, this.providePresenterProvider5, this.providePresenterProvider6, this.servicesPresenterProvider, applicationProvider, this.getUserLoanInfoProvider));
            this.deepLinkViewProvider = authRequestContext5;
            this.provideViewProvider8 = DoubleCheck.getAuthRequestContext(DeepLinkModule_ProvideViewFactory.PlaceComponentResult(deepLinkModule, authRequestContext5));
            ...
            Provider<ReadLinkPropertiesPresenter> authRequestContext6 = DoubleCheck.getAuthRequestContext(ReadLinkPropertiesPresenter_Factory.getAuthRequestContext(this.provideViewProvider8, this.readDeepLinkPropertiesProvider, this.deepLinkPayloadModelMapperProvider, create2, this.mixpanelDeeplinkTrackerProvider));
        ...
        public final void inject(InvestmentWalletDetailFragment investmentWalletDetailFragment) {
            injectInvestmentWalletDetailFragment(investmentWalletDetailFragment);
        }

        private InvestmentWalletDetailFragment injectInvestmentWalletDetailFragment(InvestmentWalletDetailFragment investmentWalletDetailFragment) {
            InvestmentWalletDetailFragment_MembersInjector.injectInvestmentPresenter(investmentWalletDetailFragment, this.providePresenterProvider.get());
            InvestmentWalletDetailFragment_MembersInjector.injectServicesPresenter(investmentWalletDetailFragment, presenter());
            InvestmentWalletDetailFragment_MembersInjector.injectGetBalancePresenter(investmentWalletDetailFragment, this.providePresenterProvider2.get());
            InvestmentWalletDetailFragment_MembersInjector.injectReadLinkPropertiesPresenter(investmentWalletDetailFragment, this.provideReadPropertiesPresenterProvider.get());
            InvestmentWalletDetailFragment_MembersInjector.injectDeviceInformationProvider(investmentWalletDetailFragment, (DeviceInformationProvider) Preconditions.PlaceComponentResult(this.applicationComponent.NetworkUserEntityData$$ExternalSyntheticLambda7()));
            InvestmentWalletDetailFragment_MembersInjector.injectWalletH5ServicesImplementation(investmentWalletDetailFragment, walletH5ServicesImplementation());
            InvestmentWalletDetailFragment_MembersInjector.injectWalletV3TrackerImplementation(investmentWalletDetailFragment, walletV3TrackerImpl());
            InvestmentWalletDetailFragment_MembersInjector.injectFeaturePresenter(investmentWalletDetailFragment, this.providePresenterProvider5.get());
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: id.dana.wallet_v3.investment.di.DaggerInvestmentWalletDetailComponent$1 */
    /* loaded from: classes5.dex */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        private static long PlaceComponentResult = 9061402557637558511L;
        ...
        public static void $$a(long j, long j2) {
            ...
            a(1 - (ViewConfiguration.getFadingEdgeLength() >> 16), new char[]{4583, 50755, 8718, 4494, 2858, 47206, 39765, 9665, 64559, 51008}, objArr);
        ...
        private static void a(int i, char[] cArr, Object[] objArr) {
            ...
            while (true) {
                if ((d.MyBillsEntityDataFactory < KClassImpl$Data$declaredNonStaticMembers$22.length ? 'M' : '\'') == '\'') {
                    break;
                }
                int i2 = $11 + 49;
                $10 = i2 % 128;
