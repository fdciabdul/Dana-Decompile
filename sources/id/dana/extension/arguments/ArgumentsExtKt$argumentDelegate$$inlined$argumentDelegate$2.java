...
public final class ArgumentsExtKt$argumentDelegate$$inlined$argumentDelegate$2<T> implements LazyProvider<Activity, T> {
    @Override // id.dana.extension.arguments.LazyProvider
    public final Lazy<T> KClassImpl$Data$declaredNonStaticMembers$2(final Activity p0, final KProperty<?> p1) {
        Intrinsics.checkNotNullParameter(p1, "");
        Intrinsics.needClassReification();
        return LazyKt.lazy(new Function0<T>() { // from class: id.dana.extension.arguments.ArgumentsExtKt$argumentDelegate$$inlined$argumentDelegate$2.1
            ...
            public final T invoke() {
                Intent intent = ((Activity) p0).getIntent();
                T t = null;
                Bundle extras = intent != null ? intent.getExtras() : null;
                if (extras != null) {
                    t = (T) extras.get(p1.getName());
                }
