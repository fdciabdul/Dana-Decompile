...
public class SSLPinningHotUpdate extends UseCase<Boolean, Void> {
    private final SSLPinningRepository sslPinningRepository;

    @Inject
    public SSLPinningHotUpdate(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SSLPinningRepository sSLPinningRepository) {
