...
public final class VerifyPinKtpModel extends BaseRpcResponse {
    ...
    public VerifyPinKtpModel(Long l, Integer num, Integer num2, Long l2) {
        this.lockedExpireSeconds = l;
        this.identifyFailedCount = num;
        this.maxFailed = num2;
