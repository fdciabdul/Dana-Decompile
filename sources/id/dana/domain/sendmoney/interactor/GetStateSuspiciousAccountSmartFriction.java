...
public final class GetStateSuspiciousAccountSmartFriction extends BaseUseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> stateSuspiciousAccountSmartFriction = this.sendMoneyRepository.getStateSuspiciousAccountSmartFriction();
        Intrinsics.checkNotNullExpressionValue(stateSuspiciousAccountSmartFriction, "");
        return stateSuspiciousAccountSmartFriction;
    }
}
