...
public final class IsNativeDecodeEnabled extends BaseUseCase<Boolean, NoParams> {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> isFeatureNativeDecodeEnable = this.featureConfigRepository.isFeatureNativeDecodeEnable();
