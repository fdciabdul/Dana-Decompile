...
public final class GetGlobalNetworkProxyConfig extends BaseUseCase<Boolean, NoParams> {
    private final FeatureConfigRepository featureConfigRepository;

    @Inject
    public GetGlobalNetworkProxyConfig(FeatureConfigRepository featureConfigRepository) {
    ...
    public final Observable<Boolean> buildUseCase(NoParams params) {
        ...
        Observable<Boolean> isFeatureGnProxyEnable = this.featureConfigRepository.isFeatureGnProxyEnable();
