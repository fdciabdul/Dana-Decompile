...
public final class BaseTrafficType$getConfigOnceReady$$inlined$getTreatmentWithConfigSdkReady$1<T> implements ObservableOnSubscribe {
    final /* synthetic */ boolean $KClassImpl$Data$declaredNonStaticMembers$2;
    final /* synthetic */ String $MyBillsEntityDataFactory;
    final /* synthetic */ Object $PlaceComponentResult;
    final /* synthetic */ BaseTrafficType BuiltInFictitiousFunctionClassFactory;
    ...
    public final void subscribe(final ObservableEmitter<T> observableEmitter) {
        ...
        String BuiltInFictitiousFunctionClassFactory = this.BuiltInFictitiousFunctionClassFactory.BuiltInFictitiousFunctionClassFactory();
        Intrinsics.reifiedOperationMarker(4, "T");
        Object obj = this.$PlaceComponentResult;
        final boolean z = this.$KClassImpl$Data$declaredNonStaticMembers$2;
        final BaseTrafficType baseTrafficType = this.BuiltInFictitiousFunctionClassFactory;
        final String str2 = this.$MyBillsEntityDataFactory;
        MyBillsEntityDataFactory.KClassImpl$Data$declaredNonStaticMembers$2(str, BuiltInFictitiousFunctionClassFactory, Object.class, obj, new ToggleCallback<T>() { // from class: id.dana.data.toggle.traffictype.BaseTrafficType$getConfigOnceReady$$inlined$getTreatmentWithConfigSdkReady$1.1
