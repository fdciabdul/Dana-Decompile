...
public final class BaseTrafficType$getConfigOnceReady$$inlined$getConfigCachedOnceReady$1<T> implements ObservableOnSubscribe {
    ...
    final /* synthetic */ BaseTrafficType MyBillsEntityDataFactory;
    ...
    public final void subscribe(final ObservableEmitter<T> observableEmitter) {
        ...
        String BuiltInFictitiousFunctionClassFactory = this.MyBillsEntityDataFactory.BuiltInFictitiousFunctionClassFactory();
        Intrinsics.reifiedOperationMarker(4, "T");
        Object obj = this.$KClassImpl$Data$declaredNonStaticMembers$2;
        final boolean z = this.$PlaceComponentResult;
        final BaseTrafficType baseTrafficType = this.MyBillsEntityDataFactory;
        final String str2 = this.$getAuthRequestContext;
        MyBillsEntityDataFactory.getAuthRequestContext(str, BuiltInFictitiousFunctionClassFactory, Object.class, obj, new ToggleCallback<T>() { // from class: id.dana.data.toggle.traffictype.BaseTrafficType$getConfigOnceReady$$inlined$getConfigCachedOnceReady$1.1
