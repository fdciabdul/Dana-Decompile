...
public final /* data */ class PaginatorEntity {
    ...
    public final PaginatorEntity copy(int beginIndex, int endIndex, int firstPage, int items, int itemsPerPage, int lastPage, int length, int nextPage, int offset, int page, int pages, int previousPage, ArrayList<Integer> slider) {
    ...
    public final String toString() {
        ...
        sb.append("PaginatorEntity(beginIndex=");
    ...
    public PaginatorEntity(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, ArrayList<Integer> arrayList) {
