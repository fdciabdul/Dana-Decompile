...
public @interface SpaceCode {
    ...
    public static final String KYB_BANNER = "kyb_banner_homepage";
    public static final String KYB_QRIS_POSTER = "kyb_qris_poster";
    public static final String KYB_TNC = "kyb_tnc";
    ...
    public static final String REFERRAL_BANNER = "native_home_referral_banner_new";
    ...
    public static final String TNC_FAMILY_ACCOUNT_AGREEMENT = "PERSISTENT_family_account_agreement";
}
