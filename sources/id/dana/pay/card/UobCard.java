...
public class UobCard {
    private UobCard() {
    }

    public static PayCardViewItem MyBillsEntityDataFactory() {
        PayCardViewItem.Builder PlaceComponentResult = PayCardViewItem.PlaceComponentResult();
        PlaceComponentResult.getErrorConfigVersion = R.drawable.bg_uobc1id_vertical;
        PlaceComponentResult.PlaceComponentResult = R.drawable.bg_uobc1id_horizontal;
        PlaceComponentResult.MyBillsEntityDataFactory = R.drawable.logo_uobc1id;
