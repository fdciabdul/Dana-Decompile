...
public final class ExpiredVoucherItemAdapter extends BaseDiscoveryItemAdapter<PromoModel> {
    ...
    */
    public ExpiredVoucherItemAdapter(id.dana.promodiscovery.richview.PromoDiscoveryListItemListener<? super id.dana.promocenter.model.PromoModel> r3) {
        /*
            r2 = this;
            java.lang.String r0 = ""
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: id.dana.promodiscovery.adapter.ExpiredVoucherItemAdapter.<init>(id.dana.promodiscovery.richview.PromoDiscoveryListItemListener):void");
    }
    ...
    public final BaseRecyclerViewHolder<PromoModel> MyBillsEntityDataFactory(ViewGroup p0) {
        ...
        return new ExpiredVoucherItemViewHolder(p0, this.BuiltInFictitiousFunctionClassFactory);
    }
}
