...
public final class CashierEntityRepository implements CashierRepository, HoldLoginV1Repository, CardCredentialRepository {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:140:0x0073, code lost:
        ...
        if (kotlin.jvm.internal.Intrinsics.areEqual(r2.getPayMethod(), "ONLINE_CREDIT") == false) goto L142;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:148:0x0096, code lost:
        ...
        if (kotlin.jvm.internal.Intrinsics.areEqual(r2.getPayMethod(), id.dana.domain.payasset.model.PayMethod.LOAN_CREDIT) == false) goto L170;
     */
    ...
    */
    ...
    public final Observable<CreateOrderInfo> createOrder(final CreateOrderRequest createOrderRequest) {
        try {
            ...
            Observable<R> flatMap = createAccountData().getNickname().flatMap(new Function() { // from class: id.dana.cashier.data.repository.CashierEntityRepository$$ExternalSyntheticLambda32
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    return CashierEntityRepository.$r8$lambda$_UFq1pQpdx9F6KBlT3IVm7T2TNA(createOrderRequest, this, (String) obj);
                }
            });
            final CreateOrderInfoResultMapper createOrderInfoResultMapper = this.createOrderInfoResultMapper;
            Observable map = flatMap.map(new Function() { // from class: id.dana.cashier.data.repository.CashierEntityRepository$$ExternalSyntheticLambda34
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    return createOrderInfoResultMapper.apply((CreateOrderInfoResult) obj);
                }
            });
            Intrinsics.checkNotNullExpressionValue(map, "");
    ...
    public final Observable<CashierAgreementResponse> createCashierAgreement(CashierAgreementRequest cashierAgreementRequest) {
        try {
            ...
            ObservableSource map = createCashierEKtpAgreement.map(new Function() { // from class: id.dana.cashier.data.repository.CashierEntityRepository$$ExternalSyntheticLambda4
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    return cashierEKtpAgreementResultMapper.apply((CashierAgreementResult) obj);
                }
            });
            Intrinsics.checkNotNullExpressionValue(map, "");
    ...
    */
    ...
    public final Observable<QueryPromotionInfo> getQueryPromotion(QueryPromotionRequest queryPromotionRequest) {
        try {
            ...
            ObservableSource map = queryPromotion.map(new Function() { // from class: id.dana.cashier.data.repository.CashierEntityRepository$$ExternalSyntheticLambda40
                @Override // io.reactivex.functions.Function
                public final Object apply(Object obj) {
                    return queryPromotionInfoResultMapper.apply((QueryPromotionInfoResult) obj);
                }
            });
            Intrinsics.checkNotNullExpressionValue(map, "");
    ...
    public final Observable<CashierAddOnModalTooltip> getTooltipContent(CashierAddOnModalTooltipRequest cashierAddOnModalTooltipRequest) {
        ...
        ObservableSource map = tooltipContent.map(new Function() { // from class: id.dana.cashier.data.repository.CashierEntityRepository$$ExternalSyntheticLambda28
            @Override // io.reactivex.functions.Function
            public final Object apply(Object obj) {
                return cashierAddOnModalTooltipResultMapper.apply((CashierAddOnModalTooltipResult) obj);
            }
        });
        Intrinsics.checkNotNullExpressionValue(map, "");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:79:0x002e, code lost:
        ...
        if (r3.isStale(r4) == false) goto L80;
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:106:0x004f, code lost:
        ...
        throw r6;
     */
    /* JADX WARN: Code restructure failed: missing block: B:91:0x0021, code lost:
