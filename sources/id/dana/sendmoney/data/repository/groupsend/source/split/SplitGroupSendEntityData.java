...
public final class SplitGroupSendEntityData implements GroupSendEntityData {
    ...
    public final Flow<Integer> PlaceComponentResult() {
        return FlowKt.flow(new SplitGroupSendEntityData$getGroupSendMaxGroup$1(this, null));
    }

    @Override // id.dana.sendmoney.data.repository.groupsend.source.GroupSendEntityData
    public final Flow<Integer> KClassImpl$Data$declaredNonStaticMembers$2() {
        return FlowKt.flow(new SplitGroupSendEntityData$getGroupSendMaxParticipant$1(this, null));
    }

    @Override // id.dana.sendmoney.data.repository.groupsend.source.GroupSendEntityData
    public final Flow<Boolean> getAuthRequestContext() {
        return FlowKt.flow(new SplitGroupSendEntityData$getEditMemberSwitch$1(this, null));
    }
    ...
    public final Flow<List<GroupSendScenarioConfigEntity>> MyBillsEntityDataFactory() {
        return FlowKt.flow(new SplitGroupSendEntityData$getGroupSendScenarios$1(this, null));
    }
