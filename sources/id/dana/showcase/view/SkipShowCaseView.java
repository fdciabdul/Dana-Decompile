...
public final class SkipShowCaseView extends BaseRichView {
    ...
    public final int getLayout() {
        return R.layout.view_tooltip_skip;
    }
    ...
    public final void setOnSkipButtonClickListener(final View.OnClickListener onClickListener) {
        ...
        ((LinearLayout) _$_findCachedViewById(R.id.getFirebaseApplicationContext)).setOnClickListener(new View.OnClickListener() { // from class: id.dana.showcase.view.SkipShowCaseView$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SkipShowCaseView.$r8$lambda$kU592N38pZgkmkXJuAZ_SMdfbv4(onClickListener, this, view);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$kU592N38pZgkmkXJuAZ_SMdfbv4(View.OnClickListener onClickListener, SkipShowCaseView skipShowCaseView, View view) {
        Intrinsics.checkNotNullParameter(onClickListener, "");
