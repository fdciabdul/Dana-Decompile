...
public final class MissionModule {
    ...
    public final MissionContract.View getPlaceComponentResult() {
        return this.PlaceComponentResult;
    }

    @Provides
    @PerActivity
    public final MissionContract.Presenter getAuthRequestContext(MissionPresenter p0) {
