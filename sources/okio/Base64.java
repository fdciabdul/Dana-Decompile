...
final class Base64 {
    ...
    public static String PlaceComponentResult(byte[] bArr) {
        return KClassImpl$Data$declaredNonStaticMembers$2(bArr, getAuthRequestContext);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static String KClassImpl$Data$declaredNonStaticMembers$2(byte[] bArr, byte[] bArr2) {
        ...
        if (length2 == 1) {
            ...
            byte b2 = bArr[length];
            int i12 = length + 1;
            bArr3[i10] = bArr2[((b2 & 3) << 4) | ((bArr[i12] & 255) >> 4)];
