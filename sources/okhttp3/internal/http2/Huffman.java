...
class Huffman {
    ...
    public void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        ...
        while (i < byteString.size()) {
            ...
            while (i4 >= 8) {
                i4 = (i4 == 1 ? 1 : 0) - 8;
                bufferedSink.PlaceComponentResult((int) (j >> i4));
            }
            i++;
            b = i4;
        }
        if (b > 0) {
            bufferedSink.PlaceComponentResult((int) ((j << (8 - b)) | (255 >>> b)));
        }
    }
    ...
    public byte[] decode(byte[] bArr) {
        ...
        while (i > 0) {
            Node node2 = node.children[(i2 << (8 - i)) & 255];
