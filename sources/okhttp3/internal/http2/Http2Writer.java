...
final class Http2Writer implements Closeable {
    ...
    public final void connectionPreface() throws IOException {
        synchronized (this) {
            ...
            if (this.client) {
                ...
                this.sink.MyBillsEntityDataFactory(Http2.CONNECTION_PREFACE.toByteArray());
                this.sink.flush();
            }
        }
    }
    ...
    public final void pushPromise(int i, int i2, List<Header> list) throws IOException {
        synchronized (this) {
            ...
            long j = this.hpackBuffer.getAuthRequestContext;
            int min = (int) Math.min(this.maxFrameSize - 4, j);
            long j2 = min;
            frameHeader(i, min + 4, (byte) 5, j == j2 ? (byte) 4 : (byte) 0);
            this.sink.BuiltInFictitiousFunctionClassFactory(i2 & Integer.MAX_VALUE);
    ...
    public final void rstStream(int i, ErrorCode errorCode) throws IOException {
        synchronized (this) {
            ...
            this.sink.BuiltInFictitiousFunctionClassFactory(errorCode.httpCode);
            this.sink.flush();
        }
    }
    ...
    public final void settings(Settings settings) throws IOException {
        synchronized (this) {
            ...
            while (i < 10) {
                if (settings.isSet(i)) {
                    this.sink.moveToNextValue(i == 4 ? 3 : i == 7 ? 4 : i);
                    this.sink.BuiltInFictitiousFunctionClassFactory(settings.get(i));
                }
                i++;
            }
            this.sink.flush();
    ...
    public final void ping(boolean z, int i, int i2) throws IOException {
        synchronized (this) {
            ...
            this.sink.BuiltInFictitiousFunctionClassFactory(i);
            this.sink.BuiltInFictitiousFunctionClassFactory(i2);
            this.sink.flush();
        }
    }
    ...
    public final void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
        synchronized (this) {
            ...
            this.sink.BuiltInFictitiousFunctionClassFactory(errorCode.httpCode);
            if (bArr.length > 0) {
                this.sink.MyBillsEntityDataFactory(bArr);
            }
            this.sink.flush();
        }
    }
    ...
    public final void windowUpdate(int i, long j) throws IOException {
        synchronized (this) {
            ...
            this.sink.BuiltInFictitiousFunctionClassFactory((int) j);
            this.sink.flush();
        }
    }
    ...
    public final void frameHeader(int i, int i2, byte b, byte b2) throws IOException {
        ...
        this.sink.PlaceComponentResult(b & 255);
        this.sink.PlaceComponentResult(b2 & 255);
        this.sink.BuiltInFictitiousFunctionClassFactory(i & Integer.MAX_VALUE);
    }
    ...
    private static void writeMedium(BufferedSink bufferedSink, int i) throws IOException {
        bufferedSink.PlaceComponentResult((i >>> 16) & 255);
        bufferedSink.PlaceComponentResult((i >>> 8) & 255);
        bufferedSink.PlaceComponentResult(i & 255);
    }
