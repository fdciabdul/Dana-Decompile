...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public final Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        final Flow[] flowArr2 = this.$flows$inlined;
        Function0 function0 = new Function0<T[]>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$1
        ...
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new FlowKt__ZipKt$combine$5$2(this.$transform$inlined, null), continuation);
