...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    @JvmName(name = "getCollectToFun$kotlinx_coroutines_core")
    ...
    @JvmName(name = "getProduceCapacity$kotlinx_coroutines_core")
