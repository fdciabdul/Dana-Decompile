...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Type inference failed for: r2v10, types: [kotlinx.coroutines.channels.ReceiveChannel] */
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        CoroutineContext builtInFictitiousFunctionClassFactory;
        ...
        try {
            if (receiveChannel3 != 0) {
                if (receiveChannel3 == 1) {
                    ...
                    ReceiveChannel.DefaultImpls.cancel$default(receiveChannel3, null, 1, null);
            ...
            ((SendChannel) receiveChannel).mo4671invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(1);
                ...
                public final void invoke2(Throwable th) {
                    if (CompletableJob.this.isActive()) {
                        CompletableJob.this.cancel(new AbortFlowException(flowCollector));
                    }
                }
            });
            try {
                builtInFictitiousFunctionClassFactory = coroutineScope.getBuiltInFictitiousFunctionClassFactory();
                threadContextElements = ThreadContextKt.threadContextElements(builtInFictitiousFunctionClassFactory);
            ...
            if (ChannelFlowKt.withContextUndispatched$default(coroutineScope.getBuiltInFictitiousFunctionClassFactory().plus(Job$default), Unit.INSTANCE, null, new AnonymousClass2(this.$flow, builtInFictitiousFunctionClassFactory, threadContextElements, receiveChannel, this.$this_unsafeFlow, this.$transform, null), this, 4, null) == coroutine_suspended) {
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Metadata(d1 = {"\u0000\f\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u0001\"\u0004\b\u0002\u0010\u00022\u0006\u0010\u0003\u001a\u00028\u0000H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"T1", "T2", "R", "value", "", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 6, 0}, xi = 48)
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            /* loaded from: classes6.dex */
            public static final class C02031 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C02031(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C02031> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C02031(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
                    return ((C02031) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r9) {
                    ...
                    L30:
                        ...
                        r8.label = r5
                        java.lang.Object r9 = r9.mo4632receiveCatchingJP2dKIU(r1)
                        if (r9 != r0) goto L41
                        return r0
                    L41:
                        ...
                        if (r5 == 0) goto L55
                        java.lang.Throwable r9 = kotlinx.coroutines.channels.ChannelResult.m4637exceptionOrNullimpl(r9)
                        if (r9 != 0) goto L54
                    ...
                    L77:
                        ...
                        return r9
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.AnonymousClass2.AnonymousClass1.C02031.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            }
