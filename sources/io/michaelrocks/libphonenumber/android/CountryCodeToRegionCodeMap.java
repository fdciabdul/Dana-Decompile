...
public class CountryCodeToRegionCodeMap {
    ...
    private static char[] MyBillsEntityDataFactory = {58052, 19278};
    private static long BuiltInFictitiousFunctionClassFactory = -6238637228389803315L;
    ...
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList.add("KN");
        arrayList.add("KY");
        arrayList.add(NearbyMePromoType.LimitRangeType.LC);
        arrayList.add("MP");
        arrayList.add("MS");
        arrayList.add("PR");
        arrayList.add("SX");
        ...
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_STA_STORE_LOW_VERSION_DATA_FILE), arrayList48);
        ...
        arrayList52.add("GM");
        hashMap.put(Integer.valueOf((int) WheelView.DIVIDER_ALPHA), arrayList52);
        ...
        a(TextUtils.getTrimmedLength(""), (SystemClock.elapsedRealtime() > 0L ? 1 : (SystemClock.elapsedRealtime() == 0L ? 0 : -1)) + 1, (char) (4558 - (ViewConfiguration.getScrollFriction() > 0.0f ? 1 : (ViewConfiguration.getScrollFriction() == 0.0f ? 0 : -1))), objArr);
        arrayList56.add(((String) objArr[0]).intern());
        ...
        arrayList78.add(RVScheduleType.IO);
        ...
        arrayList89.add("BI");
        hashMap.put(Integer.valueOf((int) DeepRecoverARiverProxy.TYPE_ENTITY_APP), arrayList89);
        ArrayList arrayList90 = new ArrayList(1);
        arrayList90.add("MZ");
        hashMap.put(Integer.valueOf((int) DeepRecoverARiverProxy.TYPE_ENTITY_TEMPLATE), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf((int) DeepRecoverARiverProxy.TYPE_ENTITY_TA_PAGE), arrayList91);
        ArrayList arrayList92 = new ArrayList(1);
        arrayList92.add("MG");
        hashMap.put(Integer.valueOf((int) DeepRecoverARiverProxy.TYPE_ENTITY_ONLINE_PAGE), arrayList92);
        ...
        arrayList105.add("GL");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_STA_STORE_UNKNOWN_ERROR), arrayList105);
        ...
        arrayList116.add(Condition.MATCH_TYPE_LESS_THAN);
        ...
        arrayList123.add(NearbyMePromoType.LimitRangeType.MC);
        ...
        arrayList135.add("LI");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_DYN_ENC_BASE64_DECODE_FAILED), arrayList135);
        ...
        arrayList138.add(Condition.MATCH_TYPE_GREATER_THAN);
        ...
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_DYN_STORE_GET_DATA_FILE_KEY_FAILED), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_DYN_STORE_GET_ENCRYPT_KEY_FAILED), arrayList141);
        ...
        arrayList144.add("PM");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_DYN_STORE_DDPEX_KEY_VALUE_NOT_EXSIT), arrayList144);
        ...
        arrayList155.add("CW");
        arrayList155.add("BQ");
        hashMap.put(Integer.valueOf((int) SecExceptionCode.SEC_ERROR_DYN_STORE_UNKNOWN_ERROR), arrayList155);
        ...
        arrayList169.add(MonitorItemConstants.MONITOR_SUB_TYPE);
        ...
        arrayList202.add(IAPAECodeEncoding.IAP_ERROR_IDENTITY);
