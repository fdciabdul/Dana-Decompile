...
final class FlowableKt$toMap$2<T, R, V> implements Function<T, V> {
    public static final FlowableKt$toMap$2 KClassImpl$Data$declaredNonStaticMembers$2 = new FlowableKt$toMap$2();
