...
public final class CompletableDelay extends Completable {
    ...
    final boolean MyBillsEntityDataFactory = false;
    ...
    public final void MyBillsEntityDataFactory(CompletableObserver completableObserver) {
        this.KClassImpl$Data$declaredNonStaticMembers$2.getAuthRequestContext(new Delay(completableObserver, this.getAuthRequestContext, this.BuiltInFictitiousFunctionClassFactory, this.PlaceComponentResult, this.MyBillsEntityDataFactory));
    }
