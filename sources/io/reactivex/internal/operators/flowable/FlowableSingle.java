...
public final class FlowableSingle<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public final void KClassImpl$Data$declaredNonStaticMembers$2(Subscriber<? super T> subscriber) {
        this.BuiltInFictitiousFunctionClassFactory.getAuthRequestContext(new SingleElementSubscriber(subscriber, this.KClassImpl$Data$declaredNonStaticMembers$2, this.getAuthRequestContext));
    }
