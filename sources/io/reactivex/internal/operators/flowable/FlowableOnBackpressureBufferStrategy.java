...
public final class FlowableOnBackpressureBufferStrategy<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    final BackpressureOverflowStrategy getAuthRequestContext;

    @Override // io.reactivex.Flowable
    public final void KClassImpl$Data$declaredNonStaticMembers$2(Subscriber<? super T> subscriber) {
        this.BuiltInFictitiousFunctionClassFactory.getAuthRequestContext(new OnBackpressureBufferStrategySubscriber(subscriber, this.KClassImpl$Data$declaredNonStaticMembers$2, this.getAuthRequestContext, this.MyBillsEntityDataFactory));
    }
        ...
        public final void onNext(T t) {
            ...
            synchronized (deque) {
                ...
                if (deque.size() == this.bufferSize) {
                    int i = AnonymousClass1.MyBillsEntityDataFactory[this.strategy.ordinal()];
                    if (i == 1) {
                        deque.pollLast();
                        deque.offer(t);
                    } else if (i == 2) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                MyBillsEntityDataFactory[BackpressureOverflowStrategy.DROP_OLDEST.ordinal()] = 2;
