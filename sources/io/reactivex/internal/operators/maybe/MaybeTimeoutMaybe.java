...
public final class MaybeTimeoutMaybe<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    public final void MyBillsEntityDataFactory(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.getAuthRequestContext);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.PlaceComponentResult.PlaceComponentResult(timeoutMainMaybeObserver.other);
