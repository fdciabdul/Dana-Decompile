...
public final class ObservableThrottleLatest<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    public final void subscribeActual(Observer<? super T> observer) {
        this.getAuthRequestContext.subscribe(new ThrottleLatestObserver(observer, this.MyBillsEntityDataFactory, this.BuiltInFictitiousFunctionClassFactory, this.PlaceComponentResult.createWorker(), this.KClassImpl$Data$declaredNonStaticMembers$2));
    }
