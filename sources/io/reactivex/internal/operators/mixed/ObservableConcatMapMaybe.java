...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
    ...
    final Function<? super T, ? extends MaybeSource<? extends R>> PlaceComponentResult;
    ...
    public ObservableConcatMapMaybe(Observable<T> observable, Function<? super T, ? extends MaybeSource<? extends R>> function, ErrorMode errorMode, int i) {
        ...
        this.MyBillsEntityDataFactory = errorMode;
        this.getAuthRequestContext = i;
    }

    @Override // io.reactivex.Observable
    public final void subscribeActual(Observer<? super R> observer) {
        if (ScalarXMapZHelper.MyBillsEntityDataFactory(this.KClassImpl$Data$declaredNonStaticMembers$2, this.PlaceComponentResult, observer)) {
            return;
        }
        this.KClassImpl$Data$declaredNonStaticMembers$2.subscribe(new ConcatMapMaybeMainObserver(observer, this.PlaceComponentResult, this.getAuthRequestContext, this.MyBillsEntityDataFactory));
    }
