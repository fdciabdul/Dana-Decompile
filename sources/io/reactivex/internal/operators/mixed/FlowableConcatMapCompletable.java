...
public final class FlowableConcatMapCompletable<T> extends Completable {
    ...
    public final void MyBillsEntityDataFactory(CompletableObserver completableObserver) {
        this.PlaceComponentResult.getAuthRequestContext(new ConcatMapCompletableObserver(completableObserver, this.MyBillsEntityDataFactory, this.getAuthRequestContext, this.BuiltInFictitiousFunctionClassFactory));
    }
            ...
            while (!this.disposed) {
                if (!this.active) {
                    ...
                    if (z && z2) {
                        ...
                        try {
                            CompletableSource completableSource = (CompletableSource) ObjectHelper.PlaceComponentResult(this.mapper.apply(poll), "The mapper returned a null CompletableSource");
                            this.active = true;
