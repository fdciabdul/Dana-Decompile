...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback, FSDraw {
    ...
    public void setTintList(ColorStateList colorStateList) {
        ...
        if (this.mDrawableContainerState.mTintList != colorStateList) {
            ...
            androidx.core.graphics.drawable.DrawableCompat.PlaceComponentResult(this.mCurrDrawable, colorStateList);
        }
    }
    ...
    public void setTintMode(PorterDuff.Mode mode) {
        ...
        if (this.mDrawableContainerState.mTintMode != mode) {
            ...
            androidx.core.graphics.drawable.DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(this.mCurrDrawable, mode);
        }
    }
    ...
    public void setAutoMirrored(boolean z) {
        if (this.mDrawableContainerState.mAutoMirrored != z) {
            ...
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
                androidx.core.graphics.drawable.DrawableCompat.BuiltInFictitiousFunctionClassFactory(drawable, this.mDrawableContainerState.mAutoMirrored);
            }
        }
    }
    ...
    public void setHotspot(float f, float f2) {
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            androidx.core.graphics.drawable.DrawableCompat.getAuthRequestContext(drawable, f, f2);
        }
    }
    ...
    public void setHotspotBounds(int i, int i2, int i3, int i4) {
        ...
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            androidx.core.graphics.drawable.DrawableCompat.getAuthRequestContext(drawable, i, i2, i3, i4);
        }
    }
        ...
        try {
            ...
            if (this.mDrawableContainerState.mHasColorFilter) {
                ...
                if (this.mDrawableContainerState.mHasTintList) {
                    androidx.core.graphics.drawable.DrawableCompat.PlaceComponentResult(drawable, this.mDrawableContainerState.mTintList);
                }
                if (this.mDrawableContainerState.mHasTintMode) {
                    androidx.core.graphics.drawable.DrawableCompat.KClassImpl$Data$declaredNonStaticMembers$2(drawable, this.mDrawableContainerState.mTintMode);
                }
            }
    ...
    */
    void animate(boolean r14) {
        ...
        L20:
            ...
            long r9 = r9 * r4
            int r3 = (int) r9
            me.zhanghai.android.materialprogressbar.internal.DrawableContainerCompat$DrawableContainerState r9 = r13.mDrawableContainerState
        ...
        L53:
            ...
            long r10 = r10 * r4
            int r3 = (int) r10
            me.zhanghai.android.materialprogressbar.internal.DrawableContainerCompat$DrawableContainerState r4 = r13.mDrawableContainerState
        ...
        L77:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: me.zhanghai.android.materialprogressbar.internal.DrawableContainerCompat.animate(boolean):void");
    }
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public DrawableContainerState(DrawableContainerState drawableContainerState, DrawableContainerCompat drawableContainerCompat, Resources resources) {
            ...
            this.mDensity = BlobStatic.MONITOR_IMAGE_WIDTH;
